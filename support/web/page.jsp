            ...
            <form action="<%=linkpage%>" method=post>
                <%       //this is for first button
...

                    {
                        ...
                        out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/merchant/images/first.png\" ></button>");
                    }
                    else
                    {
                        out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/merchant/images/first1.gif\" ></button>");
                    }
            ...
            <form action="<%=linkpage%>" method=post>
                <%
...

                    {
                        ...
                        out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+prevblockpageno+"><img src=\"/merchant/images/previous.png\" ></button>");
                    ...
                    {
                        out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/merchant/images/previous1.gif\" ></button>");
                    }
                %>
            </form>
        </td>
            ...
            <form action="<%=linkpage%>" method=post>
                <%
...

                    {
                        ...
                        out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/merchant/images/next.png\" ></button>");

                    }
                    else
                    {
                        out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/merchant/images/next1.gif\" ></button>");
                    }
                %>
            </form>
        </td>
            ...
            <form action="<%=linkpage%>" method=post>
                <%
...

                    {
                        ...
                        out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+totalnofopages+"><img src=\"/merchant/images/last.png\" ></button>");

                    }
                    else
                    {
                        out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/merchant/images/last1.gif\" ></button>");
                    }
                %>
            </form>
        </td>
