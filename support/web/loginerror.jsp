...
<html>
<head>
    <title>Support Administration </title>
    ...
    <tr>
        <td>
            <table border="0" cellpadding="5" cellspacing="0" width="100%" bgcolor="#ffffff" align="center">
                <tr>
                    <td class="texthead">&nbsp;&nbsp;Support Administration Module</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                        ...
                        <%
                           /* String action = ESAPI.encoder().encodeForHTML(request.getParameter("action"));*/
                            /*if (action.equals("F"))
                            {
                                ...
                                out.println("</p><p ALIGN=\"CENTER\"><a href=\"/support/login.jsp\"><b>Please Try Again.</b></a></p>");
                                out.println("<p ALIGN=\"center\">If you have forgotten the password please click on forgot password link on the login page and you will get mail from " + company + " support team with a temporary password. <br><br>If you have forgotten your username, please create a support request at http://support.pz.com and give your memberid ");
                                out.println("</p>");
                            }
                            ...
                            {*/
                                out.println("Please create a support request at http://support.pz.com <br>to know the reason.</b>");
                            /*}*/
                        %>
                    </td>
                </tr>
