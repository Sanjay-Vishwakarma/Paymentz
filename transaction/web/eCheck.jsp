...
<div id="eCheckOption" class="option-class">
  <ul class="nav nav-tabs" id="eCheckTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="eCheckHideShow('<%=cardName%>','<%=rb1.getString(cardName)%>')">
...
<div class="tab-content">
  ...
  <div class="tab-pane" id="CHKID">
    <form id="chkForm" class="form-style" method="post">
      ...
      <jsp:include page="requestParameters.jsp">
        <jsp:param name="paymentMode" value="eCheck" />
      </jsp:include>
  ...
  <div class="tab-pane" id="eCheckID">
    <form id="eCheckForm" class="form-style" method="post">
      ...
      <div class="tab" id="cardinfoDP" style="padding-top: 20px;height: 238px;" ><p class="form-header" style="display: none;"><%=varCardinfo%></p>
        ...
        <div class="form-group has-float-label control-group-half" >
          <input class="form-control input-control1" id="dpCheckNo" placeholder=" " type="text" onkeypress="return isNumberKey(event)"
                 maxlength="12" oninput="this.className = 'form-control input-control1'" name="checknumber" />
          <label for="dpCheckNo" class="form-label"><%=varCheckNumber%></label>
        </div>
      </div>
      ...
      <jsp:include page="requestParameters.jsp">
        <jsp:param name="paymentMode" value="ECHK" />
      </jsp:include>
