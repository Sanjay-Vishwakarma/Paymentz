...
<style type="text/css">
    ...
    .card .card_icon {
        background: transparent url('../images/transaction/cardscheme/credit_card_sprites.png') no-repeat 30px 0;
    }
    ...
    .card .status_icon {
        background: transparent url('../images/transaction/cardscheme/status_sprites.png') no-repeat 33px 0;
    }
    ...
    <div class="credit-card-wrapper" id="creditlyfield">
        <div class="first-row form-group" id="first-row">
            <div class="form-group col-md-4 controls">
                <label class="control-label headpanelfont_color" for="firstname"><%=CRE_FIRSTNAME%>
                </label>
                <input type="text" size="30" class="form-control" id="firstname" name="firstname"
                       placeholder="<%=CRE_FIRSTNAME%>" value="<%=firstname%>">
            </div>
            <div class="form-group col-md-4 controls">
                <label class="control-label headpanelfont_color" for="lastname"><%=CRE_LASTNAME%>
                </label>
                <input type="text" class="form-control" id="lastname" name="lastname" size="30"
                       placeholder="<%=CRE_LASTNAME%>" value="<%=lastname%>">
                <br>
            </div>
            ...
            <h2 class="col-md-12 controls  background panelheading_colorheadpanelfont_color"
                style="margin-top: 0px;font-size: 16px;"><%=CRE_BILLINGADDRESS%>
            </h2>
            <%
                if (fileName != null)
                {
            ...
            <div class="form-group col-md-12 controls">
                <label class="control-label headpanelfont_color" for="street"><%=CRE_ADDRESS%>
                </label>
                <input type="text" class="form-control" id="street" name="street" size="40" value="<%=street%>"
                       placeholder="<%=CRE_ADDRESS%>">
            </div>

            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color" for="city"><%=CRE_CITY%>
                </label>
                <input type="text" class="form-control" name="city" id="city" size="20" value="<%=city%>"
                       placeholder="<%=CRE_CITY%>">
            </div>
            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color" for="zip"><%=CRE_ZIP%>
                </label>
                <input type="text" class="form-control" id="zip" name="zip" size="10"
                       title="allow only alphanumeric value" value="<%=zip%>" placeholder="<%=CRE_ZIP%>">
            </div>
            <%--add New--%>
            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color Country"><%=CRE_COUNTRY%>
                </label>
                <%
            ...
            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color" for="lastname"><%=CRE_COUNTRYCODE%>
                </label>
                <input type="text" class="form-control" id="countrycode" name="countrycode" value="<%=country%>"
                       readonly="readonly">
            </div>
            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color State"><%=CRE_STATE%>
                </label>
            ...
            <div class="form-group col-md-6 controls">
                <label for="b_state" class="control-label headpanelfont_color"><%=CRE_STATECODE%>
                </label>
                <input name="state" class="form-control" value="<%=state%>" type="text" id="b_state" size="10">
            </div>
            <div class="form-group col-md-3 controls">
                <label class="control-label headpanelfont_color telnocc"><%=CRE_PHONECC%>
                </label>
            ...
            <div class="form-group col-md-3 controls" id="phoneno">
                <label class="control-label headpanelfont_color telnocc"><%=CRE_PHONENO%>
                </label>
                <input type="text" name="telno" size="20" id="telno" value="<%=telno%>" class="form-control"
                       title="allow only numeric value">
            </div>
            <div class="form-group col-md-6 controls">
                <label class="control-label headpanelfont_color"
                       for="emailaddr"><%=CRE_EMAIL%>
                </label>
