...
<div id="GiftCardsOption" class="option-class">
  <ul class="nav nav-tabs" id="GiftCardsTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="giftCardsHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<div class="tab-content">
  ...
  <%
    for(String cardId : cardList)
    {
      String cardName = GatewayAccountService.getCardType(cardId);
      String cn = cardName;
      cardName = cardName.replaceAll(" ", "_")+"_GC";
  %>
