...
<div id="BcPayGetOption" class="option-class">
  <ul class="nav nav-tabs" id="BCPayGetTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="bcPayGetHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<form method="post" name="bcpaygetForm" id="bcpaygetForm" action="/transaction/SingleCallCheckout">

  <input type="hidden" name="paymentBrand" id="paymentBrand" value="BCPAYGATE">
