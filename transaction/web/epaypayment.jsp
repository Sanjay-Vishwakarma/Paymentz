...
<%
  ...
  String customerId=getValue(genericAddressDetailsVO.getCustomerid());
%>
<style>
    ...
    <div class="first-row form-group" id="form-group">
      <div class=" form-group col-md-12 controls">
        <div class="form-group col-md-6 controls">
          <label class="control-label headpanelfont_color">ePay Customer Id</label>
          <input type="text" name="customerBankId" id="customerBankId" maxlength="30" placeholder="ePay Customer Id" value="<%=customerId%>" class="form-control textbox_color"/>
        </div>
