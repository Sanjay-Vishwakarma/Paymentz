...
<div id="PayGOption" class="option-class">
  <ul class="nav nav-tabs" id="PAYGTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="paygHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<form method="post" name="duspayDDForm" id="duspayDDForm" action="/transaction/SingleCallCheckout">

  <input type="hidden" name="paymentBrand" id="paymentBrand" value="DUSPAYDD">
