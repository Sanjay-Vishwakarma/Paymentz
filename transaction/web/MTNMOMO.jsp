...
<div id="MTNMOMOOption" class="option-class">
  <ul class="nav nav-tabs" id="MTNMOMOTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="MTNMOMOHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<div class="tab-content">
  ...
  <%
    for(String cardId : cardList)
    {
      String cardName = GatewayAccountService.getCardType(cardId);
      String cn = cardName;
      cardName = cardName.replaceAll(" ", "_")+"_MTN";
  %>
