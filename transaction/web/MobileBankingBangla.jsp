...
<%
  ...
  String displayMsgBangla   = "যেকোন সমস্যার জন্য pls support@severent.com এ যোগাযোগ করুন। যদি আপনার পরিমাণ কেটে নেওয়া হয় এবং অ্যাকাউন্টে প্রতিফলিত না হয় তবে তা 48 ঘন্টার মধ্যে ফিরিয়ে দেওয়া হবে";
  ...
  String payMode             = "BDM";
  String tabId               = "MobileBankingBangla";
  String paymodeId    = "56";
  ...
  Logger log          = new Logger("MobileBankingBangla.jsp");
...
<div class="tab-pane" id="<%=tabId%>" style="height: 305px;" >
  <form id="<%=tabId%>Form" class="form-style" method="post">
    ...
    <div class="tab" style="padding: 0px;height: auto;">
      <ul class="nav nav-tabs" id="MobileBankingBanglaTab">
        <%
        ...
        %>
        <li class="tabs-li-wallet"  onclick="MobileBankingBanglaHideShow('<%=cardName%>','<%=rb1.getString(cardName)%>',true)">
    ...
    <div class="form-group " id="terms1">
      <label  style="font-size: 55%;position: absolute;margin: 0px; color:Gray; ">
        <p style="text-align:center;"> <b><%=displayMsgEnglish%></b></p>  <p style="text-align:center;">  <b><%=displayMsgBangla%> </b> </p>
      </label>
    </div>
