...
<%
  ...
  Logger log = new Logger("cardRegistration.jsp");
...
<script>
  ...
  InvalidCity="<%=rb1.getString("VAR_INVALID_CITY")%>";
  InvalidCountry="<%=rb1.getString("VAR_INVALID_COUNTRY")%>";
  InvalidState="<%=rb1.getString("VAR_INVALID_STATE")%>";
  InvalidZip="<%=rb1.getString("VAR_INVALID_ZIP")%>";
    ...
    <div class="modal-content">
      ...
      <div id="target" class="mainDiv" >
        ...
        <div class="modal-body">
          ...
          <div class="check_mark hide" style="height:90%">
            <div id="load" class="loader hide">
            </div>
          </div>
          <%
                ...
                <form id="cardForm" class="form-style" action="/transaction/SingleCallCardRegistration" method="post">
                  <div class="tab" id="cardinfo" style="height: 305px;">
                    ...
                    <div class="form-group has-float-label control-group-seventy" id="CardName">
                      <input type="text" class="form-control input-control1" id="firstname" placeholder=" " onblur="validateCardHolderName('firstname','CardName')"
                  ...
                  <%
                    if("Y".equalsIgnoreCase(merchantDetailsVO.getIsAddressDetailsRequired())){%>
                  <div class="tab" style="height: 305px;">
                    ...
                    <div class="form-group has-float-label control-group-half" id="CardZip" >
                      <input type="text" class="form-control input-control1" id="zip" placeholder=" " onfocusout="validateZip(event.target.value ,'CardZip')"
                             oninput="this.className = 'form-control input-control1'" name="zip" maxlength="10" value="<%=zip%>"/>
                    ...
                    <div class="form-group has-float-label control-group-half" id="CardCC">
                    ...
                    <div class="form-group has-float-label control-group-half" id="CardPhone">
                  ...
                  <input type="hidden" id="notificationUrl" name="notificationUrl" value="<%=genericTransDetailsVO.getNotificationUrl()%>">
                  <input type="hidden" id="merchantRedirectUrl" name="merchantRedirectUrl" value="<%=genericTransDetailsVO.getRedirectUrl()%>">
                  <input type="hidden" id="redirectMethod" name="redirectMethod" value="<%=genericTransDetailsVO.getRedirectMethod()%>">
                </form>
              </div>
