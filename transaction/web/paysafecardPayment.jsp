...
<%
    ...
    String birthDate=getValue(genericAddressDetailsVO.getBirthdate());
%>
<body>
<style>
        ...
        <div class="first-row form-group" id="form-group">
            <div class=" form-group col-md-12 controls" id="inlinefield">
                <div class="form-group  col-md-6 controls" id="fields" >
                    <label for="firstname" class="control-label headpanelfont_color">First Name</label>
                    <input type="text" name="firstname" id="firstname" size="30" placeholder="First Name" value="<%=firstName%>" class="form-control textbox_color"/>
                 </div>
                <div class=" form-group col-md-6 controls">
                <label for="lastname" class="control-label headpanelfont_color">Last Name</label>
                <input type="text" name="lastname" id="lastname" size="30" placeholder="Last Name" value="<%=lastName%>" class="form-control textbox_color"/>
                </div>
                </div>
            <div class=" form-group col-md-12 controls" id="inlinefield">
            <div class="form-group  col-md-2 controls" id="fields" >
            ...
            <div class="form-group  col-md-2 controls" id="fields" >
                <label class="control-label headpanelfont_color">YYYY</label>
            ...
            <div class=" form-group col-md-6 controls">
                <label for="email" class="control-label headpanelfont_color">Email ID</label>
                <input type="text" name="emailaddr" id="email" size="30" placeholder="Email ID" value="<%=email%>" class="form-control textbox_color"/>
            </div>
            </div>
        </div>
...
<%--
<input type="hidden" value="<%=email%>" name="emailaddr">
--%>
