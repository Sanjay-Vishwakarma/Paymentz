...
<div id="SMARTFASTPAYOption" class="option-class">
  <ul class="nav nav-tabs" id="SMARTFASTPAYTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="SMARTFASTPAYHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
  ...
  <div class="tab-pane" id="<%=cardName%>">
    <form id="<%=cardName%>Form" class="form-style" method="post">
      ...
      <div class="tab">
        ...
        <div class="form-group has-float-label control-group-full" style="margin-top: 70px;">
          <input class="form-control input-control1" id="<%=cardName%>AccNo" placeholder=" " type="text" onkeypress="return isNumberKey(event)"
                 maxlength="17" oninput="this.className = 'form-control input-control1'" name="document" />
