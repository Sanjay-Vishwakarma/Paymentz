...
<div id="VoguePayOption" class="option-class">
  <ul class="nav nav-tabs" id="VoguePayTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="voguePayHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<form method="post" name="vpForm" id="vpForm" action="/transaction/SingleCallCheckout">

  <input type="hidden" name="paymentBrand" id="paymentBrand" value="VOGUEPAY">
