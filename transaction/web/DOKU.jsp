...
<div id="DOKUOption" class="option-class">
  <ul class="nav nav-tabs" id="DOKUTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="dokuHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<div class="tab-content">
  ...
  <form method="post" name="dokuForm" id="dokuForm" action="/transaction/SingleCallCheckout">
    <input type="hidden" name="paymentBrand" id="paymentBrand" value="DOKU">
