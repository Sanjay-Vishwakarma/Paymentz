...
<div id="BitCoinOption" class="option-class">
  <ul class="nav nav-tabs" id="BitCoinTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="bitcoinHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
