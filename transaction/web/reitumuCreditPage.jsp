...
<h2 class="col-md-8 background panelheading_color headpanelfont_color">Billing Address (where you receive your Card bills)</h2>
<div class="col-md-8 portlets ui-sortable">
<div class="form-group col-md-6" >
    <label for="firstname">First Name</label>
    <input type="text"  size="30" class="form-control textbox_color" id="firstname" name="firstname" placeholder="First Name" value="<%=firstname%>">
</div>
<div class="form-group col-md-6">
    <label for="lastname">Last Name</label>
    <input type="text" class="form-control textbox_color"  id="lastname" name="lastname" size="30" placeholder="Last Name" value="<%=lastname%>">
</div>
...
<div class="form-group col-md-6">
    ...
    <select name="country" onchange="myjunk();"  class="txtbox" style="width:265px;">
...
<div class="form-group col-md-6">
    <label for="b_state">State Code</label>
    <input name="state" class="form-control textbox_color"  value="<%=state%>" type="text" id="b_state" size="10"></td>

</div>

<div class="col-md-2 controls" style="padding-left: 17px;">
    <label class="telnocc">Phone-CC</label>
...
<div class="col-md-4 controls">
    <label class="telnocc">Phone-NO</label>
