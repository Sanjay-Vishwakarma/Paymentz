...
<div id="DelayedBankTransferOption" class="option-class">
  <ul class="nav nav-tabs" id="DelayedBankTransferTab">
    ...
    %>
    <li class="tabs-li-wallet" onclick="delayedBankTransferHideShow('<%=cardName%>','<%=rb.getString(cardName)%>')">
...
<div class="tab-content">
  ...
  <%
    for(String cardId : cardList)
    {
      String cardName = GatewayAccountService.getCardType(cardId);
      String cn = cardName;
      cardName = cardName.replaceAll(" ", "_")+"_DBT";
  %>
