...
<%
    ...
    final String CRE_DOB = rb.getString("CRE_DOB");
        ...
        <div class="first-row form-group" id="form-group">
            <div class=" form-group col-md-12 controls" id="inlinefield">
                ...
                <div class="form-group col-md-6 controls " id="fields">
                    <label class="control-label headpanelfont_color" for="fields"><%=CRE_FIRSTNAME%>
                    </label>
                    <input type="text" name="firstname" id="firstname" class="form-control" size="30"
                           placeholder="<%=CRE_FIRSTNAME%>" value="<%=firstName%>"/>
                </div>
                <div class="form-group col-md-6 controls " id="fields">
                    <label class="control-label headpanelfont_color" for="fields"><%=CRE_LASTNAME%>
                    </label>
                    <input type="text" name="lastname" id="lastname" class="form-control" size="30"
                ...
                %>
                <div class="form-group col-md-6 controls " id="fields">
                    <label class="control-label headpanelfont_color" for="emailaddr"><%=CRE_EMAIL%>
                    </label>
                    <input type="text" name="emailaddr" id="emailaddr" class="form-control textbox_color" size="30"
                           placeholder="<%=CRE_EMAIL%>" value="<%=email%>"/>
                </div>
        ...
        <div class="first-row form-group" id="form-group" style="display:table;">
            <div class=" form-group col-md-12 controls">
                <div class="col-md-12 portlets ui-sortable" id="headtag">
                    ...
                    <label class="headpanelfont_color">Birth Date</label>

                </div>
                <div class="col-sm-3 controls">
                    <label class="control-label headpanelfont_color">DD</label>
                ...
                <div class="col-sm-3 controls">
                    <label class="control-label headpanelfont_color">MM</label>
                ...
                <div class="col-sm-3 controls">
                    <label class="control-label headpanelfont_color">YY</label>
