...
%>
  ...
  <select name="country" id="country" onchange="myjunk();" class="form-control" >
...
<script type="">
  ...
  for(var i=0; i < countryID.options.length ; i++){
    if(countryID.options[i].value.includes(country_code)){
