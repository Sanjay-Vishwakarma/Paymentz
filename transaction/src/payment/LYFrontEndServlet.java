 ...
 */
public class LYFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(LYFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering LyraFrontEndServlet ......", e);
        }
    }
    ...
    {
        transactionlogger.error("Entering LyraFrontEndServlet ......");
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                LyraPaymentGateway lyraPaymentGateway= new LyraPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO = (CommResponseVO) lyraPaymentGateway.processQuery(trackingId,requestVO);
                    ...
                    if (functions.isValueNull(responseAmount))
                    {
                        ...
                        else if (!compDbAmount.equals(compRsAmount) && "success".equalsIgnoreCase(inStatus))
                        {
                            ...
                            blacklistVO.setActionExecutorName("LYFrontEndServlet");
                    ...
                    else
                    {
                        ...
                        status = "Pending";
                        message = "Pending";
                        transactionlogger.error("inside Lyra pending condition --->" + STATUS + "--" + message);
                    }
                ...
                else
                {
                    ...
                    {
                        transactionlogger.error("inside else success  condition Lyra --->" + dbStatus + "--" +" trackingid  "+trackingId);
                ...
                if (functions.isValueNull(genericTransDetailsVO.getRedirectUrl()))
                {
                    ...
                    lyraPaymentUtils.doHttpPostConnection(commonValidatorVO, redirectUrl, billingDesc, status);
        ...
        {
            transactionlogger.error("PZTechnicalViolationException Lyra---", e);
        }
        catch (NoSuchAlgorithmException e)
        {
            transactionlogger.error("NoSuchAlgorithmException  Lyra---",e);
        }
        catch (SystemError systemError)
        {
            transactionlogger.error("SystemError  Lyra---",systemError);
        }
        catch (Exception e)
        {
            transactionlogger.error("Exception  Lyra---", e);
        }
    }
