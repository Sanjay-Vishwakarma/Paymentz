 ...
 */
public class CTFrontendServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CTFrontendServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering CTFrontendServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering CTFrontendServlet ......");
        ...
        try
        {
            transactionlogger.error("----- CTFrontendServlet Response -----"+trackingId);
            ...
            transactionlogger.error("----- CTFrontendServlet Response -----" + responseMsg);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("CTFrontendServlet");
                auditTrailVO.setActionExecutorId(toid);

                ContinentPayPaymentGateway continentPayPaymentGateway = new ContinentPayPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    comm3DResponseVO    = (Comm3DResponseVO) continentPayPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if(functions.isValueNull(responseAmount))
                    {
                        ...
                        {
                            transactionlogger.error(trackingId+" CTFrontendServlet inside else Amount incorrect--->" + responseAmount);
                            remark = "Failed-IRA";
                            STATUS = "failed";
                ...
                else
                {
                    ...
                    {
                        transactionlogger.error("inside CTFrontendServlet transactionStatus " + transactionStatus);
                        status      = "pending";
...
//                smsService.sendSMS(MailEventEnum.PARTNERS_MERCHANT_SALE_TRANSACTION, String.valueOf(trackingId), status, message, billingDesc);
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("CTFrontendServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
