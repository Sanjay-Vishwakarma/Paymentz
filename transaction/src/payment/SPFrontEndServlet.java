 ...
 */
public class SPFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(SPFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering SPFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering SPFrontEndServlet ......");
        ...
        try
        {
            ...
            transactionlogger.error("----- SPFrontEndServlet Response -----"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("SPFrontend");
                auditTrailVO.setActionExecutorId(toid);

                SwiffyPaymentGateway swiffyPaymentGateway  = new SwiffyPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    comm3DResponseVO  = (Comm3DResponseVO) swiffyPaymentGateway.processQuery(trackingId, requestVO);
