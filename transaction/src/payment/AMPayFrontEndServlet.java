 ...
 */
public class AMPayFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(AMPayFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering AMPayFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering AMPayFrontEndServlet ......");
       ...
       /* String method = "";
        if(functions.isValueNull(req.getParameter("method")))
            method = req.getParameter("method");

        if ("updateCardType".equals(method))
        {
            res.setContentType("application/json");
            res.setCharacterEncoding("UTF-8");
            String json = updateTransactionCardType(req, res);
...
*/
        ...
        try
        {
            transactionlogger.error("..... AMPayFrontEndServlet ......"+trackingId);
            if(req.getParameter("card_type") != null) {
                cardtype = req.getParameter("card_type");
            }
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("AMPayFrontEnd");
                auditTrailVO.setActionExecutorId(toid);

                AamarPayPaymentGateway aamarPayPaymentGateway     = new AamarPayPaymentGateway(accountId);
               ...
               // String SECRETE_KEY                                  = gatewayAccount.getFRAUD_FTP_PASSWORD();
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) aamarPayPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if ("Success".equalsIgnoreCase(STATUS))
                    {
                        ...
                        dbBuffer.append("update transaction_common set captureamount='" + amount + "',paymentid='" + TXN_ID + "',customerId='" + cardtype + "',templateamount='" + tmpl_amt + "',templatecurrency='" + tmpl_currency +  "',rrn='" +RRN+ "" +"',status='capturesuccess'" + " ,successtimestamp='" + functions.getTimestamp());
                    ...
                    else if("Failed".equalsIgnoreCase(STATUS))
                    {
                        ...
                        dbStatus = "authfailed";
                        dbBuffer.append("update transaction_common set status='authfailed',paymentid='" + TXN_ID + "',customerId='" + cardtype + "',templateamount='" + tmpl_amt + "',templatecurrency='" + tmpl_currency + "'" + " ,failuretimestamp='" + functions.getTimestamp());
   ...
   /* private String updateTransactionCardType(HttpServletRequest request, HttpServletResponse response)
    {
        String cartType     = request.getParameter("cartType");
        String trackingID   = request.getParameter("trackingID");
        transactionlogger.error("method -----------> "+cartType);
        transactionlogger.error("trackingID -----------> "+cartType);
        AamarPayUtils aamarPayUtils =  new AamarPayUtils();

        Boolean aBoolean = aamarPayUtils.updateTransaction(trackingID, cartType);
        JSONObject requestJSON      = new JSONObject();
        try
        {
            requestJSON.put("aBoolean",aBoolean+"");
        }
