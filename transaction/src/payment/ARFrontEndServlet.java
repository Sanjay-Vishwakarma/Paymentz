 ...
 */
public class ARFrontEndServlet extends HttpServlet
{
    //private static TransactionLogger transactionlogger = new TransactionLogger(PayGPaymentFrontEndServlet.class.getName());
    private static PayGTransactionLogger transactionlogger = new PayGTransactionLogger(PayGPaymentFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering ARFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering ARFrontEndServlet ......");
        ...
        try
        {
            ...
            transactionlogger.error("..... ARFrontEndServlet ......"+trackingId+" mihpayid--> ");
