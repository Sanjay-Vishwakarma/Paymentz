 ...
 */
public class CFCaiboFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CFCaiboFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering CFCaiboFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering CFCaiboFrontEndServlet ......");
        ...
        try
        {
            ...
            transactionlogger.error("-----CFCaiboFrontEndServlet  JSON-----" + responseMsg);
            String ENCDATA          = "";
...
//            }
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("CFCaiboFrontEnd");
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    {
                        transactionlogger.error("inside CFCaiboFrontEndServlet failed --->");
                        ...
                        status      = "Pending";
                        message     = "Pending";
                        transactionlogger.error("inside CFCaiboFrontEndServlet pending condition --->"+STATUS+"--"+message);
                    }
                }
                else
                {
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("CFCaiboFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
