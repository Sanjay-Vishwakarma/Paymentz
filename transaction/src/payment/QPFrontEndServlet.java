 ...
 */
public class QPFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(QPFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering QPFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering QPFrontEndServlet ......");
        ...
        try
        {
            transactionlogger.error("..... QPFrontEndServlet ......"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                {
                    tmpl_amt = transactionDetailsVO.getAmount();
                }
                ...
                auditTrailVO.setActionExecutorName("QPFrontEnd");
                ...
                {
                    decryptedData = qikPayV2Utils.decryptAES(ENCDATA, SECRETE_KEY);
                }
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) qikPayV2PaymentGateway.processQuery(trackingId, requestVO);
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("QPFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
