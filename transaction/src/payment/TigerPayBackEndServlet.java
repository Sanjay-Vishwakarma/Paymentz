 ...
 */
public class TigerPayBackEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(TigerPayBackEndServlet.class.getName());
    ...
    public void doService(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
                        ...
                        if (commResponseVO != null)
                        {
                            ...
                            /*if(functions.isValueNull(responseAmount))
                            {
                                ...
                                else
                                {
                                    ...
                                    blacklistVO.setActionExecutorName("TigerPayBackEndServlet");
        ...
        catch(NullPointerException e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("TigerPayBackEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
