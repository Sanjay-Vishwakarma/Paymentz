 ...
 */
public class WealthPayFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(WealthPayFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Exception in  WealthPayFrontEndServlet doGet method ......",e);
        }
    }
    ...
    public void doPost(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Exception in  WealthPayFrontEndServlet doPost method ......",e);
        }
    }
    ...
    {
        transactionlogger.error("Entering WealthPayFrontEndServlet doService ......");
...
//            }
        ...
        if (req.getParameter("trackingId") != null)
        {
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                WealthPayGateway wealthPayGateway   = new WealthPayGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) wealthPayGateway.processQuery(trackingId, requestVO);
                    ...
                    {    notificationUrl    = transactionDetailsVO.getNotificationUrl();
                        ...
                        dbBuffer.append("update transaction_common set captureamount='" + amount + "',paymentid='" + TXN_ID + "',templateamount='" + tmpl_amt + "',templatecurrency='" + tmpl_currency +  "',rrn='" + "" +"',status='capturesuccess'");
