 ...
 */
public class OMFrontendServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(OMFrontendServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering OMFrontendServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering OMFrontendServlet ......");
        ...
        try
        {
            transactionlogger.error("----- OMFrontend Response -----"+trackingId);
            ...
            transactionlogger.error("----- OMFrontend Response -----" + responseMsg);
...
//            Thread.sleep(5000);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    comm3DResponseVO  = (Comm3DResponseVO) omnipayPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if(functions.isValueNull(responseAmount))
                    {
                        ...
                        {
                            transactionlogger.error(trackingId+" OMFrontend inside else Amount incorrect--->" + responseAmount);
                            remark = "Failed-IRA";
                            STATUS = "failed";
                ...
                else
                {
                    ...
                    {
                        transactionlogger.error("inside OMFrontendServlet transactionStatus " + transactionStatus);
                        status      = "pending";
...
//                smsService.sendSMS(MailEventEnum.PARTNERS_MERCHANT_SALE_TRANSACTION, String.valueOf(trackingId), status, message, billingDesc);
                ...
                transactionlogger.error("frontend notification---" + trackingId +" "+ notificationUrl);
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("OMFrontendServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
