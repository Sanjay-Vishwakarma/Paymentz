 ...
 */
public class PayGPaymentFrontEndServlet extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering PayGPaymentFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering PayGPaymentFrontEndServlet ......");
        ...
        try
        {
            ...
            transactionlogger.error("..... PayGPaymentFrontEndServlet ......"+trackingId+" mihpayid--> ");
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) payGPaymentGateway.processQuery(trackingId, requestVO);
