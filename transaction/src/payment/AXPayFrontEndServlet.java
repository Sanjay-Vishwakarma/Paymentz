 ...
 */
public class AXPayFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(AXPayFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering ApexPayFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering ApexPayFrontEndServlet ......");
        ...
        try
        {
            transactionlogger.error("..... ApexPayFrontEndServlet ......"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
              ...
              //  transactionlogger.error("notificationUrl ---" + notificationUrl);
                ...
                auditTrailVO.setActionExecutorName("AXPayFrontEnd");
                ...
                {
                    decryptedData = apexPayUtils.decryptAES(ENCDATA, SECRETE_KEY);
                }
                transactionlogger.error("decryptedData apexpay ---" + decryptedData);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) apexPayPaymentGateway.processQuery(trackingId, requestVO);
            ...
            /*        transactionlogger.error("inquiry trackingid--->"+trackingId);
                    ...
                    {
                        transactionlogger.error("inside ApexPay failed --->");
                        ...
                        status      = "Pending";
                        message     = "Pending";
                        transactionlogger.error("inside ApexPay pending condition --->"+STATUS+"--"+message);
                    }
                }
                else
                {
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("ApexPayFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
