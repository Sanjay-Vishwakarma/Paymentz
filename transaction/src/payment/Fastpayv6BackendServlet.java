 ...
 */
public class Fastpayv6BackendServlet extends PzServlet
{
    private static TransactionLogger transactionLogger = new TransactionLogger(Fastpayv6BackendServlet.class.getName());

    public Fastpayv6BackendServlet()
    {
        super();
    }
    ...
    {
        transactionLogger.error("------inside Fastpayv6BackendServlet-----");
        ...
        transactionLogger.error("-----Fastpayv6BackendServlet   response-----" + responseMsg);
...
*/
                        ...
                        if (PZTransactionStatus.AUTH_STARTED.toString().equalsIgnoreCase(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                        {
                            if ("OK".equals(bankStatus) || "CAPTURED".equals(bankStatus) || "APPROVED".equals(bankStatus))
                            {
                                ...
                                if ("N".equalsIgnoreCase(isService) || "PA".equalsIgnoreCase(transactionDetailsVO.getTransactionType()) || type.equalsIgnoreCase("auth")) // AUTH
                                {
                                    ...
                                    sb.append(" ,remark='" + remark + "',paymentid='" + pspid + "',firstname='" + firstname + "',lastname='" + lastname + "',Name='"+  CardHName + "',ccnum='"+  CardNum + "',transaction_mode=null" + ",successtimestamp='" + functions.getTimestamp() + "',authorization_code='"+ authCode + "' where trackingid =" + trackingId + "");
                            ...
                            else if ("NOTOK".equalsIgnoreCase(respStatus) || "DECLINED".equals(bankStatus))
                            {
                                ...
                                sb.append(" ,remark='" + remark + "',paymentid='" + pspid +  "',firstname='" + firstname + "',lastname='" + lastname + "',Name='"+  CardHName + "',ccnum='"+  CardNum + "',transaction_mode=null" + ",failuretimestamp='" + functions.getTimestamp() + "',authorization_code='"+ authCode + "' where trackingid =" + trackingId + "");
                                con = Database.getConnection();
                                transactionLogger.error("QUERY============>"+sb.toString());
                    ...
                    else if (type.equalsIgnoreCase("refund"))
                    {
                        if (PZTransactionStatus.MARKED_FOR_REVERSAL.toString().equalsIgnoreCase(dbStatus))
                        {
                            if ("OK".equals(bankStatus) &&  "CAPTURED".equals(ISOResp))
                            {
                                ...
                                commResponseVO.setStatus("success");
                                commResponseVO.setRemark(ISOResp);
                                commResponseVO.setDescriptor(displayName);
                                ...
                                dbBuffer.append("update transaction_common set status='reversed',refundAmount='" + String.format("%.2f", refAmount) +  "',firstname='" + firstname + "',lastname='" + lastname + "',Name='"+  CardHName + "',ccnum='"+  CardNum  + "',refundtimestamp='" + functions.getTimestamp() +  "',authorization_code='"+ authCode + "'where trackingid = " + trackingId);
                    ...
                    { transactionLogger.error(" before in CAPTURE , capturesuccess ---"+dbStatus+"  ISOResp"+ISOResp);
                        if (PZTransactionStatus.CAPTURE_STARTED.toString().equalsIgnoreCase(dbStatus))
                        {
                            ...
                            else if("NOTOK".equalsIgnoreCase(bankStatus))
                            {
                                ...
                                transactionLogger.debug("Sql Query-----" + sb.toString());
                                sb.append(" ,remark='" + remark + "',paymentid='" + pspid + "',firstname='" + firstname + "',lastname='" + lastname + "',Name='"+  CardHName + "',ccnum='"+  CardNum +  "',authorization_code='"+ authCode + "' where trackingid =" + trackingId + "");
                                con = Database.getConnection();
                                result = Database.executeUpdate(sb.toString(), con);
                                if (result != 1)
                                {
                    ...
                    else if (type.equalsIgnoreCase("payout"))
                    {
                        ...
                        if (PZTransactionStatus.PAYOUT_STARTED.toString().equalsIgnoreCase(dbStatus))
                        {
                            if ("OK".equals(bankStatus) && "CAPTURED".equalsIgnoreCase(ISOResp))
                            {
                                ...
                                sb.append(" ,remark='" + remark + "',paymentid='" + pspid + "',firstname='" + firstname + "',lastname='" + lastname + "',Name='"+  CardHName + "',ccnum='"+  CardNum + "',payouttimestamp='" + functions.getTimestamp() +  "',authorization_code='"+ authCode + "' where trackingid =" + trackingId + "");
            ...
            {
                transactionLogger.error("SQL Exception in Fastpayv6BackendServlet---", e);
            }
            catch (SystemError e)
            {
                transactionLogger.error("System Exception in Fastpayv6BackendServlet---", e);
            }
            catch (NoSuchAlgorithmException e)
            {
                transactionLogger.error("NoSuchAlgorithm Exception in Fastpayv6BackendServlet---", e);
            }
