...
/**
 * Created by Admin on 12/18/2020.
 */
 public class OctapayFrontEndServlet extends HttpServlet
    {
        TransactionLogger transactionLogger = new TransactionLogger(OctapayFrontEndServlet.class.getName());
        ...
        {
            transactionLogger.error("---- Inside OctapayFrontEndServlet------");
            ...
            String paymentId=request.getParameter("order_id");
            String toid = "";
            String currency = "";
            String dbStatus = "";
