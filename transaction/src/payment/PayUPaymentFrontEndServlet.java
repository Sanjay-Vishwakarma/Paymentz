 ...
 */
public class PayUPaymentFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(PayUPaymentFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering PayUPaymentFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering PayUPaymentFrontEndServlet ......");
        ...
        try
        {
            ...
            if(req.getParameter("mihpayid") != null){
                mihpayid = req.getParameter("mihpayid");
            }

            transactionlogger.error("..... PayUPaymentFrontEndServlet ......"+trackingId+" mihpayid--> "+mihpayid);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("FrontEnd");
                auditTrailVO.setActionExecutorId(toid);

                PayUPaymentGateway payUPaymentGateway     = new PayUPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commTransactionDetailsVO.setPreviousTransactionId(mihpayid);

                    requestVO.setTransDetailsVO(commTransactionDetailsVO);

                    con             = Database.getConnection();
                    commResponseVO  = (CommResponseVO) payUPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    else if("Failed".equalsIgnoreCase(STATUS))
                    {
                        ...
                        dbBuffer.append("update transaction_common set paymentid='" + mihpayid + "' where trackingid = " + trackingId);
                        Database.executeUpdate(dbBuffer.toString(), con);
                        transactionlogger.debug("inside Payu pending condition --->" + STATUS + "--" + message);
                    }
