 ...
 */
public class PAFrontendServlet extends HttpServlet
{

    private static TransactionLogger transactionlogger = new TransactionLogger(PAFrontendServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering PayaidFrontEndServlet ......", e);
        }
    }
    ...
    {
        transactionlogger.error("Entering PayaidFrontEndServlet ......");
        ...
        transactionlogger.error("PayaidFrontEndServlet::");
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                PayaidPaymentGateway payaidPaymentGateway = new PayaidPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO = (CommResponseVO) payaidPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if ("0".equalsIgnoreCase(RESPONSE_CODE) && "Success".equalsIgnoreCase(STATUS))
                    {
               ...
               // genericTransDetailsVO.setRedirectUrl(redirectUrl);
                ...
                if (functions.isValueNull(genericTransDetailsVO.getRedirectUrl()))
                {
                    ...
                    payaidPaymentUtils.doHttpPostConnection(commonValidatorVO, redirectUrl, billingDesc,status);
