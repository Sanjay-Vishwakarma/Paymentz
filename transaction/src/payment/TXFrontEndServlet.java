 ...
 */
public class TXFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(TXFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering TXFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering TXFrontEndServlet ......");
        ...
        try
        {
            transactionlogger.error("----- TXFrontEndServlet Response -----"+trackingId);
            ...
            transactionlogger.error("----- TXFrontEndServlet Response -----" + responseMsg);
