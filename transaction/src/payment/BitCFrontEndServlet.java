 ...
 */
public class BitCFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(BitCFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering BitClearFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering BitClearFrontEndServlet ......");
        ...
        try
        {
            ...
            transactionlogger.error("..... BitClearFrontEndServlet ......"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                BitClearPaymentGateway paymentGateway     = new BitClearPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) paymentGateway.processQuery(trackingId, requestVO);
                    ...
                    transactionlogger.error("inquiry inStatus--->"+STATUS);
                    ...
                    transactionlogger.error("Inside FrontEnd ---> "+trackingId +" "+STATUS);
