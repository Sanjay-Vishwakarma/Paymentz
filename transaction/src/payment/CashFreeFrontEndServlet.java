 ...
 */
public class CashFreeFrontEndServlet  extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CashFreeFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering CashFreeFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("Entering CashFreeFrontEndServlet ......");
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                CashFreePaymentGateway cashFreePaymentGateway=new CashFreePaymentGateway(accountId);
                ...
                {
                    commResponseVO= (CommResponseVO) cashFreePaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    RRN=commResponseVO.getResponseHashInfo();
                    transactionlogger.error("cashfree inquiry trackingid--->"+trackingId);
                    transactionlogger.error("inquiry TXN_ID--->"+TXN_ID);
                    ...
                    // commResponseVO.gettran(PZProcessType.SALE.toString());
                    ...
                    else if(!compDbAmount.equals(compRsAmount)&&"success".equalsIgnoreCase(inStatus))
                    {
                        ...
                        blacklistVO.setActionExecutorName("CashFreeFrontEndServlet");
                  ...
                  //  currency=commResponseVO.getCurrency();
                    ...
                    {    notificationUrl = transactionDetailsVO.getNotificationUrl();
                        ...
                        dbBuffer.append(",customerIp='" + requestIp + "',customerIpCountry='" + functions.getIPCountryShort(requestIp) + "' ,remark='" + responseStatus + "',successtimestamp='" + functions.getTimestamp() + "' where trackingid = " + trackingId);
                    ...
                    {    notificationUrl = transactionDetailsVO.getNotificationUrl();
                        ...
                        dbStatus = "authfailed";
                        dbBuffer.append("update transaction_common set status='authfailed',paymentid='" + TXN_ID + "',templateamount='" + tmpl_amt +  "',rrn='" + RRN + "',templatecurrency='" + tmpl_currency + "'");
                        /*if("11111".equalsIgnoreCase(RESPONSE_CODE)&&"success".equalsIgnoreCase(commResponseVO.getStatus())){
                            dbBuffer.append(",captureamount='"+ amount+"'");
                        }*/

                        dbBuffer.append(",authorization_code='"+amount+"',customerIp='" + requestIp + "',customerIpCountry='" + functions.getIPCountryShort(requestIp) + "' ,remark='" + responseStatus + "',failuretimestamp='" + functions.getTimestamp() + "' where trackingid = " + trackingId);
                        transactionlogger.error("Update Query---" + dbBuffer);
                        Database.executeUpdate(dbBuffer.toString(), con);
                        ...
                        status="Pending";
                        message="Pending";
                        transactionlogger.error("inside cashfree pending condition --->" + STATUS + "--" + message);
                    }
                ...
                if (functions.isValueNull(genericTransDetailsVO.getRedirectUrl()))
                {
                    ...
                    cashFreeUtils.doHttpPostConnection(commonValidatorVO,redirectUrl,billingDesc,status);
        ...
        catch (Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("CashFreeFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
