 ...
 */
public class APBackEndServlet extends HttpServlet
{
    ...
    {
        transactionlogger.error("Entering  APBackendServlet......");
        ...
        try
        {
            ...
            transactionlogger.error("----- APBackend  response-----" + trackingId);
            ...
            transactionlogger.error(trackingId+"----- SPBackend  response-----" + responseMsg);
...
//                    }
                    ...
                    auditTrailVO.setActionExecutorName("APBackEnd");
...
//                        requestVO.setAddressDetailsVO(commAddressDetailsVO);
                        ...
                        transactionlogger.error("inside APBackendServlet transactionStatus " + transactionStatus);

                        if ("complete".equalsIgnoreCase(transactionStatus))   //status = 2: - Payment successful
                        {
                            transactionlogger.error("inside success APBackendServlet transactionStatus " + transactionStatus);
                        ...
                        {
                            transactionlogger.error("inside fail or error APBackendServlet transactionStatus " + transactionStatus);
                            notificationUrl = transactionDetailsVO.getNotificationUrl();
                            status          = "failed";
                        ...
                        {
                            transactionlogger.error("inside else pending APBackendServlet transactionStatus " + transactionStatus);
                            //pending
...
//                    smsService.sendSMS(MailEventEnum.PARTNERS_MERCHANT_SALE_TRANSACTION, String.valueOf(trackingId), status, message, billingDesc);
        ...
        catch (NullPointerException e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("APBackendServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
