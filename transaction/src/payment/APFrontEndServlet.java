...
/**
 * Created by Admin on 07-Dec-22.
 */
public class APFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(APFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering APFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering APFrontEndServlet ......");
        ...
        String partnerName  = "";
        String amount       = "";
        String trackingId   = req.getParameter("merchant_reference");
        String status       = "";
        String remark       = "";
        ...
        try
        {
            if (functions.isValueNull(req.getParameter("transaction_id")))
            {
                ...
                transactionlogger.error("transaction_id is >>>>>>>>>>>>>"+transactionId);
            }
            transactionlogger.error("----- APFrontEndServlet Response -----"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("APFrontend");
                auditTrailVO.setActionExecutorId(toid);

                AlphapayPaymentGateway alphapayPaymentGateway = new AlphapayPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    transactionlogger.error("transaction_id 2 is >>>>>>>>>>>>>"+commTransactionDetailsVO.getPreviousTransactionId());
                    requestVO.setTransDetailsVO(commTransactionDetailsVO);

                    con               = Database.getConnection();
                    comm3DResponseVO  = (Comm3DResponseVO) alphapayPaymentGateway.processQuery(trackingId, requestVO);
