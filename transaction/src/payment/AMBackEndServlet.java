 ...
 */
public class AMBackEndServlet extends HttpServlet
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(AMBackEndServlet.class.getName());
    ...
    {
        transactionLogger.error("----Inside AMBackEndServlet----");
        ...
        try
        {
            ...
            if(functions.isValueNull(amMessage) && (amMessage.contains("/")))
            {
                amMessage = amMessage.replaceAll("/", " ");
            }
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equalsIgnoreCase(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    commResponseVO.setErrorCode(statusCode);
                    commResponseVO.setBankCode(statusCode);
