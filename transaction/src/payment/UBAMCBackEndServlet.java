 ...
 */
public class UBAMCBackEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(UBAMCBackEndServlet.class.getName());
    ...
    {
        transactionlogger.error("Entering UBAMCBackEndServlet ......");
        ...
        transactionlogger.error("-----UBAMCBackEndServlet   response-----" + responseMsg);
        ...
        try
        {
           ...
           transactionlogger.error("-----UBAMCBackEndServlet ----- " + trackingId);
