 ...
 */
public class CPayBackEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CPayBackEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering CPayBackEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering CPayBackEndServlet ......");
        ...
        transactionlogger.error("-----CPayBackEndServlet     response-----" + responseMsg);
        String ENCDATA          = "";
        String decryptedData    = "";
        try
        {
            JSONObject jsonObject = new JSONObject(responseMsg.toString());
            JSONObject merchant_order = null;

            if(jsonObject.has("merchant_order")){
                merchant_order = jsonObject.getJSONObject("merchant_order");
            }

            if(merchant_order != null && merchant_order.has("id")){
                trackingId = merchant_order.getString("id");
            }

            transactionlogger.error("..... CPayBackEndServlet ...... "+trackingId);
...
//                Thread.sleep(5000);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("CPPayBackEnd");
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) cardPayPaymentGateway.processInquiry(requestVO);
                    ...
                    {
                        transactionlogger.error("inside TigerPay failed --->");
                        ...
                        status      = "Pending";
                        message     = "Pending";
                        transactionlogger.error("inside TigerPay pending condition --->"+STATUS+"--"+message);
                    }
                }
                else
                {
