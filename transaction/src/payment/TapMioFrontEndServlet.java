 ...
 */
public class TapMioFrontEndServlet extends HttpServlet
{


    private static TransactionLogger transactionlogger = new TransactionLogger(TapMioFrontEndServlet.class.getName());
    ...
    public void doService(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        transactionlogger.error(" RESPONSE------------------------->" + responseMsg);
        ...
        try
        {
           ...
           /* String INTERNAL_ACQUIRER_TYPE=req.getParameter("INTERNAL_ACQUIRER_TYPE");//for PhonePe
            ...
            if (transactionDetailsVO != null)
            {
                ...
                transactionlogger.error("billingDescripter frontend-------------------------------------->"+GatewayAccountService.getGatewayAccount(accountId).getDisplayName());

                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {     transactionlogger.error("accountid frontend-------------------------------------->"+accountId);
                     TapMioPaymentGateway tapMioPaymentGateway = new TapMioPaymentGateway(accountId);
                 ...
                 commResponseVO= (CommResponseVO) tapMioPaymentGateway.process3DSaleConfirmation(trackingId, requestVO);
                    ...
                    if ("Y".equalsIgnoreCase(autoredirect))
                    {
                        ...
                        transactionlogger.error("billingDesc in ---" + billingDesc);
            ...
            catch(Exception e)
            {
                ...
                PZExceptionHandler.raiseAndHandleDBViolationException("tapMioPayFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
            }finally
            {
