 ...
 */
public class CRBackendServlet extends HttpServlet
{
    private static TransactionLogger transactionLogger = new TransactionLogger(CRBackendServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionLogger.error("Entering CRBackendServlet ......",e);
        }
    }
    ...
    public void doService(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException, PZDBViolationException
    {
        ...
        try{
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("CRBackend");
            ...
            transactionLogger.error("Exception Inside CRBackendServlet============>"+e);
        }
