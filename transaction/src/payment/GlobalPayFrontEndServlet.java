...
/**
 * Created by Admin on 1/9/2021.
 */
public class GlobalPayFrontEndServlet   extends HttpServlet
{

    private static TransactionLogger transactionlogger = new TransactionLogger(GlobalPayFrontEndServlet.class.getName());
    ...
    {
        transactionlogger.error("Entering GlobalPayFrontEndServlet ......");
        ...
        while (enumeration.hasMoreElements())
        {
            ...
            transactionlogger.error("---Key---GlobalPayFrontEndServlet---" + key + "---Value---" + value);
...
*/
           ...
           /* String INTERNAL_ACQUIRER_TYPE=req.getParameter("INTERNAL_ACQUIRER_TYPE");//for PhonePe
            ...
            if (transactionDetailsVO != null)
            {
              //  ccnum = PzEncryptor.decryptPAN(transactionDetailsVO.getCcnum());
                ...
                transactionlogger.error("paymodeid ---" + paymodeid);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                   ...
                   // VervePaymentGateway vervePaymentGateway = new VervePaymentGateway(accountId);
                    ...
                    if (commResponseVO != null)
                    {
                        ...
                        transactionStatus= (String) hashMap.get("status");
                        message=(String) hashMap.get("transaction_status");
                        ...
                        else
                        {
                           // message="failed";
                            ...
                            billingDesc="";
                            displayName="";
                            dbBuffer.append("update transaction_common set amount='" + amount + "'"+",status='authfailed',customerIp='" + requestIp + "',customerIpCountry='" + functions.getIPCountryShort(requestIp) + "', remark = '" + message + "'where trackingid = " + trackingId);
                            con = Database.getConnection();
                            Database.executeUpdate(dbBuffer.toString(), con);
        ...
        catch(Exception e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("GlobalPayFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        finally
        {
