 ...
 */
public class IMoneyPayFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(IMoneyPayFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering IMoneyPayFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering IMoneyPayFrontEndServlet ......");
        ...
        try
        {
            transactionlogger.error("..... IMoneyPayFrontEndServlet ......"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("IMPayFrontEnd");
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO  = (CommResponseVO) iMoneyPayPaymentGateway.processQuery(trackingId, requestVO);
