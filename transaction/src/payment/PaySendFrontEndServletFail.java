 ...
 */
public class PaySendFrontEndServletFail extends HttpServlet
{
    private static TransactionLogger transactionLogger = new TransactionLogger(PaySendFrontEndServletFail.class.getName());
    ...
    {
        transactionLogger.error("-----Inside PaySendFrontEndServletFail -----");
        ...
        try
        {
            ...
            try
            {
                ...
                if(PZTransactionStatus.AUTH_STARTED.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    transactionLogger.error("--- in if AUTH_STARTED ----------- STATUS failed ---");
                    ...
                    sb.append("remark='Transaction Failed'");
                    ...
                    transactionLogger.error("common update query PaySendWalletFrontEndFail---" + sb.toString());
