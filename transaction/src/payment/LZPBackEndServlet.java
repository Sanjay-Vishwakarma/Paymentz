...
/**
 * Created by Admin on 9/17/2021.
 */
public class LZPBackEndServlet extends HttpServlet

{

    private static LetzPayGatewayLogger transactionlogger = new LetzPayGatewayLogger(LZPBackEndServlet.class.getName());
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equalsIgnoreCase(dbStatus) || PZTransactionStatus.AUTH_FAILED.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    if ("000".equalsIgnoreCase(RESPONSE_CODE)&&"Captured".equalsIgnoreCase(txnStatus))
                    {
                        ...
                        dbBuffer.append("update transaction_common set captureamount='" + amountRes + "',currency='" + currency + "' ,paymentid='" + TXN_ID + "',status='capturesuccess' ,remark='" + message + "' where trackingid = " + trackingId);
                    ...
                    else if ("Denied due to fraud".equalsIgnoreCase(txnStatus)||"Failed".equalsIgnoreCase(txnStatus)||"Declined".equalsIgnoreCase(txnStatus)||"Rejected".equalsIgnoreCase(txnStatus)||"Failed at Acquirer".equalsIgnoreCase(txnStatus))
                    {
                        ...
                        commResponseVO.setRemark(message);
                        dbBuffer.append("update transaction_common set status='authfailed',paymentid='" + TXN_ID + "' ,remark='" +  message + "'");
