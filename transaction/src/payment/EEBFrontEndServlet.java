 ...
 */
public class EEBFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(EEBFrontEndServlet.class.getName());
    ...
    public void doService(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException
    {
        ...
        transactionLogger.error("-----inside EEBFrontEndServlet-----");
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                EuroEximBankPaymentGateway euroEximBankPaymentGateway=new EuroEximBankPaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO= (CommResponseVO) euroEximBankPaymentGateway.processInquiry(commRequestVO);
                    ...
                    if(functions.isValueNull(responseAmount))
                    {
                        ...
                        transactionLogger.error("EEBFrontEndServlet inquiry response amount --->" + compRsAmount);
                        ...
                        else
                        {
                            ...
                            blacklistVO.setActionExecutorName("EEBFrontEndServlet");
        ...
        catch (PZDBViolationException e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("EEBFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
        catch (NoSuchAlgorithmException e)
        {
            transactionLogger.error("NoSuchAlgorithmException:::::", e);
            PZExceptionHandler.raiseAndHandleTechnicalViolationException("EEBFrontEndServlet.java", "doService()", null, "Transaction", null, PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause(), toid, null);
        }
