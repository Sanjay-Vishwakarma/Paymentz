...
import com.directi.pg.core.paymentgateway.LpbPaymentGateway;
 ...
 */
public class LpbFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionLogger = new TransactionLogger(LpbFrontEndServlet.class.getName());
    ...
    public void doService(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            transactionLogger.debug("PaRes:::::::" + PaRes);
            String trackingId = request.getParameter("MD");
            transactionLogger.debug("trackingId:::::::" + trackingId);
            String cvv = "";
            LpbPaymentProcess lpbPaymentProcess = new LpbPaymentProcess();
            LpbRequestVO commRequestVO = new LpbRequestVO();

            lpbPaymentProcess.setLpbRequestVO(commRequestVO, trackingId, PaRes);
            ...
            try
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    LpbPaymentGateway lpbPaymentGateway = new LpbPaymentGateway(accountId);
                    ...
                    transRespDetails = (CommResponseVO) lpbPaymentGateway.process3DSaleConfirmation(trackingId, commRequestVO);
                    ...
                    if (transRespDetails != null)
                    {
                        ...
                        transactionLogger.debug("Dipescrtion---" + transRespDetails.getTransactionStatus() + "-----" + transRespDetails.getDescription() + "----" + transRespDetails.getErrorCode());
                    ...
                    if ("success".equals(transactionStatus))
                    {
                        ...
                        billingDesc = account.getDisplayName();
            ...
            catch (SystemError se)
            {
                ...
                PZExceptionHandler.raiseAndHandleDBViolationException("LpbFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, se.getMessage(), se.getCause(), toId, null);
            }
            finally
            {
        ...
        catch (PZTechnicalViolationException e)
        {
            ...
            PZExceptionHandler.raiseAndHandleTechnicalViolationException("LpbFrontEndServlet.java", "doService()", null, "Transaction", null, PZTechnicalExceptionEnum.IOEXCEPTION, null, e.getMessage(), e.getCause(), toId, null);
        }
        catch (PZConstraintViolationException e)
        {
            transactionLogger.error("PZConstraintViolationException:::::", e);
            PZExceptionHandler.raiseAndHandleConstraintViolationException("LpbFrontEndServlet.java", "doService()", null, "Transaction", null, PZConstraintExceptionEnum.INVALID_PARAMETER_ENTERED, null, e.getMessage(), e.getCause(), toId, null);
        }
        catch (PZDBViolationException e)
        {
            transactionLogger.error("PZDBViolationException:::::", e);
            PZExceptionHandler.raiseAndHandleDBViolationException("LpbFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toId, null);
        }
        catch (Exception e)
        {
            transactionLogger.error("Exception:::::", e);
            PZExceptionHandler.raiseAndHandleTechnicalViolationException("LpbFrontEndServlet.java", "doService()", null, "Transaction", null, PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause(), toId, null);
        }
    }
}
