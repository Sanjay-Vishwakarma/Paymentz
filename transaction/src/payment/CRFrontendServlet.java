 ...
 */
public class CRFrontendServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CRFrontendServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering CRFrontendServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering CRFrontendServlet ......");
        ...
        try
        {
            transactionlogger.error("..... CRFrontendServlet ......"+trackingId);
            ...
            String decodedParams = cajaRuralUtils.decodeMerchantParameters(Ds_MerchantParameters);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("CRFrontend");
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    {
                        transactionlogger.error("inside CRbackend succes --->");
                    ...
                    {
                        transactionlogger.error("inside CRbackend failed --->");
                        ...
                        transactionlogger.error("inside CRbackendPay pending condition --->"+STATUS+"--"+message+"---"+billingDesc);
                    }
                }
                else
                {
