 ...
 */
public class EBFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(EBFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering EBFrontEndServlet ......",e);
        }
    }
    ...
    public void doService(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException, PZDBViolationException
    {
        ...
        transactionlogger.error("....Entering EBFrontEndServlet ......");
        ...
        try
        {
            ...
            if (transactionDetailsVO!=null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    EaseBuzzPaymentGateway easeBuzzPaymentGateway = new EaseBuzzPaymentGateway(accountId);
                    ...
                    System.out.println("amount front=="+amount);
                    commTransactionDetailsVO.setAmount(amount);
                    requestVO.setTransDetailsVO(commTransactionDetailsVO);
                    requestVO.setAddressDetailsVO(commAddressDetailsVO);

                    con             = Database.getConnection();
                    commResponseVO  = (CommResponseVO) easeBuzzPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if (commResponseVO != null)
                    {
                        ...
                        if(functions.isValueNull(responseAmount))
                        {
                            ...
                            else
                            {
                                ...
                                blacklistVO.setActionExecutorName("EBFrontEndServlet");
                                blacklistVO.setRemark("IncorrectAmount");
                                blacklistManager.commonBlackListing(blacklistVO);
                            }
                        }
                        transactionlogger.error("remark message Easebuzz bank----------------------------------->" + commResponseVO.getRemark());
                        transactionlogger.error("cardtype  ----------------------------------->" + commResponseVO.getBankCode());
