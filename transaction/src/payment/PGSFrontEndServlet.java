 ...
 */
public class PGSFrontEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(PGSFrontEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering PGSFrontEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering PGSFrontEndServlet ......");
        ...
        try
        {
            transactionlogger.error("----- PGSFrontEndServlet Response -----"+trackingId);
            ...
            transactionlogger.error("----- PGSFrontEndServlet Response -----" + responseMsg);
...
//            Thread.sleep(5000);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("PGSFrontEnd");
                auditTrailVO.setActionExecutorId(toid);

                PayGSmilePaymentGateway payGSmilePaymentGateway     = new PayGSmilePaymentGateway(accountId);
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus) || PZTransactionStatus.AUTHSTARTED_3D.toString().equalsIgnoreCase(dbStatus))
                {
                    ...
                    comm3DResponseVO  = (Comm3DResponseVO) payGSmilePaymentGateway.processQuery(trackingId, requestVO);
