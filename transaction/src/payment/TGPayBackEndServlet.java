 ...
 */
public class TGPayBackEndServlet extends HttpServlet
{
    private static TransactionLogger transactionlogger = new TransactionLogger(TGPayBackEndServlet.class.getName());
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            transactionlogger.error("Entering TGPayBackEndServlet ......",e);
        }
    }
    ...
    {
        transactionlogger.error("....Entering TGPayBackEndServlet ......");
        ...
        transactionlogger.error("-----TGPayBackEndServlet   response-----" + responseMsg);
        String ENCDATA          = "";
        String decryptedData    = "";
        try
        {
            transactionlogger.error("..... TGPayBackEndServlet ......"+trackingId);
            ...
            if (transactionDetailsVO != null)
            {
                ...
                auditTrailVO.setActionExecutorName("TGPPayBackEnd");
