 ...
 */
public class vervepayfrontendservlet extends HttpServlet
{
    private static VervePayGatewayLogger transactionlogger = new VervePayGatewayLogger(vervepayfrontendservlet.class.getName());
    ...
    {
        transactionlogger.error("Entering vervepayfrontendservlet ......");
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                   ...
                   // entry.actionEntryFor3DCommon(trackingId, amount, ActionEntry.ACTION_3D_CONFIRMATION_STARTED, ActionEntry.STATUS_3D_CONFIRMATION, null, requestVO, auditTrailVO, requestIp);
                    commResponseVO = (CommResponseVO) vervePaymentGateway.process3DSaleConfirmation(trackingId, requestVO);
                    ...
                    if (commResponseVO != null)
                    {
                        ...
                        else
                        {
                            ...
                            blacklistVO.setActionExecutorName("vervepayfrontendservlet");
                        ...
                        transactionlogger.error("cardtype  vervepay----------------------------------->" + commResponseVO.getBankCode());
