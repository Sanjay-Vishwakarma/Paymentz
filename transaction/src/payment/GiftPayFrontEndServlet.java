...
{
    private static TransactionLogger transactionlogger = new TransactionLogger(GiftPayFrontEndServlet.class.getName());
    ...
    {
        transactionlogger.error("Entering GiftPayFrontEndServlet ......");
        ...
        transactionlogger.error("-----GiftPayFrontEndServlet   response-----" + responseMsg);
           ...
           /* String INTERNAL_ACQUIRER_TYPE=req.getParameter("INTERNAL_ACQUIRER_TYPE");//for PhonePe
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (PZTransactionStatus.AUTH_STARTED.toString().equals(dbStatus))
                {
                    ...
                    commResponseVO = (CommResponseVO) giftPayPaymentGateway.processQuery(trackingId, requestVO);
                    ...
                    if (commResponseVO != null)
                    {
                        ...
                        /*if(functions.isValueNull(responseAmount))
                        {
                            ...
                            else
                            {
                                ...
                                blacklistVO.setActionExecutorName("GiftPayFrontEndServlet");
        ...
        catch(NullPointerException e)
        {
            ...
            PZExceptionHandler.raiseAndHandleDBViolationException("GiftPayFrontEndServlet.java", "doService()", null, "Transaction", null, PZDBExceptionEnum.INCORRECT_QUERY, null, e.getMessage(), e.getCause(), toid, null);
        }
