...
public class IPEntry
{
    ...
    public Hashtable retrievIPForMerchant(String memberId,PaginationVO paginationVO,String actionExecutorId,String actionExecutorName,boolean isLimit)
    {
        ...
        {
            conn = Database.getConnection();
            StringBuffer query =new StringBuffer("SELECT memberId as Id, ipAddress,actionExecutorId,actionExecutorName,type FROM ipwhitelist WHERE memberId=?");
            if(isLimit==true)
            {
    ...
    public Hashtable retrievIPForPartner(String partnerId,PaginationVO paginationVO,String actionExecutorId,String actionExecutorName,boolean isLimit)
    {
        Hashtable recordHash = new Hashtable();
        Connection conn = null;
        try
        {
            conn = Database.getConnection();
            StringBuffer query =new StringBuffer("SELECT partnerId as Id,ipAddress,actionExecutorId,actionExecutorName,type FROM ipwhitelist WHERE partnerId=?");
            if(isLimit==true)
            {
                query.append("LIMIT "+paginationVO.getStart()+","+paginationVO.getEnd());
            }
    ...
    public Hashtable retrievIPForAgent(String agentId,PaginationVO paginationVO,boolean isLimit)
    {
        ...
        {
            conn = Database.getConnection();
            StringBuffer query =new StringBuffer("SELECT agentId as Id, ipAddress,actionExecutorId,actionExecutorName,type FROM ipwhitelist WHERE agentId=?");
            if(isLimit==true)
            {
                query.append("LIMIT "+paginationVO.getStart()+","+paginationVO.getEnd());
            }
...
//            pstmt.setString(3,actionExecutorId);
  //          pstmt.setString(4,actionExecutorName);
    ...
    public Hashtable retrievIPForMerchant1(String memberId,String ipAddress,String type,PaginationVO paginationVO,String actionExecutorId,String actionExecutorName,boolean isLimit)
    {
        Hashtable recordHash = new Hashtable();
        Connection conn = null;
        ...
        {
            conn = Database.getConnection();
            StringBuffer query =new StringBuffer("SELECT id, ipAddress,actionExecutorId,actionExecutorName,type FROM ipwhitelist WHERE memberId=?");
           ...
           /* if(functions.isValueNull(actionExecutorId))
            {
                query.append(" AND actionExecutorId='"+actionExecutorId+"'");
            }
            if(functions.isValueNull(actionExecutorName))
            {
                query.append(" AND actionExecutorName='"+actionExecutorName+"'");
            }
           */ PreparedStatement p = conn.prepareStatement(query.toString());
            p.setString(1,memberId);
    ...
    public void insertIPForMerchant(String memberId,String ipAddress,String actionExecutorId,String actionExecutorName,String type)//String endIpAddress
    {
        Connection conn = null;
        try
        {
            conn = Database.getConnection();
            String query = "INSERT INTO ipwhitelist (memberId,ipAddress,actionExecutorId,actionExecutorName,type) VALUES (?,?,?,?,?)";
            PreparedStatement p =conn.prepareStatement(query);
            p.setString(1,memberId);
    ...
    public void insertIPForPartner(String partnerId,String ipAddress,String actionExecutorId,String actionExecutorName,String type)
    {
        Connection conn = null;
        try
        {
            conn = Database.getConnection();
            String query = "INSERT INTO ipwhitelist (partnerId,ipAddress,actionExecutorId,actionExecutorName,type) VALUES (?,?,?,?,?)";
            PreparedStatement p =conn.prepareStatement(query);
            p.setString(1,partnerId);
            p.setString(2,ipAddress);
            p.setString(3,actionExecutorId);
    ...
    public void insertIPForAgent(String agentId,String ipAddress,String actionExecutorId,String actionExecutorName,String type)
    {
        Connection conn = null;
        try
        {
            conn = Database.getConnection();
            String query = "INSERT INTO ipwhitelist (agentId,ipAddress,actionExecutorId,actionExecutorName,type) VALUES (?,?,?,?,?)";
            PreparedStatement p =conn.prepareStatement(query);
            p.setString(1,agentId);
            p.setString(2,ipAddress);
            p.setString(3,actionExecutorId);
