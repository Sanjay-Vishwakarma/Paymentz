 ...
 */
public class TotalPayInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(TotalPayInputValidator.class.getName());
        ...
        for (InputFields inputFields1 : inputFields) {
            switch (inputFields1)
            {
                ...
                case STATE:
                    ...
                    break;
                case CARDHOLDERIP:
                    transactionLogger.error("genericAddressDetailsVO.getCardHolderIpAddress()--->"+genericAddressDetailsVO.getCardHolderIpAddress());
