 ...
 */
public class QikPayUtils
{

    private final static ResourceBundle BPBANKSID = LoadProperties.getProperty("com.directi.pg.BPBANKSID");
    private static QikPayGatewayLogger transactionlogger = new QikPayGatewayLogger(QikPayUtils.class.getName());
    ...
    public CommRequestVO getQikPayRequestVO(CommonValidatorVO commonValidatorVO)
    {
