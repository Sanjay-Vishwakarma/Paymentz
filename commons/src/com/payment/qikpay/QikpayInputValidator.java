 ...
 */
public class QikpayInputValidator  extends CommonInputValidator
{
    private static Logger log = new Logger(QikpayInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(QikpayInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  QikpayInputValidator------------>"+error);
