 ...
 */
public class QikPayPaymentProcess  extends CommonPaymentProcess
{
    private static QikPayGatewayLogger transactionlogger = new QikPayGatewayLogger(QikPayPaymentProcess.class.getName());

    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        transactionlogger.error("inside  QikPayPaymentProcess Form---");
        ...
        transactionlogger.error("QikPayPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.error("inside QikPay Process --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside QikPay getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D, CommonValidatorVO commonValidatorVO)
    {
        ...
        transactionlogger.debug("inside  QikPay payment process---"+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for QikPayPaymentGateway");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery qikpay-----" + pstmt);
