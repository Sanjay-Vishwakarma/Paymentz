 ...
 */
public class XceptsPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(XceptsPaymentProcess.class.getName());
    private static Functions functions  = new Functions();

    @Override
    public String get3DConfirmationForm(String trackingId, String ctoken, Comm3DResponseVO response3D)
    {
        transactionlogger.error("Xcepts 3d page displayed....." + response3D.getUrlFor3DRedirect());
        ...
        transactionlogger.error("XceptsPaymentProcess form for "+trackingId+" ---->"+ form);
        return form;
    }

    public DirectKitResponseVO setNBResponseVO(DirectKitResponseVO directKitResponseVO, CommonValidatorVO commonValidatorVO)
    {
        transactionlogger.error("inside XceptsPaymentProcess --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside XceptsPaymentProcess getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    {
        transactionlogger.debug("inside  XceptsPaymentProcess---"+response3D.getUrlFor3DRedirect());
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        {
            transactionlogger.error("SystemError in XceptsPaymentProcess---",systemError);
            PZExceptionHandler.raiseDBViolationException(XceptsPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in XceptsPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(XceptsPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
    ...
    public void setRefundVOParamsextension(CommRequestVO requestVO, PZRefundRequest refundRequest) throws PZDBViolationException
    {
        ...
        transactionlogger.error("trackingid in Xcepts----" + refundRequest.getTrackingId());
        ...
        if (functions.isValueNull(requestVO.getTransDetailsVO().getOrderDesc()))
    ...
    {
        transactionlogger.debug("Entering ActionEntry for XceptsPaymentProcess");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery Xcepts :-----" + pstmt);
