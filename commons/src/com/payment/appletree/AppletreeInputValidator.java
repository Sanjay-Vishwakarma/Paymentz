 ...
 */
public class AppletreeInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(AppletreeInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname,String addressValidation)
    {
        transactionLogger.error(":::::inside AppletreeInputValidator::::: " +addressValidation);
        ...
        for (InputFields inputFields1 : inputFields) {
            switch (inputFields1)
            {
                ...
                case COUNTRYCODE:
                    ...
                    break;
                case CITY:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getCity(), "City", 50, false))
                    {
                ...
                case ZIP:
                    ...
                    break;
                case STATE:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getState(), "Address", 100, false))
                    {
                ...
                case ORDERDESCRIPTION:
                    ...
                    break;
                case FIRSTNAME:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getFirstname(), "AccentUsername", 40, false))
                    {
                    ...
                    break;
                case LASTNAME:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getLastname(), "AccentUsername", 40, false))
                    {
