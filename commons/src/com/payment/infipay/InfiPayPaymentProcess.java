 ...
 */
public class InfiPayPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(InfiPayPaymentProcess.class.getName());
    private static Functions functions                 = new Functions();

    @Override
    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        transactionlogger.error("inside  InfipayPaymentProcess Form---");
        ...
        transactionlogger.error("InfipayPaymentProcess Form---"+form.toString());
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        catch (SystemError systemError)
        {
            ...
            PZExceptionHandler.raiseDBViolationException(InfiPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in BoomBill---", e);
            PZExceptionHandler.raiseDBViolationException(InfiPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
    ...
    public void setPayoutVOParamsextension(CommRequestVO requestVO, PZPayoutRequest payoutRequest) throws PZDBViolationException
    {
        ...
        commTransactionDetailsVO.setBankAccountNo(payoutRequest.getCustomerBankAccountNumber());
