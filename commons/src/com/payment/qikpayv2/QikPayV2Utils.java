 ...
 */
public class QikPayV2Utils
{

    private final static ResourceBundle BPBANKSID           = LoadProperties.getProperty("com.directi.pg.QPNBANKS");
    private static TransactionLogger transactionlogger      = new TransactionLogger(QikPayV2Utils.class.getName());
    ...
    public CommRequestVO getQPayNRequestVO(CommonValidatorVO commonValidatorVO)
    {
    ...
    public static String doGetHTTPSURLConnectionClient(String url,String request) throws PZTechnicalViolationException
    {
        ...
        catch (HttpException he)
        {
            ...
            PZExceptionHandler.raiseTechnicalViolationException("QikPayV2Utils.java", "doGetHTTPSURLConnectionClient()", null, "common", "Technical Exception Occurred", PZTechnicalExceptionEnum.HTTP_EXCEPTION, null, he.getMessage(), he.getCause());
        }
        catch (IOException io)
        {
            transactionlogger.error("IOException----"+io);
            PZExceptionHandler.raiseTechnicalViolationException("QikPayV2Utils.java","doGetHTTPSURLConnectionClient()",null,"common","Technical Exception Occurred", PZTechnicalExceptionEnum.IOEXCEPTION,null,io.getMessage(),io.getCause());
        }finally
        {
    ...
    public static String encryptAES(String message, String key) throws PZTechnicalViolationException
    {
        ...
        catch (NoSuchPaddingException e)
        {
            ...
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.NOSUCH_PADDING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (BadPaddingException e)
        {
            transactionlogger.error("BadPaddingException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.BAD_PADDING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (NoSuchAlgorithmException e)
        {
            transactionlogger.error("NoSuchAlgorithmException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (IllegalBlockSizeException e)
        {
            transactionlogger.error("IllegalBlockSizeException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.ILLEGAL_BLOCK_SIZE_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (UnsupportedEncodingException e)
        {
            transactionlogger.error("UnsupportedEncodingException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.UNSUPPORTED_ENCOADING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (InvalidKeyException e)
        {
            transactionlogger.error("InvalidKeyException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "encryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.INVALID_KEY_EXCEPTION, null, e.getMessage(), e.getCause());
        }
    ...
    public static String decryptAES(String data,String key) throws PZTechnicalViolationException
    {
        ...
        {
            transactionlogger.error("NoSuchPaddingException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.NOSUCH_PADDING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (BadPaddingException e)
        {
            transactionlogger.error("BadPaddingException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.BAD_PADDING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (NoSuchAlgorithmException e)
        {
            transactionlogger.error("NoSuchAlgorithmException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (IllegalBlockSizeException e)
        {
            transactionlogger.error("IllegalBlockSizeException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.ILLEGAL_BLOCK_SIZE_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (UnsupportedEncodingException e)
        {
            transactionlogger.error("UnsupportedEncodingException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.UNSUPPORTED_ENCOADING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (InvalidKeyException e)
        {
            transactionlogger.error("InvalidKeyException --->", e);
            PZExceptionHandler.raiseTechnicalViolationException(QikPayV2Utils.class.getName(), "decryptAES()", null, "common", "Technical Exception Occurred. Please contact your Admin:::", PZTechnicalExceptionEnum.INVALID_KEY_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (InvalidAlgorithmParameterException e)
        {
            transactionlogger.error("InvalidAlgorithmParameterException --->", e);
