 ...
 */
public class CashFreeInputValidator extends CommonInputValidator
{
    private static Logger log = new Logger(CashFreeInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(CashFreeInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  CashFreeInputValidator------------>"+error);
