 ...
 */
public class SecureTradingInputValidator extends CommonInputValidator
{
    private static Logger log = new Logger(SecureTradingInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(SecureTradingInputValidator.class.getName());
    ...
    public  String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO,String actionName,String addressValidation)
    {
        ...
        if ("Y".equalsIgnoreCase(addressValidation))
        {
            ...
            InputValidationsForSecureTrading(commonValidatorVO, param, errorList, false);
    ...
    public  void InputValidationsForSecureTrading(CommonValidatorVO commonValidatorVO, List<InputFields> inputList, ValidationErrorList validationErrorList, boolean isOptional)
    {
