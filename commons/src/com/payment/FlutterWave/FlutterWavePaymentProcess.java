...
/**
 * Created by Jitendra on 20-Apr-19.
 */
public class FlutterWavePaymentProcess  extends CommonPaymentProcess
{

    //transactionLogger transactionLogger= new transactionLogger(FlutterWavePaymentProcess.class.getName());
      FlutterWaveLogger transactionLogger= new FlutterWaveLogger(FlutterWavePaymentProcess.class.getName());
    ...
    public String get3DConfirmationFormVT(String trackingId, String ctoken, Comm3DResponseVO response3D)
    {
        ...
        transactionLogger.error("3d page displayed....." + response3D.getUrlFor3DRedirect());
        transactionLogger.debug("ter url ----------------------"+response3D.getTerURL());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        directKitResponseVO.setTarget(response3D.getTarget());
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        catch (SystemError systemError)
        {
            ...
            PZExceptionHandler.raiseDBViolationException(FlutterWavePaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionLogger.error("SQLException in OmnipayPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(FlutterWavePaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
