 ...
 */
public class AsyncSafexPayPayoutQueryService
{
    private static SafexPayGatewayLogger transactionLogger = new SafexPayGatewayLogger(AsyncSafexPayPayoutQueryService.class.getName());
    ...
    public   AsyncSafexPayPayoutQueryService()
    {
    ...
    public AsyncSafexPayPayoutQueryService(String trackingid,String accountId,String paymentId,String afterExecuteTime,String delayTime,String maxExecutionTime)
    {
        //timer = new Timer();
        //timer.schedule(new RemindTask(), seconds*1000);
        transactionLogger.error("inside AsyncSafexPayPayoutQueryService -------");
        ...
        public String call() throws Exception
        {
            try
            {
                ...
                exec.scheduleAtFixedRate(new Runnable()
                {
                    ...
                    {
                        // do stuff
                        transactionLogger.error("------Inside AsyncSafexPayPayoutQueryService run() method for trackingid--------" + trackingid);
    ...
    {
        transactionLogger.error("------Inside AsyncSafexPayPayoutQueryService callQuery method--------");
        ...
        transactionLogger.error("Inside call for AsyncSafexPayPayoutQueryService---"+trackingid+"--");
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (dbStatus.equalsIgnoreCase(PZTransactionStatus.PAYOUT_STARTED.toString()))
                {
                    ...
                    genericResponseVO = (CommResponseVO) safexPayPaymentGateway.processPayoutInquiry(trackingid, commRequestVO);
