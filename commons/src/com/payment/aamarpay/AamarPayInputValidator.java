 ...
 */
public class AamarPayInputValidator extends CommonInputValidator
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(AamarPayInputValidator.class.getName());
    ...
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  AamarPayInputValidator------------>"+error+" "+addressValidation);
