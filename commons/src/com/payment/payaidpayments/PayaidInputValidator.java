...
/**
 * Created by Admin on 12/27/2021.
 */
public class PayaidInputValidator extends CommonInputValidator
{
    private static Logger log = new Logger(PayaidInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(PayaidInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  PayaidInputValidator------------>"+error);
