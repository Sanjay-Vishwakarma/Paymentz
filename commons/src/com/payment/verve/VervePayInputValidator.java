 ...
 */
public class VervePayInputValidator extends CommonInputValidator
{
        private static Logger log = new Logger(VervePayInputValidator.class.getName());
        private static TransactionLogger transactionLogger = new TransactionLogger(VervePayInputValidator.class.getName());
        public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
        {
            ...
            transactionLogger.error("error  VervepayInputValidator------------>"+error);
