...
public class VerveUtils
{
    ...
    private static VervePayGatewayLogger transactionlogger = new VervePayGatewayLogger(VerveUtils.class.getName());
    ...
    public CommRequestVO getVervePayRequestVO(CommonValidatorVO commonValidatorVO)
    {
        ...
        transactionlogger.error("verveutils phone is-------------->"+commonValidatorVO.getAddressDetailsVO().getPhone());
    ...
    public Boolean updateTransaction (String trackingid, String paymentid,String customerId){
        ...
        try
        {
            ...
            String update = "update transaction_common set paymentid = ?, customerid=? where trackingid=?";
            psUpdateTransaction = con.prepareStatement(update.toString());
            psUpdateTransaction.setString(1,paymentid);
            psUpdateTransaction.setString(2, customerId);
 ...
 /*   public HashMap getPaymentType(String paymentMethod)
    {
        HashMap paymentmodeMap =new HashMap();
        String payModeID = "";
        String cardtypeID = "";

        if("Netbanking".equalsIgnoreCase(paymentMethod))
        {
            payModeID = "79";cardtypeID = "79";
            paymentmodeMap.put(payModeID,cardtypeID);
        }
        else{
            payModeID = "18";cardtypeID = "1301";
            paymentmodeMap.put(payModeID,cardtypeID);
        }
