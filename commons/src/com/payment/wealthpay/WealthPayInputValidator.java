...
/**
 * Created by admin on 17-Aug-21.
 */
public class WealthPayInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(WealthPayInputValidator.class.getName());
    private Functions functions = new Functions();

    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname, String addressValidation)
    {

        transactionLogger.error("inside WealthPayInputValidator ----- " + actionname);
        String error="";
        ...
        for (InputFields inputFields1 : inputFields) {
            switch (inputFields1)
            {
                case EMAILADDR:
                    ...
                    break;
                case TELNO:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getPhone(), "Phone", 25, isOptional))
                    {
