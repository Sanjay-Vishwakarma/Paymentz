            ...
            switch(input)
            {
                ...
                case ACCOUNTNUMBER:
                    if (!ESAPI.validator().isValidInput(input.toString(), /*commonValidatorVO.getReserveField2VO().getAccountNumber()*/accountNumber, "OnlyNumber", 17, isOptional))
                    {
                        ...
                        validationErrorList.addError(input.toString(), new PZValidationException(errorCodeVO.getErrorCode()+"_"+errorCodeVO.getErrorDescription(), errorCodeVO.getErrorCode()+"_"+errorCodeVO.getErrorDescription()+ ":::" + accountNumber, errorCodeVO));
                        if (commonValidatorVO.getErrorCodeListVO() != null)
                            commonValidatorVO.getErrorCodeListVO().addListOfError(errorCodeVO);
                ...
                case ROUTINGNUMBER:
                    if (!ESAPI.validator().isValidInput(input.toString(), /*commonValidatorVO.getReserveField2VO().getRoutingNumber()*/routingNumber, "OnlyNumber", 9, isOptional))
                    {
                        ...
                        validationErrorList.addError(input.toString(), new PZValidationException(errorCodeVO.getErrorCode() + "_" + errorCodeVO.getErrorDescription(), errorCodeVO.getErrorCode() + "_" + errorCodeVO.getErrorDescription() + ":::" + routingNumber, errorCodeVO));
                        if (commonValidatorVO.getErrorCodeListVO() != null)
                            commonValidatorVO.getErrorCodeListVO().addListOfError(errorCodeVO);
