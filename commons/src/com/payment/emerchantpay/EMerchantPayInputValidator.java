 ...
 */
public class EMerchantPayInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger = new TransactionLogger(EMerchantPayInputValidator.class.getName());
    ...
    {
        transactionLogger.error(":::::Inside EMerchantPayInputValidator :::::");
