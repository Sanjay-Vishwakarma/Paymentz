 ...
 */
public class BnmQuickInputValidator extends CommonInputValidator
{

    private static TransactionLogger transactionLogger  = new TransactionLogger(BnmQuickInputValidator.class.getName());
    ...
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  BnmQuickInputValidator------------>"+error+" "+addressValidation);
