 ...
 */
public class ApexPayInputValidator extends CommonInputValidator
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(ApexPayInputValidator.class.getName());
