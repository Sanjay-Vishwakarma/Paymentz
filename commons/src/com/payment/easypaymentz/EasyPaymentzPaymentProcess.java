 ...
 */
public class EasyPaymentzPaymentProcess extends CommonPaymentProcess
{

    private static TransactionLogger transactionlogger = new TransactionLogger(EasyPaymentzPaymentProcess.class.getName());

    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
    transactionlogger.error("inside  EasyPaymentzPaymentProcess Form---");
    ...
    transactionlogger.error("EasyPaymentzPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.error("inside EasyPaymentz Process --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside EasyPaymentz getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D, CommonValidatorVO commonValidatorVO)
    {
        ...
        transactionlogger.debug("inside  EasyPaymentz payment process---"+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for EasyPaymentzPaymentGateway");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery EasyPaymentz-----" + pstmt);
