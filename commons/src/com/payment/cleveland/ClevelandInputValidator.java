...
/**
 * Created by Admin on 10/23/2021.
 */
public class ClevelandInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(ClevelandInputValidator.class.getName());

    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname, String addressValidation)
    {

        transactionLogger.error("inside ClevelandInputValidator ----- " + actionname);
        String error="";
        ...
        addressParameter.add(InputFields.FIRSTNAME);
        addressParameter.add(InputFields.LASTNAME);
        addressParameter.add(InputFields.EMAILADDR);
        addressParameter.add(InputFields.TELNO);
        addressParameter.add(InputFields.TELCC);
        ...
        InputValidationsforCleveland(commonValidatorVO, mandatoryParameter, errorList2, false);
        ...
        if("Y".equals(addressValidation))
        {
            ...
            InputValidationsforCleveland(commonValidatorVO, addressParameter, errorList, false);
        ...
        {
            ValidationErrorList errorList = new ValidationErrorList();
            InputValidationsforCleveland(commonValidatorVO, addressParameter, errorList, true);
            error = error + inputValiDatorUtils.getError(errorList, addressParameter, actionname);
    ...
    private void InputValidationsforCleveland(CommonValidatorVO commonValidatorVO, List<InputFields> inputFields, ValidationErrorList validationErrorList, boolean isOptional)
    {
