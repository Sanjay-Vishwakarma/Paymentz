 ...
 */
public class EuroEximBankInputVaidator extends CommonInputValidator
{
    private static Logger log = new Logger(EuroEximBankInputVaidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(EuroEximBankInputVaidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  EuroEximBankInputVaidator------------>"+error);
