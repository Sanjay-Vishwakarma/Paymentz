...
/**
 * Created by Balaji Sawant on 27-Sep-19.
 */
public class ECPPaymentProcess  extends CommonPaymentProcess
{
    TransactionLogger transactionLogger= new TransactionLogger(ECPPaymentProcess.class.getName());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        transactionLogger.debug("inside ECP payment process---"+response3D.getUrlFor3DRedirect());
        ...
        asyncParameterVO= new AsyncParameterVO();
        asyncParameterVO.setName("method");
        asyncParameterVO.setValue("GET");
        directKitResponseVO.addListOfAsyncParameters(asyncParameterVO);
    }
}
