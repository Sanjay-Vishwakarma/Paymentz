 ...
 */
public class CajaRuralPaymentGateway extends AbstractPaymentGateway
{

    private static TransactionLogger transactionLogger=new TransactionLogger(CajaRuralPaymentGateway.class.getName());

    private static Logger log=new Logger(CajaRuralPaymentGateway.class.getName());
    public static final String GATEWAY_TYPE="cajarural";
    ResourceBundle RB= LoadProperties.getProperty("com.directi.pg.Cajarural");
    //private static ResourceBundle RB= LoadProperties.getProperty("com.directi.pg.Repropay");
    public CajaRuralPaymentGateway(String accountId){
    ...
    {
        transactionLogger.error("******Inside CajaRuralPaymentGateway processSale()*************");
        log.error("******Inside CajaRuralPaymentGateway processSale()*************");
        ...
        CajaRuralUtils reproPayUtills=new CajaRuralUtils();
        ...
        try
        {
            ...
            CajaRuralUtils sha256 = new CajaRuralUtils();
    ...
    public String  processAutoRedirect(CommonValidatorVO commonValidatorVO) throws PZTechnicalViolationException, PZDBViolationException
    {
        ...
        CajaRuralPaymentProcess reproPayPaymentProcess           = new CajaRuralPaymentProcess();
        CommRequestVO commRequestVO          = cajaRuralUtils.getCajaruralRequestVO(commonValidatorVO);
        GatewayAccount gatewayAccount       = GatewayAccountService.getGatewayAccount(accountId);
    ...
    public GenericResponseVO processAuthentication(String trackingID, GenericRequestVO requestVO) throws PZTechnicalViolationException, PZDBViolationException, PZConstraintViolationException, PZGenericConstraintViolationException
    {
        ...
        PZGenericConstraint genConstraint = new PZGenericConstraint("CajaRuralPaymentGateway", "processAuthentication", null, "common", "This Functionality is not supported by processing gateway. Please contact your Tech. support Team:::", errorCodeListVO);
    ...
    {
        transactionLogger.error("******Inside CajaRuralPaymentGateway processRefund()*************");
        log.error("******Inside CajaRuralPaymentGateway processRefund()*************");
