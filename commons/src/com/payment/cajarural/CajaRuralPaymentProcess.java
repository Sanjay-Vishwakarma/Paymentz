 ...
 */
public class CajaRuralPaymentProcess extends CommonPaymentProcess
{
    private TransactionLogger transactionLogger= new TransactionLogger(CajaRuralPaymentProcess.class.getName());
    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        transactionLogger.error("inside  CajaRuralPaymentProcess Form---");
        ...
        transactionLogger.error("CajaRuralPaymentProcess Form---" + form.toString());
