 ...
 */
public class SwiffyInputValidator extends CommonInputValidator
{

    private static TransactionLogger transactionLogger =new  TransactionLogger(SwiffyInputValidator.class.getName());
...
//        transactionLogger.error("error  SwiffyInputValidator------------>"+error+" "+addressValidation);
