 ...
 */
public class CBCGInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(CBCGInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname,String addressValidation)
    {
        ...
        if("Y".equals(addressValidation))
        {
            ...
            InputValidationsforCBCG(commonValidatorVO, parameter, errorList, false);
        ...
        else
        {
            ...
            ValidationErrorList errorList = new ValidationErrorList();
            ValidationErrorList errorList1 = new ValidationErrorList();
            InputValidationsforCBCG(commonValidatorVO, parameter, errorList, true);
            error = error + inputValiDatorUtils.getError(errorList, parameter, actionname);
    ...
    private void InputValidationsforCBCG(CommonValidatorVO commonValidatorVO, List<InputFields> inputFields, ValidationErrorList validationErrorList, boolean isOptional)
    {
        ...
        for (InputFields inputFields1 : inputFields) {
            switch (inputFields1)
            {
                case EMAILADDR:
                    ...
                    break;
                case TELCC:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getTelnocc(), "Number", 15, isOptional))
                    {
