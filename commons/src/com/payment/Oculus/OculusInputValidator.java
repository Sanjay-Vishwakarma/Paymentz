...
public class OculusInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(OculusInputValidator.class.getName());
    private Functions functions = new Functions();

    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname, String addressValidation)
    {

        transactionLogger.error("inside OculusInputValidator -----");
        String error="";
