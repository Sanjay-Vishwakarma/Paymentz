 ...
 */
public class GlobalGatePaymentProcess extends CommonPaymentProcess
{

    private static TransactionLogger transactionLogger=new TransactionLogger(GlobalGatePaymentProcess.class.getName());
    ...
    {
        transactionLogger.debug("inside globalgateprocess===");
        ...
        {
            birthday = GlobalGateUtils.getBirthday(commonValidatorVO.getAddressDetailsVO().getBirthdate(),null);
        }
        ...
        String apmName=globalGateUtils.getAPMName(cardTypeId);
        String mainAcq = "";
        String addressXML = "";
        ...
        try
        {
            ...
            String hash = globalGateUtils.getMD5HashVal(xmlToPostForMD5);
    ...
    {
        AsyncParameterVO asyncParameterVO = null;
        transactionLogger.debug("inside globalgate payment process---"+response3D.getUrlFor3DRedirect());
