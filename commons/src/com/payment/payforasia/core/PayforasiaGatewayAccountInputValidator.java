 ...
 */
public class PayforasiaGatewayAccountInputValidator extends CommonGatewayAccountInputValidator
{

    private static Logger logger = new Logger(PayforasiaGatewayAccountInputValidator.class.getName());
