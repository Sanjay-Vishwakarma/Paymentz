 ...
 */
public class PayforasiaPaymentGateway extends AbstractPaymentGateway
{
    public static final String GATEWAY_TYPE = "payforasia";
    ...
    private static TransactionLogger transactionlogger = new TransactionLogger(PayforasiaPaymentGateway.class.getName());
    private static Logger logger = new Logger(PayforasiaPaymentGateway.class.getName());


    public PayforasiaPaymentGateway(String accountId)
    {
    ...
    public static String SHA256forRefund(String merchantNo, String gatewayNo, String tradeNo, String refundType, String signKey) throws PZTechnicalViolationException
    {
        ...
        {
            PZExceptionHandler.raiseTechnicalViolationException(PayforasiaPaymentGateway.class.getName(), "SHA256forRefund()", null, "common", "NoSuchAlgorithm Exception while placing transaction", PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (UnsupportedEncodingException e)
        {
            PZExceptionHandler.raiseTechnicalViolationException(PayforasiaPaymentGateway.class.getName(), "SHA256forRefund()", null, "common", "UnsupportedEncodingException  while placing transaction", PZTechnicalExceptionEnum.UNSUPPORTED_ENCOADING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
    ...
    public static String SHA256forInquiry(String merchantNo, String gatewayNo, String signKey) throws PZTechnicalViolationException
    {
        ...
        {
            PZExceptionHandler.raiseTechnicalViolationException(PayforasiaPaymentGateway.class.getName(), "SHA256forInquiry()", null, "common", "NoSuchAlgorithm Exception while placing transaction", PZTechnicalExceptionEnum.NOSUCH_ALGO_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        catch (UnsupportedEncodingException e)
        {
            PZExceptionHandler.raiseTechnicalViolationException(PayforasiaPaymentGateway.class.getName(), "SHA256forInquiry()", null, "common", "UnsupportedEncodingException  while placing transaction", PZTechnicalExceptionEnum.UNSUPPORTED_ENCOADING_EXCEPTION, null, e.getMessage(), e.getCause());
        }
    ...
    public GenericResponseVO processSale(String trackingID, GenericRequestVO requestVO) throws PZTechnicalViolationException, PZConstraintViolationException
    {
        ...
        transactionlogger.error("Entering processSale of Payforasia...");
        ...
        transactionlogger.error("------request----" + logRequest);
        //transactionlogger.error("payforasia request----" + strRequest);
        String response = PayforasiaUtils.doPostHTTPSURLConnection(URL, strRequest);
        transactionlogger.error("------sale response------"+"trackingid"+trackingID + response);
    ...
    {
        transactionlogger.info("  Inside   PayforasiaPaymentGateway  ::::::::");
...
*/
        ...
        transactionlogger.error("------- rebill request----" +"trackingid"+trackingID+ logRequest);
        String response = PayforasiaUtils.doPostHTTPSURLConnection(URL, strRequest);
        transactionlogger.error("-------rebill response------" +"trackingid"+trackingID+ response);
  ...
  /*  public static void main(String[] args) throws PZTechnicalViolationException
    ...
    private void validateForRebill(String trackingID, GenericRequestVO requestVO) throws PZConstraintViolationException
    {
        if (trackingID == null || trackingID.equals(""))
        {
            PZExceptionHandler.raiseConstraintViolationException(PayforasiaPaymentGateway.class.getName(), "validateForRebill()", null, "common", "Tracking Id not provided while placing transaction", PZConstraintExceptionEnum.MANDATORY_PARAMETER_MISSING, null, "Tracking Id not provided while placing transaction", new Throwable("Tracking Id not provided while placing transaction"));
        }
        ...
        {
            PZExceptionHandler.raiseConstraintViolationException(PayforasiaPaymentGateway.class.getName(), "validateForRebill()", null, "common", "TransactionDetails  not provided while placing transaction", PZConstraintExceptionEnum.VO_MISSING, null, "TransactionDetails  not provided while placing transaction", new Throwable("TransactionDetails  not provided while placing transaction"));
        }
        if (commTransactionDetailsVO.getAmount() == null || commTransactionDetailsVO.getAmount().equals(""))
        {
            PZExceptionHandler.raiseConstraintViolationException(PayforasiaPaymentGateway.class.getName(), "validateForRebill()", null, "common", "Amount not provided while placing transaction", PZConstraintExceptionEnum.MANDATORY_PARAMETER_MISSING, null, "Amount not provided while placing transaction", new Throwable("Amount not provided while placing transaction"));
        }
    }
}