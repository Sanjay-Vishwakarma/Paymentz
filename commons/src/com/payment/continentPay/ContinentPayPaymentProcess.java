 ...
 */
public class ContinentPayPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(ContinentPayPaymentProcess.class.getName());


    @Override
    public String get3DConfirmationForm(String trackingId, String ctoken, Comm3DResponseVO response3D)
    {
        transactionlogger.error("ContinentPay 3d page displayed....." + response3D.getUrlFor3DRedirect());
        ...
        transactionlogger.error("ContinentPayPaymentProcess form for "+trackingId+" ---->"+ form);
        return form;
    }

    public DirectKitResponseVO setNBResponseVO(DirectKitResponseVO directKitResponseVO, CommonValidatorVO commonValidatorVO)
    {
        transactionlogger.error("inside ContinentPayPaymentProcess --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside ContinentPayPaymentProcess getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    {
        transactionlogger.debug("inside  ContinentPayPaymentProcess---"+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for ContinentPayPaymentProcess");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery ContinentPay :-----" + pstmt);
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        {
            transactionlogger.error("SystemError in ContinentPayPaymentProcess---",systemError);
            PZExceptionHandler.raiseDBViolationException(ContinentPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in ContinentPayPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(ContinentPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
