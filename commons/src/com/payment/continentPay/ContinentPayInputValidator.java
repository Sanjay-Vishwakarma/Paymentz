 ...
 */
public class ContinentPayInputValidator extends CommonInputValidator
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(ContinentPayInputValidator.class.getName());
    ...
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        params.add(InputFields.TELNO);
        params.add(InputFields.TELCC);
        params.add(InputFields.EMAILADDR);
        params.add(InputFields.CARDHOLDERIP);
            ...
            switch (inputFields1)
            {
                ...
                case STATE:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getState(), "StrictString", 2, isOptional))
                    {
                        ...
                        errorCodeVO.setErrorDescription("Invalid state code, accepts only [a-z][A-Z] with max length 2");
                        errorCodeVO.setApiDescription("Invalid state code, accepts only [a-z][A-Z] with max length 2");
