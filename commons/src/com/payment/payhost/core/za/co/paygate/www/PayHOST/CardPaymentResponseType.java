...
public class CardPaymentResponseType  implements java.io.Serializable {
    private com.payment.payhost.core.za.co.paygate.www.PayHOST.StatusType status;

    //private com.payment.payhost.core.za.co.paygate.www.PayHOST.RedirectResponseType redirect;

    //private com.payment.payhost.core.za.co.paygate.www.PayHOST.KeyValueType[] userDefinedFields;

    public CardPaymentResponseType() {
    }

    public CardPaymentResponseType(
            com.payment.payhost.core.za.co.paygate.www.PayHOST.StatusType status)
            //com.payment.payhost.core.za.co.paygate.www.PayHOST.RedirectResponseType redirect,
    ...
    /**
     * Gets the status value for this CardPaymentResponseType.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this CardPaymentResponseType.
     * 
     * @param status
     */
    ...
    /**
     * Gets the redirect value for this CardPaymentResponseType.
     * 
     * @return redirect
     */
    /*public com.payment.payhost.core.za.co.paygate.www.PayHOST.RedirectResponseType getRedirect() {
        return redirect;
    }
*/

    /**
     * Sets the redirect value for this CardPaymentResponseType.
     * 
     * @param redirect
     */
    /*public void setRedirect(com.payment.payhost.core.za.co.paygate.www.PayHOST.RedirectResponseType redirect) {
        this.redirect = redirect;
    }
*/

    /**
     * Sets the userDefinedFields value for this CardPaymentResponseType.
     *
...
*/
    /**
     * Gets the userDefinedFields value for this CardPaymentResponseType.
     *
...
*/
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CardPaymentResponseType)) return false;
        CardPaymentResponseType other = (CardPaymentResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CardPaymentResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.paygate.co.za/PayHOST", "CardPaymentResponseType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.paygate.co.za/PayHOST", "RedirectResponseType"));
