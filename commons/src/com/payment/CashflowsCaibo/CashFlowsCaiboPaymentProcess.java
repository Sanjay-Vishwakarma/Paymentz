 ...
 */
public class CashFlowsCaiboPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(CashFlowsCaiboPaymentProcess.class.getName());

    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        transactionlogger.error("inside  CashFlowsCaiboPaymentProcess Form---");
        ...
        transactionlogger.error("CashFlowsCaiboPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.error("inside CashFlowsCaiboPaymentProcess --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside CashFlowsCaiboPaymentProcess getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        transactionlogger.debug("inside  CashFlowsCaiboPaymentProcess---"+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for CashFlowsCaiboPaymentProcess");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery CashFlowsCaiboPaymentProcess-----" + pstmt);
    ...
    public void setCashflowsCaiboRequestVO(CommRequestVO requestVO, String trackingId, String cvv, String DB) throws PZDBViolationException
    {
        ...
        commAddressDetailsVO.setBirthdate(DB);
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        {
            transactionlogger.error("SystemError in CashFlowsCaiboPaymentProcess---",systemError);
            PZExceptionHandler.raiseDBViolationException(CashFlowsCaiboPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in CashFlowsCaiboPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(CashFlowsCaiboPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
