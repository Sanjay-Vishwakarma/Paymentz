 ...
 */
public class PayvisonV2PaymentGateway extends AbstractPaymentGateway
{
    private static Logger logger=new Logger(PayvisonV2PaymentGateway.class.getName());
    private static TransactionLogger transactionLogger=new TransactionLogger(PayvisonV2PaymentGateway.class.getName());
    public static final String GATEWAY_TYPE="pavisionV2";
    String url1="";

    public PayvisonV2PaymentGateway(String accountId)
    {
                ...
                if (jsonObject!=null)
                {
                    ...
                    if (jsonObject1!=null)
                    {
                       ...
                       /* if (jsonObject1.has("ChallengePayload"))
                        {
                            JSONObject object=jsonObject1.getJSONObject("ChallengePayload");
                            if (object!=null)
                            {
    ...
    public static void authenticate()
    {
        ...
        try
        {
            ...
            transactionLogger.error("Authenticate response----"+response);
            System.out.println("Authenticate response----"+response);
            ...
            if (functions.isValueNull(response) && response.startsWith("{"))
            {
                ...
                if (jsonObject!=null)
                {
                    ...
                    if (jsonObject1!=null)
                    {
                        ...
                        String result="";
                        String authenticationIndicator="";
                        //JSONObject ChallengePayload=null;
                        String dateTime="";
                        String enrolled="";
                        String issuerUrl="";
                        String threeDSFlow="";
                        ...
                        /*if (jsonObject1.has("ChallengePayload"))
                        {
                            ChallengePayload=jsonObject1.getJSONObject("ChallengePayload");
