 ...
 */
public class PayTMPaymentProcess  extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(PayTMPaymentProcess.class.getName());
    ...
    HashMap<String,String> requestMap = (HashMap<String, String>) response3D.getRequestMap();
    String form = "";
        ...
        transactionlogger.error("PayTMPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.error("inside PayTMPaymentProcess Process --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside PayTMPaymentProcess getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        transactionlogger.debug("inside set3DResponseVO PayTMPaymentProcess---"+response3D.getUrlFor3DRedirect());
    ...
    public int actionEntryExtension(int newDetailId, String trackingId, String amount, String action, String status, CommResponseVO responseVO, CommRequestVO commRequestVO) throws PZDBViolationException
    {
        ...
        {
            PZExceptionHandler.raiseDBViolationException(PayTMPaymentProcess.class.getName(), "actionEntryExtension()", null, "common", "Technical exception", PZDBExceptionEnum.SQL_EXCEPTION, null, se.getMessage(), se.getCause());
        }
        catch (SystemError systemError)
        {
            PZExceptionHandler.raiseDBViolationException(PayTMPaymentProcess.class.getName(), "actionEntryExtension()", null, "common", "Technical exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        finally
        {
