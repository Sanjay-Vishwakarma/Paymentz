...
public class SecureUtil {
    ...
    private static UnionPayInternationalLogger transactionLogger= new UnionPayInternationalLogger(SecureUtil.class.getName());
    ...
    private static byte[] sha1(byte[] data) {
        ...
        try {
            ...
            transactionLogger.error("SHA1 calculation fails" + e);
            return null;
        }
    }
    ...
    private static byte[] sha256(byte[] data) {
        ...
        try {
            ...
            transactionLogger.error("SHA256 calculation fails" + e);
            return null;
        }
    }
    ...
    private static byte[] sm3(String datas, String encoding) {
        try {
            ...
            transactionLogger.error("SM3 calculation fails" + e);
            return null;
        }
    }
    ...
    public static String encryptData(String dataString, String encoding,PublicKey key) {
        ...
        transactionLogger.error("Inside SecureUtil.encryptData");
        byte[] data = null;
        try {
    ...
    private static byte[] decryptData(PrivateKey privateKey, byte[] data)
        ...
        try {
            ...
            transactionLogger.error("Decryption fails" + e);
        }
        return null;
    }
