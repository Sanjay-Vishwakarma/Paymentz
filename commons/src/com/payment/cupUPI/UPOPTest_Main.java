 ...
 */
public class UPOPTest_Main extends HttpServlet
{
    public static void sendSMS()
    {
        ...
        String merId = "389908262345678";//first 8 digits, IIN last 7 any
        String orderId = "988765687114";
        String txnTime = String.valueOf(dateFormat.format(date));
        System.out.println("Txn time---"+txnTime);
        String txnAmt = "100";
        String phoneNo = "852-11112222";
    ...
    public static void easyEnrollment()
    {
        DateFormat dateFormat = new SimpleDateFormat("YYYYMMddHHmmss");
        Date date = new Date();

        String merId = "389908262345678";//first 8 digits, IIN last 7 any
        //String orderId = "98876568657";
        String orderId = "988765687114";
        //String txnTime = String.valueOf(dateFormat.format(date));
        String txnTime = "20190701153140";
        String txnAmt = "100";
        String phoneNo = "852-11112222";
        String accNo = "6250947000000014";//Card Number
...
//					parseStr.append("Decrypted card number:"+accNo2);
    ...
    public static void purchase()
    {
        ...
        String merId = "389908262345678";//first 8 digits, IIN and last 7 any
        String orderId = "988765687017";
        String txnTime = String.valueOf(dateFormat.format(date));
        String txnAmt = "100";
        String phoneNo = "852-11112222";
        //String accNo = "6250947000000014";//Card Number
        String accNo = "6223164991230014";//Card Number
        //String accNo = "8171999927660000";//Card Number
        ...
        contentData.put("txnSubType", "05");                           //Transaction sub-type 01-purchase
        //000301: Merchant-hosted
        //000000: ExpressPay
        //000902: Token payment
        //001001: MOTO
...
//					parseStr.append("Decrypted card number:"+accNo2);
    ...
    {
        String merId = "389908262345678";//first 8 digits, IIN and last 7 any
        String origQryId = "281907031704214655028";
        String txnAmt = "100";
        String acqInsCode = "38990826";
    ...
    {
        String merId = "389908262345678";//first 8 digits, IIN and last 7 any
        String origQryId = "361907031457123835028";
        String txnAmt = "100";
        String acqInsCode = "38990826";
