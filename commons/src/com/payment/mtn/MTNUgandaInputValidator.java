 ...
 */
public class MTNUgandaInputValidator extends CommonInputValidator
{
    private static TransactionLogger transactionLogger  = new TransactionLogger(MTNUgandaInputValidator.class.getName());

    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        transactionLogger.error("inside MTNUgandaInputValidator -----> ");
        String error = "";
    ...
    private void InputValidation(CommonValidatorVO commonValidatorVO, List<InputFields> inputFields, ValidationErrorList validationErrorList, boolean isOptional)
    {
        ...
        for (InputFields inputFields1 : inputFields) {
            ...
            {
                case TELNO:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericAddressDetailsVO.getPhone(), "OnlyNumber", 10, isOptional))
                    {
