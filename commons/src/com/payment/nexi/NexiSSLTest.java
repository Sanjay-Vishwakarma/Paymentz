 ...
 */
public class NexiSSLTest
{
    public static void main(String[] args)
    {
        //System.out.println("Inside main");
        String recurringUrl = "https://ecommerce.nexi.it/ecomm/api/recurring/pagamentoRicorrente";
        ...
        String scadenza = "203010";
        String cvv = "123";
        String importo = "500";
        String divisa = "978";
        String codiceTransazione = "125432";
