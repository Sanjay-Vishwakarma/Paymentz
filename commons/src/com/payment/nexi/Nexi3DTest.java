...
public class Nexi3DTest
{
    public static void main(String[] args)
    {
        ...
        String testURL = "https://int-ecommerce.nexi.it/ecomm/api/paga/autenticazione3DS";
        ...
        String importo = "500";
        String divisa = "978";
        String codiceTransazione = "125427";
        ...
        String stringaMac="apiKey="+apikey+"codiceTransazione="+codiceTransazione+"divisa="+divisa+"importo="+importo+"timeStamp="+timeStamp+macKey;
        ...
        try
        {
            ...
            JSONObject informazioniSicurezza = new JSONObject();//for 3D 2.0
            ...
            json.put("informazioniSicurezza", informazioniSicurezza);
