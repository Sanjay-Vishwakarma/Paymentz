...
public class EnrollmentRequestVO
{
    ...
    public String setAcceptHeader(String acceptHeader)
    {
    ...
    public String setBrowserColorDepth(String browserColorDepth)
    {
    ...
    public String setBrowserJavaEnabled(String browserJavaEnabled)
    {
