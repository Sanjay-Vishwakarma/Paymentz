...
/**
 * Created by Admin on 2/6/2020.
 */
public class KCPInputValidator extends CommonInputValidator
{       TransactionLogger transactionLogger = new TransactionLogger(KCPInputValidator.class.getName());
