 ...
 */
public class EasyPayPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(EasyPayPaymentProcess.class.getName());

    @Override
    public String get3DConfirmationForm(String trackingId, String ctoken, Comm3DResponseVO response3D)
    {
        transactionlogger.error("inside  EasyPayPaymentProcess Form ---");
        ...
        transactionlogger.error("EasyPayPaymentProcess Form for >>>"+trackingId +" "+form.toString());
    ...
    {
        transactionlogger.debug("inside  EasyPayPaymentProcess---> "+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for EasyPayPaymentProcess");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery EasyPayment-----" + pstmt);
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        {
            transactionlogger.error("SystemError in EasyPayPaymentProcess---",systemError);
            PZExceptionHandler.raiseDBViolationException(EasyPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in EasyPayPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(EasyPayPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
