 ...
 */
public class CuroInputValidator extends CommonInputValidator
{
    private static Logger log = new Logger(CuroInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(CuroInputValidator.class.getName());
