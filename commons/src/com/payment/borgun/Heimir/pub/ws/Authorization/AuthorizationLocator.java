...
public class AuthorizationLocator extends org.apache.axis.client.Service implements com.payment.borgun.Heimir.pub.ws.Authorization.Authorization {
    ...
    //private java.lang.String Heimir_pub_ws_Authorization_Port_address = "http://WM8TEST02.europay.is:5555/ws/Heimir.pub.ws:Authorization/Heimir_pub_ws_Authorization_Port";

    final static ResourceBundle RB = LoadProperties.getProperty("com.directi.pg.Borgun");
    //private java.lang.String Heimir_pub_ws_Authorization_Port_address = "https://gatewaytest.borgun.is/ws/Heimir.pub.ws:Authorization";
    private java.lang.String Heimir_pub_ws_Authorization_Port_address = RB.getString("borgunurl");
    ...
    public com.payment.borgun.Heimir.pub.ws.Authorization.Authorization_PortType getHeimir_pub_ws_Authorization_Port() throws javax.xml.rpc.ServiceException {
    ...
    public com.payment.borgun.Heimir.pub.ws.Authorization.Authorization_PortType getHeimir_pub_ws_Authorization_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payment.borgun.Heimir.pub.ws.Authorization.Heimir_pub_ws_Authorization_BinderStub _stub = new com.payment.borgun.Heimir.pub.ws.Authorization.Heimir_pub_ws_Authorization_BinderStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payment.borgun.Heimir.pub.ws.Authorization.Authorization_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payment.borgun.Heimir.pub.ws.Authorization.Heimir_pub_ws_Authorization_BinderStub _stub = new com.payment.borgun.Heimir.pub.ws.Authorization.Heimir_pub_ws_Authorization_BinderStub(new java.net.URL(Heimir_pub_ws_Authorization_Port_address), this);
                _stub.setPortName(getHeimir_pub_ws_Authorization_PortWSDDServiceName());
                return _stub;
            }
        }
