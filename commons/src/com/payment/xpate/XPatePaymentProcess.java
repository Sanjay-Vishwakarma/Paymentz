 ...
 */
public class XPatePaymentProcess extends CommonPaymentProcess
{

    TransactionLogger transactionLogger= new TransactionLogger(XPatePaymentProcess.class.getName());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        transactionLogger.debug("inside xpate payment process---"+response3D.getUrlFor3DRedirect());
