 ...
 */
public class IMoneyPayPaymentProcess  extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(IMoneyPayPaymentProcess.class.getName());
    ...
    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        ...
        transactionlogger.error("IMoneyPayPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.error("inside IMoney Process --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside IMoney getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for IMoneyPayPaymentGateway");
