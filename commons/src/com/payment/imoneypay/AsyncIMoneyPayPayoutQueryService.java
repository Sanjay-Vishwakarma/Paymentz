 ...
 */
public class AsyncIMoneyPayPayoutQueryService
{

    private static TransactionLogger transactionLogger  = new TransactionLogger(AsyncIMoneyPayPayoutQueryService.class.getName());
    ...
    public static AsyncIMoneyPayPayoutQueryService asyncIMoneyPayPayoutQueryService = null;
    public AsyncIMoneyPayPayoutQueryService()
    {
    ...
    public AsyncIMoneyPayPayoutQueryService(String trackingid, String accountId, String paymentId, String afterExecuteTime, String delayTime, String maxExecutionTime)
    {
        //timer = new Timer();
        //timer.schedule(new RemindTask(), seconds*1000);
        transactionLogger.error("inside AsyncIMoneyPayPayoutQueryService -------");
    ...
    public static AsyncIMoneyPayPayoutQueryService getInstance()
    {
        if(asyncIMoneyPayPayoutQueryService !=null)
        {
            return asyncIMoneyPayPayoutQueryService;
        }
        else
        {
            return new AsyncIMoneyPayPayoutQueryService();
        }
    }
    ...
    {
        return executorService.submit(new IMoneyQueryCallable(trackingid,accountId,paymentId, afterExecuteTime, delayTime, maxExecutionTime));
    }
    public class IMoneyQueryCallable implements Callable<String>
    {
        ...
        private IMoneyQueryCallable(String trackingid,String accountId,String paymentId,String afterExecuteTime,String delayTime,String maxExecutionTime)
        {
            this.paymentId          = paymentId;
            this.trackingid         = trackingid;
            this.accountId          = accountId;
        ...
        public String call() throws Exception
        {
            try
            {
                ...
                exec.scheduleAtFixedRate(new Runnable()
                {
                    ...
                    {
                        // do stuff
                        transactionLogger.error("------Inside AsyncIMoneyPayPayoutQueryService run() method for trackingid--------" + trackingid);
    ...
    {
        transactionLogger.error("------Inside AsyncIMoneyPayPayoutQueryService callQuery method--------trackingid "+trackingid+" paymentId--->"+paymentId);
        Functions functions     = new Functions();
        IMoneyPayPaymentGateway iMoneyPayPaymentGateway   = new IMoneyPayPaymentGateway(accountId);
        ...
        try
        {
            ...
            if (transactionDetailsVO != null)
            {
                ...
                if (dbStatus.equalsIgnoreCase(PZTransactionStatus.PAYOUT_STARTED.toString()))
                {
                    ...
                    genericResponseVO = (CommResponseVO) iMoneyPayPaymentGateway.processPayoutInquiry(trackingid, commRequestVO);
