 ...
 */
public class PayGInputValidator extends CommonInputValidator
{
    //private static TransactionLogger transactionLogger  = new TransactionLogger(PayGInputValidator.class.getName());
    private static PayGTransactionLogger transactionLogger  = new PayGTransactionLogger(PayGInputValidator.class.getName());
    ...
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  PayGInputValidator------------>"+error+" "+addressValidation);
