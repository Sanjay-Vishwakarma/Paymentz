...
public class PayGUtils
{
    ...
    //private static TransactionLogger transactionlogger      = new TransactionLogger(PayGUtils.class.getName());
    private static PayGTransactionLogger transactionlogger      = new PayGTransactionLogger(PayGUtils.class.getName());
    ...
    public CommRequestVO getPayGRequestVO(CommonValidatorVO commonValidatorVO)
    {
...
//			IvParameterSpec iv = new IvParameterSpec(key.getBytes(ConfigurationConstants.DEFAULT_ENCODING_UTF_8.getValue()));
    ...
    public static void sendHTMLMail(Hashtable values,String isCredential,String action,String oldinvoiceno,String invoiceno ) throws SystemError
    {
        ...
        try
        {
            ...
            {
                com.lowagie.text.Image poweredByLogoValue = com.lowagie.text.Image.getInstance(PARTNER_LOGO_PATH + "poweredby_new_logo.png");
