...
/**
 * Created by Jitendra on 07-Sep-18.
 */
public class EPaySolnInputValidator extends CommonInputValidator
{
    TransactionLogger transactionLogger= new TransactionLogger(EPaySolnInputValidator.class.getName());

    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionname,String addressValidation)
    {
        transactionLogger.error(":::::inside EPaySolnInputValidator:::::");
        ...
        /*parameter.add(InputFields.REDIRECT_URL);*/
      ...
      //  inputValidator.InputValidations(commonValidatorVO,parameter,errorList,false);
       // error = error + inputValiDatorUtils.getError(errorList,parameter,actionname);
        transactionLogger.debug("line 54-----"+error);

        InputValidationsforEPaySoln(commonValidatorVO, parameter, errorList, false);
        String EOL = "<BR>";
        ...
        transactionLogger.debug("line 68-----" + error);
        return error;
    }

    private void InputValidationsforEPaySoln(CommonValidatorVO commonValidatorVO, List<InputFields> inputFields, ValidationErrorList validationErrorList, boolean isOptional)
    {
        ErrorCodeVO errorCodeVO = new ErrorCodeVO();
        ErrorCodeUtils errorCodeUtils = new ErrorCodeUtils();
        GenericAddressDetailsVO genericAddressDetailsVO = commonValidatorVO.getAddressDetailsVO();
        /*GenericTransDetailsVO genericTransDetailsVO = commonValidatorVO.getTransDetailsVO();*/
        /*transactionLogger.debug(genericTransDetailsVO.getRedirectUrl());*/
            ...
            switch (inputFields1)
            {
               ...
               /* case STATE:
                ...
                case LASTNAME:
                    ...
                    break;*/
                /*case REDIRECT_URL:
                    if (!ESAPI.validator().isValidInput(inputFields1.toString(), genericTransDetailsVO.getRedirectUrl(), "URL", 255, isOptional))
                    {
                        ...
                        validationErrorList.addError(inputFields1.toString(), new PZValidationException(ErrorMessages.INVALID_REDIRECT_URL, ErrorMessages.INVALID_REDIRECT_URL + ":::" + genericTransDetailsVO.getRedirectUrl(), errorCodeVO));
                        if (commonValidatorVO.getErrorCodeListVO() != null)
                            commonValidatorVO.getErrorCodeListVO().addListOfError(errorCodeVO);
                    }*/
            }
