...
public interface MerchantToolsSoap extends java.rmi.Remote {
     ...
     */
    public com.payment.apco.biz.apsp.www.GetTransactionStatusResponseGetTransactionStatusResult getTransactionStatus(String merchID, String merchPass, String ORef) throws java.rmi.RemoteException;
