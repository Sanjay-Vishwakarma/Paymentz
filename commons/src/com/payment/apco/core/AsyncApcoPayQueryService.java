...
/**
 * Created by Admin on 4/13/2020.
 */
public class AsyncApcoPayQueryService
{
    //private Session session;
    private static TransactionLogger transactionLogger = new TransactionLogger(AsyncApcoPayQueryService.class.getName());
    ...
    public static  AsyncApcoPayQueryService asyncApcoPayQueryService = null;
    public   AsyncApcoPayQueryService()
    {
    ...
    public AsyncApcoPayQueryService(String trackingid,String accountId,String paymentId,String isService,String afterExecuteTime,String delayTime,String maxExecutionTime)
    {
        //timer = new Timer();
        //timer.schedule(new RemindTask(), seconds*1000);

        callAsyncApcoQuery(trackingid, accountId, paymentId, isService, afterExecuteTime, delayTime, maxExecutionTime);
    ...
    public static AsyncApcoPayQueryService getInstance()
    {
        if(asyncApcoPayQueryService !=null)
        {
            return asyncApcoPayQueryService;
        }
        else
        {
            return new AsyncApcoPayQueryService();
        }
    }


    public Future<String> callAsyncApcoQuery(String trackingid,String accountId,String paymentId,String isService,String afterExecuteTime,String delayTime,String maxExecutionTime)
    {
        return executorService.submit(new ApcoPayQueryCallable(trackingid,accountId,paymentId,isService, afterExecuteTime, delayTime, maxExecutionTime));
    }
    public class ApcoPayQueryCallable implements Callable<String>
    {
        ...
        private ApcoPayQueryCallable(String trackingid,String accountId,String paymentId,String isService,String afterExecuteTime,String delayTime,String maxExecutionTime)
        {
            this.paymentId = paymentId;
            this.trackingid = trackingid;
            this.isService = isService;
    ...
    {
        transactionLogger.error("------Inside AsyncApcoPayQueryService callQuery method--------");
