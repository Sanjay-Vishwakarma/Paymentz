 ...
 */
public class RubixpayUtils
{
    private static TransactionLogger transactionlogger = new TransactionLogger(RubixpayUtils.class.getName());
    ...
    public CommRequestVO getRubixPayRequestVO(CommonValidatorVO commonValidatorVO)
    {
