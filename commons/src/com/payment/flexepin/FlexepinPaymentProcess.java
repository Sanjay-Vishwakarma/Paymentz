 ...
 */
public class FlexepinPaymentProcess extends CommonPaymentProcess
{
    private static TransactionLogger transactionlogger = new TransactionLogger(FlexepinPaymentProcess.class.getName());
    private static Functions function                  = new Functions();

    @Override
    public String get3DConfirmationForm(String trackingId, String ctoken, Comm3DResponseVO response3D)
    {
        transactionlogger.error("Flexepin 3d page displayed....." + response3D.getUrlFor3DRedirect());
        String form = "";
        String responseType = "";
    ...
    {
        transactionlogger.error("inside FlexepinPaymentProcess --->"+directKitResponseVO.getBankRedirectionUrl());
        directKitResponseVO.setBankRedirectionUrl(directKitResponseVO.getBankRedirectionUrl());
        transactionlogger.error("inside FlexepinPaymentProcess getBankRedirectionUrl Process -->"+directKitResponseVO.getBankRedirectionUrl());
    ...
    public void set3DResponseVO(DirectKitResponseVO directKitResponseVO, Comm3DResponseVO response3D)
    {
        ...
        transactionlogger.debug("inside  FlexepinPaymentProcess---"+response3D.getUrlFor3DRedirect());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for FlexepinPaymentProcess");
        ...
        try
        {
            ...
            transactionlogger.error("SqlQuery Flexepin :-----" + pstmt);
    ...
    private Hashtable getTransactionDetails(String trackingid, String status) throws PZDBViolationException
    {
        ...
        {
            transactionlogger.error("SystemError in FlexepinPaymentProcess---",systemError);
            PZExceptionHandler.raiseDBViolationException(FlexepinPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        catch (SQLException e)
        {
            transactionlogger.error("SQLException in FlexepinPaymentProcess---", e);
            PZExceptionHandler.raiseDBViolationException(FlexepinPaymentProcess.class.getName(), "getTransactionDetails()", null, "common", "DB Exception", PZDBExceptionEnum.SQL_EXCEPTION, null, e.getMessage(), e.getCause());
        }
        finally
        {
    ...
    public void setRefundVOParamsextension(CommRequestVO requestVO, PZRefundRequest refundRequest) throws PZDBViolationException
    {
        ...
        transactionlogger.error("trackingid in Flexepin----" + refundRequest.getTrackingId());
