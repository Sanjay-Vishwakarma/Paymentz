 ...
 */
public class AirPayInputValidator extends CommonInputValidator
{
    //private static TransactionLogger transactionLogger  = new TransactionLogger(AirPayInputValidator.class.getName());
    private static AirPayTransactionLogger transactionLogger  = new AirPayTransactionLogger(AirPayInputValidator.class.getName());
    ...
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  ApexPayInputValidator------------>"+error+" "+addressValidation);
