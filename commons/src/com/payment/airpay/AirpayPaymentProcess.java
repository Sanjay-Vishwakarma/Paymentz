 ...
 */
public class AirpayPaymentProcess extends CommonPaymentProcess
{
    //private static TransactionLogger transactionlogger = new TransactionLogger(AirpayPaymentProcess.class.getName());
    private static AirPayTransactionLogger transactionlogger = new AirPayTransactionLogger(AirpayPaymentProcess.class.getName());

    public String get3DConfirmationForm(CommonValidatorVO commonValidatorVO, Comm3DResponseVO response3D){
        transactionlogger.error("inside  AirpayPaymentProcess Form---");
        ...
        transactionlogger.error("AirpayPaymentProcess Form---"+form.toString());
    ...
    {
        transactionlogger.debug("Entering ActionEntry for AirpayPaymentProcess");
        ...
        {
            PZExceptionHandler.raiseDBViolationException(AirpayPaymentProcess.class.getName(), "actionEntryExtension()", null, "common", "Technical exception", PZDBExceptionEnum.SQL_EXCEPTION, null, se.getMessage(), se.getCause());
        }
        catch (SystemError systemError)
        {
            PZExceptionHandler.raiseDBViolationException(AirpayPaymentProcess.class.getName(), "actionEntryExtension()", null, "common", "Technical exception", PZDBExceptionEnum.DB_CONNECTION_ISSUE, null, systemError.getMessage(), systemError.getCause());
        }
        finally
        {
