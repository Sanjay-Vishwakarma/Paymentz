...
/**
 * Created by Admin on 05-Apr-22.
 */
public class EasebuzzInputValidator extends CommonInputValidator
{
    private static Logger log = new Logger(EasebuzzInputValidator.class.getName());
    private static TransactionLogger transactionLogger = new TransactionLogger(EasebuzzInputValidator.class.getName());
    public String validateIntegrationSpecificParameters(CommonValidatorVO commonValidatorVO, String actionName, String addressValidation)
    {
        ...
        transactionLogger.error("error  EasebuzzInputValidator------------>"+error);
