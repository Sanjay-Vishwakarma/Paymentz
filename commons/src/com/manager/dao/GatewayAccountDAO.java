...
public class GatewayAccountDAO
{
    ...
    public String createBankAccount(String merchantId, String pgtypeId, String isCVVrequired, String aliasname, String displayname, Integer isMastercardSupported, String shortName, String site, String path, String is3dSupportAccount, String username,
                                    ...
                                    String tableName, String columnName,String daily_card_limit_check,String weekly_card_limit_check,String monthly_card_limit_check,String Daily_Account_Amount_Limit,String Weekly_Account_Amount_Limit,String Monthly_Account_Amount_Limit,String daily_card_amount_limit_check,String weekly_card_amount_limit_check,String monthly_card_amount_limit_check ,HttpServletRequest req,String daily_amount_range,String daily_amount_range_check) throws PZDBViolationException
    {
        Connection con = null;
        PreparedStatement pstmt = null;
        int i = 0;
        ...
        try
        {
            ...
            pstmt.setString(53,daily_amount_range);
            pstmt.setString(54,daily_amount_range_check);
            logger.error("pstmt bankaccount is ::::::"+pstmt);
                                    ...
                                    String daily_amount_range, String daily_amount_range_check) throws SystemError, SQLException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                pstmt.setString(51,addressValidation);
                pstmt.setString(52,daily_amount_range);
                pstmt.setString(53,daily_amount_range_check);
                int inserted = pstmt.executeUpdate();
                //String accountId = "";
                logger.error("pstmt for gateway_account is ::::::"+pstmt);
