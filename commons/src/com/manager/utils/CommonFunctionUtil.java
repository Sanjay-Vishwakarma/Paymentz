...
import com.manager.enums.ConnectionType;
...
{   //common usage instance
    ...
    Logger logger = new Logger(CommonFunctionUtil.class.getName());
    ...
    public static StringBuffer getmerchant_category_code(String selectedItem)
    {
        Functions functions = new Functions();

        StringBuffer optionList = new StringBuffer(" <option value=\"\">Select MCC code</option>");
...
/* public static void main(String[] args)
    ...
    public String convertDatepickerFromTimestampWithSlash(String timestamp)
    {
    ...
    public String newValidateDate(String newStartD, String newEndD, String previousStartD, String previousEndD)
    {
        ...
        try
        {
            ...
            System.out.println("previousStartD---------->"+previousStartD);
            System.out.println("previousEndD---------->"+previousEndD);
            if (previousStartD != null && previousEndD != null)
            {
                ...
                System.out.println("dateBefore.after(previousStartDate)----------->"+dateBefore.after(previousStartDate));
    ...
    public StringBuffer getDefaultModeOptions(String selectedItem)
    {
        Functions functions = new Functions();

        StringBuffer optionList = new StringBuffer(" <option value=\"\">Select Default Mode</option>");

        for (ConnectionType connectionType : ConnectionType.values())
        {

            if (functions.isValueNull(selectedItem) && connectionType.toString().contains(selectedItem))
            {
                optionList.append("<option value=\"" + connectionType.toString() + "\" selected>" + connectionType.toString() + "</option>");
            }
            else
            {
                optionList.append("<option value=\"" + connectionType.toString() + "\" >" + connectionType.toString() + "</option>");
            }
        }
