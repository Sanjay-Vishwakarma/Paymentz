 ...
 */
public class TrillionPayAuthenticator extends AbstractAuthenticator
{
    private static volatile Authenticator singletonInstance;
           ...
           public static Authenticator getInstance()
           {
               if ( singletonInstance == null ) {
                   synchronized ( TrillionPayAuthenticator.class ) {
                       if ( singletonInstance == null ) {
                           singletonInstance = new TrillionPayAuthenticator();
                       }
                   }
               }
           ...
           public static void main(String[] args) throws Exception {
               ...
               TrillionPayAuthenticator auth = new TrillionPayAuthenticator();
            ...
            *
            */
           private TrillionPayAuthenticator() {
               super();
           }
