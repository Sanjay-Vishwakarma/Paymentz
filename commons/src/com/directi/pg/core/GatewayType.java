...
public class GatewayType
{
    ...
    public GatewayType(ResultSet rs) throws SQLException
    {
        ...
        limitresettime=rs.getString("limitresettime");
    }
    ...
    public String getLimitresettime()
    {
        return limitresettime;
    }

    public void setLimitresettime(String limitresettime)
    {
        this.limitresettime = limitresettime;
    }
}