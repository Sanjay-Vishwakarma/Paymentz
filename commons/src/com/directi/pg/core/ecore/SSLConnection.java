...
public class SSLConnection
{
    ...
    private static final String upopHost = "base2.credorax.com";

    private static final int HTTPS_PORT = 443;

    private static final String certFileAlias = "Credorax_base";
    ...
    public static void importCertificate(String jksPath, String jksPassword) {
        try {
            ...
            throw new RuntimeException("Exception while importing certificate to Java Key Store for credorax certificate.",
                    e);
        }
    }
    ...
    private static void setRemainCertificates(KeyStore ks, String jksPath, String jksPassword) {
        try {
            ...
            throw new RuntimeException(
                    "Exception while setting remain certificates to Java Key Store for credorax certificate.", e);
        }
    }
