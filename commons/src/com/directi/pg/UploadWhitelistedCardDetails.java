 ...
 */
public class UploadWhitelistedCardDetails
{
    private static Logger log = new Logger(UploadWhitelistedCardDetails.class.getName());
    public StringBuilder processSettlement(String memberId,String accountId,StringBuilder sSuccessMessage,StringBuilder sErrorMessage,List<String> queryBatch)
    {
        ...
        try
        {
            ...
            isRecordInserted=whiteListManager.uploadCards(queryBatch);
        }
        catch(Exception e){
