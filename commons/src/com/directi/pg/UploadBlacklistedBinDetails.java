 ...
 */
public class UploadBlacklistedBinDetails
{
    private static Logger log = new Logger(UploadBlacklistedBinDetails.class.getName());
    public StringBuilder processSettlement(String memberId,String accountId,StringBuilder sSuccessMessage,StringBuilder sErrorMessage,List<String> queryBatch)
    {
        ...
        try
        {
            ...
            isRecordInserted=blackListManager.uploadBins(queryBatch);
        }
        catch(Exception e){
