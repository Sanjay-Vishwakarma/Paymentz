package com.directi.pg.encryption.blowfish;
...
public class BlowfishCBC extends BlowfishECB
{
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(byte[], int, byte[], int, int)
     */
    public int encrypt(
            byte[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(byte[], byte[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(byte[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(int[], int, int[], int, int)
     */
    public void encrypt(
            int[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(int[], int[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(int[])
     * @deprecated use encrypt(int[], int, int[], int, int) instead
     */
    public void encrypt(
            int[] buf)
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(long[], int, long[], int, int)
     */
    public void encrypt(
            long[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(long[], long[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#encrypt(long[])
     * @deprecated use encrypt(long[], int, long[], int, int) instead
     */
    public void encrypt(
            long[] buf)
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(byte[], int, byte[], int, int)
     */
    public int decrypt(
            byte[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(byte[], byte[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(byte[])
     * @deprecated use encrypt(byte[], int, byte[], int, int) instead
     */
    public void decrypt(
            byte[] buf)
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(int[], int, int[], int, int)
     */
    public void decrypt(
            int[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(int[], int[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(int[])
     * @deprecated use decrypt(int[], int, int[], int, int) instead
     */
    public void decrypt(
            int[] buf)
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(long[], int, long[], int, int)
     */
    public void decrypt(
            long[] inBuf,
            int nInPos,
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(long[], long[])
    ...
    /**
     * @see com.logicboxes.encryption.blowfish.BlowfishECB#decrypt(long[])
     * @deprecated use decrypt(long[], int, long[], int, int) instead
     */
    public void decrypt(
            long[] buf)
