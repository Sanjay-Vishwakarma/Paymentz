...
/**
 * Created by Kanchan on 09-03-2021.
 */
public class UploadMerchantLogo extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        logger.debug("Enter in upload merchant logo ");
        ...
        RequestDispatcher rdsuccess= request.getRequestDispatcher("/merchantLogo.jsp?MES=SUCCESS&ctoken="+user.getCSRFToken());
        RequestDispatcher rderror= request.getRequestDispatcher("/merchantLogo.jsp?MES=ERR&ctoken="+user.getCSRFToken());
