...
public class RecurringModule extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        {
            req.setAttribute("errorMsg","Please provide PartnerId");
        ...
        try
        {
            ...
            {
                PZExceptionHandler.raiseConstraintViolationException("RecurringModule.java","doPost()",null,"icici",error, PZConstraintExceptionEnum.INVALID_PARAMETER_ENTERED,null,null,null);
            }
            ...
            paginationVO.setInputs("&pid="+pid+"&memberid="+toid+"&recurring_subscription_id="+rbid+"&trackingid="+trackingid+"&name="+name+"&firstsix="+firstSix+"&lastfour="+lastFour+"&terminalid="+terminalid+"&terminalbuffer="+sb);
        ...
        {
            log.error("Catch PZConstraintViolationException...",dbe);
    ...
    private String validateOptionalParameters(HttpServletRequest req)
    {
        ...
        inputFieldsListOptional.add(InputFields.TRACKINGS);
        inputFieldsListOptional.add(InputFields.RBIDS);
        inputFieldsListOptional.add(InputFields.CARDNAME_SMALL);
        inputFieldsListOptional.add(InputFields.FIRST_SIXS);
        inputFieldsListOptional.add(InputFields.LAST_FOURS);
