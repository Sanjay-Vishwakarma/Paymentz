 ...
 */
public class CreateBankApplication extends HttpServlet
{
    private static Logger logger= new Logger(CreateBankApplication.class.getName());
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException,ServletException
    {
        ...
        RequestDispatcher rdError = request.getRequestDispatcher("/servlet/BankDetailsList?MES=ERR&ctoken="+user.getCSRFToken());
        RequestDispatcher rdSuccess = request.getRequestDispatcher("/servlet/BankDetailsList?MES=Success&ctoken="+user.getCSRFToken());
        ...
        try
        {
            ...
            {
                if ("Verified PDF".equals(request.getParameter("action")))
                {
                    if (pgtypeids == null)
                    {
