 ...
 */
public class UploadBinFile extends HttpServlet
{
    private static Logger log = new Logger(UploadBinFile.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("/uploadBin.jsp?ctoken="+user.getCSRFToken());
        ...
        UploadWhitelistedBinDetails uploadWhitelistedBinDetails = new UploadWhitelistedBinDetails();
        ...
        try
        {
            List<String> queryBatch =fileHandlingUtil.readBinDetails(filePath, fub.getFieldValue("accountid"), fub.getFieldValue("toid"));
            fileHandlingUtil.deleteFile(filePath);
            ...
            try
            {
                ...
                {
                    sSuccessMessage=  uploadWhitelistedBinDetails.processSettlement(fub.getFieldValue("toid"),fub.getFieldValue("accountid"), sSuccessMessage, sErrorMessage,queryBatch);
