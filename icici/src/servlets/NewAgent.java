...
public class NewAgent extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (((String) request.getParameter("step")).equals("1"))
        {
            ...
            try
            {
                ...
                detailhash.put("emailTemplateLang", (String) request.getParameter("emailTemplateLang"));
    ...
    public AgentAuthenticate addAgent_new(long accid,Hashtable details) throws SystemError
    {
        ...
        StringBuffer sb = new StringBuffer("insert into agents " +
                ...
                "telno,contact_persons,logoName,siteurl,supporturl,notifyemail,maincontact_ccmailid,maincontact_phone,cbcontact_name,cbcontact_mailid,cbcontact_ccmailid,cbcontact_phone,refundcontact_name,refundcontact_mailid,refundcontact_ccmailid,refundcontact_phone,salescontact_name,salesemail,salescontact_ccmailid,salescontact_phone,fraudcontact_name,fraudcontact_mailid,fraudcontact_ccmailid,fraudcontact_phone,technicalcontact_name,technicalcontact_mailid,technicalcontact_ccmailid,technicalcontact_phone,billingcontact_ccmailid,billingcontact_phone,billingcontact_name,billingemail,superadminid,isIpWhitelisted,dtstamp,partnerId,actionExecutorId,actionExecutorName,emailTemplateLang) values (");
