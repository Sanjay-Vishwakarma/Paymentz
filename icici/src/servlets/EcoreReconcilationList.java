 ...
 */
public class EcoreReconcilationList extends HttpServlet
{
    static Logger log = new Logger(EcoreReconcilationList.class.getName());
    ...
    {
        log.debug("Entering in EcoreReconcilationList");
        ...
        catch (ValidationException e)
        {
            ...
            RequestDispatcher rd = req.getRequestDispatcher("/ecorereconcilationlist.jsp?ctoken="+user.getCSRFToken());
            rd.forward(req, res);
        }
        ...
        try
        {
            ...
            StringBuffer query = new StringBuffer("SELECT trackingid,toid,description,fromid,amount,status,timestamp,accountid,ecorePaymentOrderNumber FROM transaction_ecore WHERE STATUS IN('authstarted','markedforreversal')");
            StringBuffer countquery = new StringBuffer("select count(*) from transaction_ecore where status IN('authstarted','markedforreversal')");
            ...
            {
                query.append(" and ecorePaymentOrderNumber='" + ESAPI.encoder().encodeForSQL(me,paymentordernumber) + "'");
                countquery.append(" and ecorePaymentOrderNumber='" + ESAPI.encoder().encodeForSQL(me,paymentordernumber) + "'");
            }
