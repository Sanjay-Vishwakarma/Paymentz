...
public class ListPartnerCommission extends HttpServlet
{
    ...
    public void doProcess(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
    {
        ...
        try
        {
            ...
            StringBuffer query = new StringBuffer("select pc.id,pc.partnerid,pc.memberid,pc.terminalid,pc.chargeid,pc.commission_value,pc.startdate,pc.enddate,pc.sequence_no,pc.actionExecutorId,pc.actionExecutorName,cm.chargename from partner_commission as pc JOIN charge_master cm on pc.chargeid=cm.chargeid ");
            ...
            {
                query.append(" and pc.partnerid='"+partnerId+"'");
                countquery.append(" and pc.partnerid='"+partnerId+"'");
            }
