...
<%
  session.setAttribute("submit","Block Countries");
            ...
            <td>
              <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                ...
                <tr>
                  ...
                  <td class="textb">:</td>
                  <td>
                    <input name="accountid" id="accountid" value="" class="txtbox" autocomplete="on">
                  </td>
                </tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
                <tr>
                  ...
                  <td>
                    <input name="toid" id="memid" value="" class="txtbox" autocomplete="on">
                  </td>
                </tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
                <tr>
...
<div class="reporttable">
  <%
    if(request.getAttribute("listofcountrys")!=null)
    {
      List<BlacklistVO> iList = (List<BlacklistVO>)request.getAttribute("listofcountrys");
