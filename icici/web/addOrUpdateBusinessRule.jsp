    ...
    function confirmsubmitreg()
    {
     ...
     trigger = document.getElementById("processtrigger").value;
      if(trigger =="Y"){
        ...
        window.alert("Please click on PROCESS button to continue.");
  ...
  <div class="col-lg-12">
    <div class="panel panel-heading">
      ...
      <%
        ...
        List<String> multipleSelectedOutputItem=new ArrayList<String>();
        //List<String> multipleSelectedInputOutputItem=new ArrayList<String>();
              ...
              <table border="0" cellpadding="5" cellspacing="0" width="100%"  align="center">
                ...
                <tr>
                  ...
                  <td width="12%" class="textb">
                    <select name="businessRuleId" class="txtbox">
...
<div class="reporttable">
  <%
    ...
    Map<String,Integer> numberOfInputName=new HashMap<String, Integer>();
    ...
    {
      int i=1;
      StringBuffer optionTagWhole=new StringBuffer();
      for(RuleOperation ruleOperation:ruleVO.getRuleOperation())
      {
         optionTagWhole.append("<option value='"+ruleOperation.getInputName()+"'>"+ruleOperation.getInputName()+"</option>");
      }

      for(RuleOperation ruleOperation:ruleVO.getRuleOperation())
      {
        if(InputNameEnum.getEnum(ruleOperation.getInputName())!=null && !numberOfInputName.containsKey(ruleOperation.getInputName()))
        {
          Integer numberOfTime=1;
          multipleSelectedItem.add(ruleOperation.getInputName());
          numberOfInputName.put(ruleOperation.getInputName(),numberOfTime);
        }
        else
        {
          multipleSelectedOutputItem.add(ruleOperation.getInputName());
        }
        comparatorComparator.append("<tr>");
        comparatorComparator.append("<td class=\"textb\" valign=\"middle\" >");
        comparatorComparator.append("<select name='comparatorOperationType_"+i+"' class='txtbox'  style='background-color: #EBEBE4' "+((actionVO.isView())? "disabled style='background-color: #EBEBE4'":"")+">"+profileManagementManager.getOptionTagForOperationType(functions.isValueNull(ruleOperation.getOperationType())?ruleOperation.getOperationType():"")+"</select>");
        comparatorComparator.append("</td>");
        comparatorComparator.append("<td class=\"textb\" valign=\"middle\" >");
        comparatorComparator.append("<select name='comparatorInputName_"+i+"' class='txtbox'  style='background-color: #EBEBE4' "+((actionVO.isView())? "disabled ":"")+">"+optionTagWhole.toString().replaceFirst("value='"+ruleOperation.getInputName()+"'","value='"+ruleOperation.getInputName()+"' selected")+"</select>");
        comparatorComparator.append("</td>");
        comparatorComparator.append("<td class='textb' valign='middle'>");
        comparatorComparator.append("<select name='comparatorOperator_"+i+"' class='txtbox' style='background-color:#EBEBE4;width:100px' "+((actionVO.isView()) ?"disabled style='background-color: #EBEBE4'":"")+">"+(profileManagementManager.getOptionTagforOperators(ruleOperation.getOperator()))+"</select>");
        comparatorComparator.append("</td>");
        comparatorComparator.append("<td class='textb' valign='middle'>");
        comparatorComparator.append("<select name='comparatorDataType_"+i+"' class='txtbox' style='background-color:#EBEBE4;width:100px' onchange=\"selectedDataType('"+i+"')\" "+((actionVO.isView()) ?"disabled style='background-color: #EBEBE4'":"")+">"+(profileManagementManager.getOptionTagForDataType(ruleOperation.getDataType()))+"</select>");
        comparatorComparator.append("</td>");
        comparatorComparator.append("<td class=\"textb\" valign=\"middle\" >");
        comparatorComparator.append("<input name='comparatorEnumValue_"+i+"' class='txtbox' value='"+(functions.isValueNull(ruleOperation.getEnumValue())?ruleOperation.getEnumValue():"")+"'  "+(((actionVO.isView()) || !DataType.ENUM.name().equals(ruleOperation.getDataType()))? "readonly style='background-color: #EBEBE4'":"")+">");
        comparatorComparator.append("</td>");
    ...
    else if(functions.isValueNull(ruleVO.getRuleType()) && (RuleTypeEnum.FLAT_FILE.name()).equals(ruleVO.getRuleType()) && ruleVO.getRuleOperation()!=null)
    {
      ...
      for(RuleOperation ruleOperation:ruleVO.getRuleOperation())
      {
        ...
        flat_FileComparator.append("<td class=\"textb\" valign=\"middle\" >");
        flat_FileComparator.append("<select name='flatFileOperationType_"+i+"' class='txtbox' style='background-color: #EBEBE4'  "+((actionVO.isView())? "disabled ":"")+">"+profileManagementManager.getOptionTagForOperationType(functions.isValueNull(ruleOperation.getOperationType())?ruleOperation.getOperationType():"")+"</select>");
        flat_FileComparator.append("</td>");
        flat_FileComparator.append("<td class=\"textb\" valign=\"middle\" >");
        flat_FileComparator.append("<select name='flatFileInputName_"+i+"' class='txtbox' style='background-color: #EBEBE4'   "+((actionVO.isView())? "disabled ":"")+">"+optionTagWhole.toString().replaceFirst("value='"+ruleOperation.getInputName()+"'","value='"+ruleOperation.getInputName()+"' selected")+"</select>");
        flat_FileComparator.append("</td>");
        flat_FileComparator.append("<td class='textb' align='center' valign='middle' colspan='"+(i < ruleVO.getRuleOperation().size() ?"2":"2")+"'>");
        ...
        if(i<ruleVO.getRuleOperation().size())
        {
          ...
          flat_FileComparator.append("<select name='flatFileComparator_"+i+"' class=\"txtbox\" style='background-color:#EBEBE4;width:100px' "+((actionVO.isView()) ?"disabled style='background-color: #EBEBE4'":"")+">"+(profileManagementManager.getOptionTagForComparator(functions.isValueNull(ruleOperation.getComparator())?ruleOperation.getComparator():"",null))+"</select>");
          flat_FileComparator.append("</td>");
        }
        else
        {
    ...
    else if(functions.isValueNull(ruleVO.getRuleType()) && (RuleTypeEnum.REGULAR_EXPRESSION.name()).equals(ruleVO.getRuleType()) && ruleVO.getRuleOperation()!=null)
    {
      ...
      for(RuleOperation ruleOperation:ruleVO.getRuleOperation())
      {
        ...
        regexComparator.append("<select name='regexOperationType_"+i+"' class=\"txtbox\" style='background-color: #EBEBE4' "+((actionVO.isView())?"disabled  ":"")+">"+profileManagementManager.getOptionTagForOperationType(functions.isValueNull(ruleOperation.getInputName())?ruleOperation.getOperationType():"")+"</select>");
        regexComparator.append("</td>");

        regexComparator.append("<td class='textb' valign='middle' colspan='"+(i < ruleVO.getRuleOperation().size() ?"1":"1")+"'>");
        regexComparator.append("<select name='regexInputName_"+i+"' class=\"txtbox\" style='background-color: #EBEBE4' "+((actionVO.isView())?"disabled  ":"")+">"+optionTagWhole.toString().replaceFirst("value='"+ruleOperation.getInputName()+"'","value='"+ruleOperation.getInputName()+"' selected")+"</select>");
        regexComparator.append("</td>");
        ...
        regexComparator.append("<td class=\"textb\" valign=\"middle\">");
        regexComparator.append("<input name='regex_"+i+"' class=\"txtbox\" placeholder=\"REGEX\" value='"+(functions.isValueNull(ruleOperation.getRegex())?ruleOperation.getRegex():"")+"'  "+((actionVO.isView())? "readonly style='background-color: #EBEBE4'":"")+">");
        regexComparator.append("</td>");
    ...
    else if(functions.isValueNull(ruleVO.getRuleType()) && (RuleTypeEnum.DATABASE.name()).equals(ruleVO.getRuleType()) && ruleVO.getRuleOperation()!=null)
    {
      int i=1;
      int s=1;
      int f=1;
      ...
      for(RuleOperation ruleOperation:ruleVO.getRuleOperation())
      {
        if(InputNameEnum.getEnum(ruleOperation.getInputName())!=null || OutputNameEnum.getEnum(ruleOperation.getInputName())!=null)
          multipleSelectedOutputItem.add(ruleOperation.getInputName());
        databaseComparator.append("<tr>");
        databaseComparator.append("<td class=\"textb\" valign=\"middle\" >");
        databaseComparator.append("<select name='databaseOperationType_"+i+"' class='txtbox'  style='background-color: #EBEBE4'  "+((actionVO.isView())? "disabled ":"")+">"+profileManagementManager.getOptionTagForOperationType(functions.isValueNull(ruleOperation.getOperationType())?ruleOperation.getOperationType():"")+"</select>");
        databaseComparator.append("</td>");
        databaseComparator.append("<td class=\"textb\" valign=\"middle\" >");
        databaseComparator.append("<select name='select_"+i+"' class='txtbox' style='background-color: #EBEBE4'  "+((actionVO.isView())? "disabled ":"")+">"+optionTagWhole.toString().replaceFirst("value='"+ruleOperation.getInputName()+"'","value='"+ruleOperation.getInputName()+"' selected")+"</select>");
        databaseComparator.append("</td>");
        databaseComparator.append("<td class='textb' valign='middle' colspan='"+(i < ruleVO.getRuleOperation().size() ?"1":"1")+"'>");
        databaseComparator.append("<select name='selectOperator_"+i+"' class='txtbox' style='background-color:#EBEBE4;width:100px' "+((actionVO.isView()) ?"disabled style='background-color: #EBEBE4'":"")+">"+(profileManagementManager.getOptionTagforOperators(ruleOperation.getOperator()))+"</select>");
        databaseComparator.append("</td>");
        databaseComparator.append("<td class='textb' valign='middle' colspan='"+(i < ruleVO.getRuleOperation().size() ?"1":"1")+"'>");
        ...
        if(i<ruleVO.getRuleOperation().size())
        {
          ...
          databaseComparator.append("<select name='selectComparator_"+i+"' class=\"txtbox\" style='background-color:#EBEBE4;width:100px' "+((actionVO.isView()) ?"disabled style='background-color: #EBEBE4'":"")+">"+(profileManagementManager.getOptionTagForComparator(functions.isValueNull(ruleOperation.getComparator())?ruleOperation.getComparator():"",null))+"</select>");
          databaseComparator.append("</td>");
  ...
  %>
  <form action="/icici/servlet/AddBusinessRuleDetails?ctoken=<%=ctoken%>" method="post" name="myForm" id="myForm">
    ...
    <table align=center width="80%">
      <tr>
        <td colspan="2"><center><B>
          <%if (actionVO.isView())
          {%>
          View Business Rule Details
          <%
          }
          else if (actionVO.isEdit())
          {
          %>
          Edit Business Rule Details
          <%
          }
          else if(actionVO.isAdd())
          {
          %>
          Add New Business Rule Details
          <%
            }
          %>
        </B></center> </td>
      ...
      <tr class="tr0">
        <td valign="middle" align="center" class="textb">Business&nbsp;Rule&nbsp;Name *</td>
        <td>
          <input name="businessRuleName" class="txtbox" <%if(actionVO.isView()){%>readonly style="background-color: #EBEBE4" <%}%> value="<%=functions.isValueNull(ruleVO.getName())?ruleVO.getName():(functions.isValueNull(request.getParameter("businessRuleName"))?request.getParameter("businessRuleName"):"")%>">
        </td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr>
        <td valign="middle" align="center" class="textb">Business&nbsp;Rule&nbsp;Label *</td>
        <td class="textb">
          <input type="text" class="txtbox" name="businessRuleLabel" <%if(actionVO.isView()){%>readonly style="background-color: #EBEBE4" <%}%> value="<%=functions.isValueNull(ruleVO.getLabel())?ruleVO.getLabel():(functions.isValueNull(request.getParameter("businessRuleLabel"))?request.getParameter("businessRuleLabel"):"")%>">
        </td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr class="tr0">
        <td valign="middle" align="center" class="textb">Business&nbsp;Rule&nbsp;Description *</td>
        <td>
          <input type="text" class="txtbox" name="businessRuleDescription" <%if(actionVO.isView()){%>readonly style="background-color: #EBEBE4" <%}%> value="<%=functions.isValueNull(ruleVO.getDescription())?ruleVO.getDescription():(functions.isValueNull(request.getParameter("businessRuleDescription"))?request.getParameter("businessRuleDescription"):"")%>" >
        </td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr>
        <td valign="middle" align="center" class="textb">Business&nbsp;Rule&nbsp;Type *</td>
        <td class="textb">
          <select  class="txtbox" name="ruleType" <%if(actionVO.isView()){%>disabled <%}%> onchange="selectedDropdown('ruleType')" > <%=profileManagementManager.getOptionTagForRuleType(functions.isValueNull(ruleVO.getRuleType()) ? ruleVO.getRuleType() : (functions.isValueNull(request.getParameter("ruleType")) ? request.getParameter("ruleType") : ""))%></select>
        </td>
      </tr>
      <tr><td>&nbsp;</td></tr>
        ...
        <td valign="middle" align="center" colspan="2">
          <div id="comparator" align="center" style="<%=((functions.isValueNull(ruleVO.getRuleType()) && "COMPARATOR".equals(ruleVO.getRuleType())) || (functions.isValueNull(request.getParameter("ruleType"))  && "COMPARATOR".equals(request.getParameter("ruleType"))))?"":"display:none;"%>">
            <table width="100%"  align="center">
              ...
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" width="45%" >Output&nbsp;Name</td>
                <td valign="middle" width="50%">
                  <select name="comparatorOutputName" class="textb" multiple id="comparatorOutputName" <%=(actionVO.isView())? "disabled style=\"background-color: #EBEBE4\"":"" %>>
                    <%=profileManagementManager.getOptionTagForOutputName(multipleSelectedOutputItem, null, null).toString().replaceAll("<option value=''>Select Input Name</option>", "")%>
                  </select>
                </td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" colspan="2" ><button type="button" name="Process" <%=!actionVO.isView()?"id=\"processComparator\"":""%> class="buttonform">Process</button></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
          ...
          <div id="flatfile" align="center" style="<%=((functions.isValueNull(ruleVO.getRuleType()) || functions.isValueNull(request.getParameter("ruleType"))) && ( "FLAT_FILE".equals(ruleVO.getRuleType())  || "FLAT_FILE".equals(request.getParameter("ruleType"))) )?"":"display:none;"%>">
            <table width="100%"  align="center">
              ...
              <tr>
                <td valign="middle" align="center" class="textb" width="45%" >Output&nbsp;Name</td>
                <td valign="middle" width="50%">
                  <select name="flatFileOutputName" class="textb" multiple id="flatFileOutputName" <%=(actionVO.isView())? "disabled style=\"background-color: #EBEBE4\"":"" %>>
                    <%=profileManagementManager.getOptionTagForOutputName(multipleSelectedOutputItem, null, null).toString().replaceAll("<option value=''>Select Input Name</option>", "")%>
                  </select>
                </td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" colspan="2" ><button type="button" name="Process" <%=!actionVO.isView()?"id=\"processFlatFile\"":""%> class="buttonform">Process</button></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" colspan="2" >
                  <div id="processFlatFileDIV" align="center" style="<%=(actionVO!=null&&(!actionVO.isAdd() || ((request.getAttribute("error")!=null || request.getAttribute("catchError")!=null) && RuleTypeEnum.FLAT_FILE.name().equals(request.getParameter("ruleType")))))?"":"display:none;"%>">
                    <table width="100%" id="processFlatFileTable" align="center"  class="table table-striped table-bordered table-green dataTable">
                      <tr>
                        <td valign="middle" align="center" class="th0" width="25%" colspan="5" >Flat&nbsp;File</td>
                      </tr>
                      <%=flat_FileComparator%>
                    </table>
          ...
          <div id="regex" align="center" style="<%=((functions.isValueNull(ruleVO.getRuleType()) || functions.isValueNull(request.getParameter("ruleType"))) && ("REGULAR_EXPRESSION".equals(ruleVO.getRuleType()) || "REGULAR_EXPRESSION".equals(request.getParameter("ruleType"))))?"":"display:none;"%>">
            <table width="100%"  align="center">
              ...
              <tr>
                <td valign="middle" align="center" class="textb" width="45%" >Output&nbsp;Name</td>
                <td valign="middle" width="50%">
                  <select name="regexOutputName" class="textb" multiple id="regexOutputName" <%=(actionVO.isView())? "disabled style=\"background-color: #EBEBE4\"":"" %>>
                    <%=profileManagementManager.getOptionTagForOutputName(multipleSelectedOutputItem, null, null).toString().replaceAll("<option value=''>Select Input Name</option>", "")%>
                  </select>
                </td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" colspan="2" ><button type="button" name="ProcessRegex" <%=!actionVO.isView()?"id=\"processRegex\"":""%> class="buttonform">Process</button></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" colspan="2" >
          ...
          <div id="query" align="center" style="<%=((functions.isValueNull(ruleVO.getRuleType()) || functions.isValueNull(request.getParameter("ruleType")))&& ("DATABASE".equals(ruleVO.getRuleType()) || "DATABASE".equals(request.getParameter("ruleType"))))?"":"display:none;"%>">
            <table width="100%"  align="center">
              ...
              <tr><td>&nbsp;</td></tr>
              <tr>
                <td valign="middle" align="center" class="textb" width="25%" >Output&nbsp;Name</td>
                <td valign="middle" width="25%" >
                  <select name="databaseOutputName" class="textb" multiple id="databaseOutputName" <%=(actionVO.isView())? "disabled style=\"background-color: #EBEBE4\"":"" %>>
                    <%=profileManagementManager.getOptionTagForOutputName(multipleSelectedOutputItem, null, null).toString().replaceAll("<option value=''>Select Input Name</option>", "")%>
                  </select>
                </td>
                <td valign="middle" align="center" class="textb" width="25%">&nbsp;</td>
                <td valign="middle" width="25%">&nbsp;</td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr><td valign="middle" align="center" class="textb" colspan="4"><button type="button" <%=!actionVO.isView()?"id=\"process\"":""%> class="buttonform">Process</button></td></tr>
              <tr><td>&nbsp;</td></tr>
              <tr><td colspan="4">
      ...
      %>
      <tr class="tr0">
        <td valign="middle" align="center"  ><button type="submit" class="buttonform" style="float:right" name="action" id="update" value="<%=functions.isValueNull(ruleVO.getId())?ruleVO.getId():(functions.isValueNull(request.getParameter("action"))?request.getParameter("action").split("_")[0]:"")%>_Edit" onclick="confirmsubmitreg()">Update</button></td>
        <td class="textb" valign="middle" align="center" style="padding-left: 10px;">
          <button type="submit" class="buttonform" style="float:left"  name="businessRuleId"  VALUE="<%=functions.isValueNull(request.getParameter("businessRuleId"))?request.getParameter("businessRuleId"):""%>" onclick="cancel('<%=ctoken%>')">
            <i class="fa fa-clock-o"></i>
            &nbsp;&nbsp;Cancel
          </button>
        </td>
      ...
      %>
      <tr class="tr0">
        <td valign="middle" align="center"  ><button type="submit" class="buttonform" style="float:right" name="action" value="1_Add" onclick="confirmsubmitreg()">Add</button></td>
        <td class="textb" valign="middle" align="center" style="padding-left: 10px;">
          <button type="submit" class="buttonform" name="businessRuleId" style="float:left" VALUE="<%=functions.isValueNull(request.getParameter("businessRuleId"))?request.getParameter("businessRuleId"):""%>" onclick="cancel('<%=ctoken%>')">
            <i class="fa fa-clock-o"></i>
            &nbsp;&nbsp;Cancel
          </button>
        </td>
      ...
      %>
      <tr class="tr0">
        <td class="textb" valign="middle" align="center" colspan="2" >
          <button type="submit" class="buttonform" name="businessRuleId" VALUE="<%=functions.isValueNull(request.getParameter("businessRuleId"))?request.getParameter("businessRuleId"):""%>" onclick="cancel('<%=ctoken%>')">
            <i class="fa fa-clock-o"></i>
            &nbsp;&nbsp;Cancel
          </button>
        </td>
    ...
    <input type="hidden" name="processtrigger" id="processtrigger" value="Y"/>
  </form>
</div>
<script>
  ...
  {
    document.getElementById("processtrigger").value="Y";
    ...
    $('#flatFileInputName option:selected').each(function(){
      selectedInput+="<option value='"+($(this).val())+"'>"+($(this).val())+"</option>";
    });
    $('#flatFileOutputName option:selected').each(function(){
      selectedInput+="<option value='"+($(this).val())+"'>"+($(this).val())+"</option>";
    });
    ...
    $('#flatFileInputName option:selected').each(function(){
      ...
      var textNode0 = "<select name=\"flatFileOperationType_!count!\" class=\"txtbox\" style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForOperationType(null)%></select>";
      cellLeft0.innerHTML=textNode0.replace(/!count!/g, iteration);
      cellLeft0.setAttribute("class","textb");
      cellLeft0.setAttribute("valign","middle");

      var cellLeft = row.insertCell(1);
      var textNode = "<select name=\"flatFileInputName_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\">"+selectedInput+"</select>";
      ...
      // right cell
      if($('#flatFileInputName option:selected').length>iteration || $('#flatFileOutputName option:selected').length>0)
      {
    ...
    $('#flatFileOutputName option:selected').each(function(){
      ...
      cellRightSel.setAttribute("colspan","2");
      // right cell
      if($('#flatFileOutputName option:selected').length>initialFlatIteration)
      {
  ...
  $('#processRegex').click(function()
  {
    ...
    $('#regexOutputName option:selected').each(function(){
      selectedInput+="<option value='"+($(this).val())+"'>"+($(this).val())+"</option>";
    });
    ...
    $('#regexInputName option:selected').each(function(){
      ...
      var cellLeft0 = row.insertCell(0);
      var textNode0 = "<select name=\"regexOperationType_!count!\" class=\"txtbox\" style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForOperationType(null)%></select>";
      cellLeft0.innerHTML=textNode0.replace(/!count!/g, iteration);
      cellLeft0.setAttribute("class","textb");
      cellLeft0.setAttribute("valign","middle");

      var cellLeft = row.insertCell(1);
      var textNode = "<select name=\"regexInputName_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\">"+selectedInput+"</select>";
      cellLeft.innerHTML=textNode.replace(/!count!/g, iteration);
      cellLeft.setAttribute("class","textb");
      cellLeft.setAttribute("valign","middle");
      ...
      // right cell
      if($('#regexInputName option:selected').length>iteration ||  $('#regexOutputName option:selected').length>0)
      {
      ...
      lastRow++;
      iteration++;
      initialRegexIteration++;
    });

    var initialRegexIteration=1;
    $('#regexOutputName option:selected').each(function(){
      ...
      // right cell
      if($('#regexOutputName option:selected').length>initialRegexIteration)
      {
        var cellRight = row.insertCell(5);
        var strHtml2 = "<select name=\"regexComparator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForComparator(null,null)%></select>";
        cellRight.innerHTML = strHtml2.replace(/!count!/g, iteration);
  ...
  $('#processComparator').click(function()
  {
    ...
    $('#comparatorOutputName option:selected').each(function(){
      selectedInput+="<option value='"+($(this).val())+"'>"+($(this).val())+"</option>";
    });
    ...
    $('#comparatorInputName option:selected').each(function(){
      ...
      var textNode = "<select name=\"comparatorOperationType_!count!\" class=\"txtbox\" style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForOperationType(null)%></select>";
      cellLeft.innerHTML=textNode.replace(/!count!/g, iteration);
      cellLeft.setAttribute("class","textb");
      cellLeft.setAttribute("valign","middle");

      var cellLeft = row.insertCell(1);
      var textNode = "<select name=\"comparatorInputName_!count!\" class=\"txtbox\" style=\"background-color:#EBEBE4;width:100px\">"+selectedInput+"</option>";
      cellLeft.innerHTML=textNode.replace(/!count!/g, iteration);
      cellLeft.setAttribute("class","textb");
      cellLeft.setAttribute("valign","middle");
      ...
      var cellRightSel = row.insertCell(2);
      var strHtml1 = "<select name=\"comparatorOperator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagforOperators(null)%></select>";
      cellRightSel.innerHTML = strHtml1.replace(/!count!/g, iteration);
      cellRightSel.setAttribute("class","textb");
      cellRightSel.setAttribute("valign","middle");

      var cellRightSel = row.insertCell(3);
      var strHtml1 = "<select name=\"comparatorDataType_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\" onchange=\"selectedDataType('!count!')\"><%=profileManagementManager.getOptionTagForDataType(null)%></select>";
      cellRightSel.innerHTML = strHtml1.replace(/!count!/g, iteration);
      cellRightSel.setAttribute("class","textb");
      cellRightSel.setAttribute("valign","middle");

      var cellRightSel = row.insertCell(4);
      var strHtml1 = "<input type=\"text\" name=\"comparatorEnumValue_!count!\" class=\"txtbox\" readonly style=\"background-color:#EBEBE4;width:100px\" placeholder=\"Enum Value(Seperated by comma)\"\>";
      cellRightSel.innerHTML = strHtml1.replace(/!count!/g, iteration);
      cellRightSel.setAttribute("class","textb");
      cellRightSel.setAttribute("valign","middle");
      ...
      // right cell
      if($('#comparatorInputName option:selected').length>iteration || $('#comparatorOutputName option:selected').length>0)
      {
    ...
    $('#comparatorOutputName option:selected').each(function(){
      ...
      var cellLeft = row.insertCell(0);
      var textNode = "<select name=\"comparatorOperationType_!count!\" class=\"txtbox\" style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForOperationType(null)%></select>";
      cellLeft.innerHTML=textNode.replace(/!count!/g, outputIteration);
      cellLeft.setAttribute("class","textb");
      cellLeft.setAttribute("valign","middle");
      ...
      var cellRightSel = row.insertCell(2);
      var strHtml1 = "<select name=\"comparatorOperator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagforOperators(null)%></select>";
      cellRightSel.innerHTML = strHtml1.replace(/!count!/g, outputIteration);
      cellRightSel.setAttribute("class","textb");
      cellRightSel.setAttribute("valign","middle");
      ...
      // right cell
      if($('#comparatorOutputName option:selected').length>initialIteration)
      {
        cellRightSel.setAttribute("colspan","1");
        var cellRight = row.insertCell(5);
        var strHtml2 = "<select name=\"comparatorComparator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForComparator(null,null)%></select>";
        cellRight.innerHTML = strHtml2.replace(/!count!/g, outputIteration);
        cellRight.setAttribute("class", "textb");
        cellRight.setAttribute("valign", "middle");
        cellRight.setAttribute("colspan", "1");
      }
  ...
  function processQuery()
  {
    ...
    $('#databaseOutputName option:selected').each(function(){
      currentSelectStatement+="<option value='"+($(this).val())+"'>"+($(this).val())+"</option>"
    });
    for(var k = 0; k < inputs.length; k++) {
      if(inputs[k].name.indexOf('selectField_') == 0) {
        currentSelectStatement+="<option>";
        if($('select[name=selectAggregate_'+inputs[k].name.split("_")[1]+']').val()!="")
        {
          currentSelectStatement+=($('select[name=selectAggregate_'+inputs[k].name.split("_")[1]+']').val());
          currentSelectStatement+="(";
          currentSelectStatement+=(inputs[k].value);
          currentSelectStatement+=")";
    ...
    for(var i = 0; i < inputs.length; i++) {
      ...
      if(inputs[i].name.indexOf('selectField_') == 0) {
        ...
        // left cell
        var cellLeftOn0 = select.insertCell(0);
        var textNodeOn0 = "<select type=\"text\" class=\"txtbox\" name=\"databaseOperationType_!count!\" style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForOperationType(null)%></option>";
        cellLeftOn0.innerHTML = textNodeOn0.replace(/!count!/g,selectIteration);
        cellLeftOn0.setAttribute("class","textb");
        cellLeftOn0.setAttribute("valign","middle");

        var cellLeftOn = select.insertCell(1);
        var textNodeOn = "<select type=\"text\" class=\"txtbox\" name=\"select_!count!\" style=\"background-color:#EBEBE4;width:100px\">"+currentSelectStatement+"</option>";
        cellLeftOn.innerHTML = textNodeOn.replace(/!count!/g,selectIteration);
        cellLeftOn.setAttribute("class","textb");
        cellLeftOn.setAttribute("valign","middle");

        var cellRightSelOn = select.insertCell(2);
        var strHtml1On = "<select name=\"selectOperator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagforOperators(null)%></select>";
        cellRightSelOn.innerHTML = strHtml1On.replace(/!count!/g, selectIteration);
        cellRightSelOn.setAttribute("class","textb");
        cellRightSelOn.setAttribute("valign","middle");

        var cellRightSelMan = select.insertCell(3);
        ...
        if($('input[name=selectField_'+(Number(inputs[i].name.split("_")[1])+1)+']').val()!=null || $('#databaseOutputName option:selected').length>0)
        {
          var cellRightSelOn = select.insertCell(4);
    ...
    else
    {
      ...
      $('#databaseOutputName option:selected').each(function(){
        ...
        if( $('#databaseOutputName option:selected').length>initialOutputDatabase)
        {
          var cellRightSelOn = select.insertCell(4);
          var strHtml2On = "<select name=\"selectComparator_!count!\" class=\"txtbox\"  style=\"background-color:#EBEBE4;width:100px\"><%=profileManagementManager.getOptionTagForComparator(null,null)%></select>";
          cellRightSelOn.innerHTML = strHtml2On.replace(/!count!/g, selectIteration);
  ...
  function selectedDropdown(name)
  {
    ...
    document.getElementById("processtrigger").value="N";
    if(hatto1=="DATABASE")
    {
  ...
  function cancel(ctoken) {
    document.myForm.action="/icici/servlet/BusinessRuleDetails?ctoken="+ctoken;
  }
