...
%>
<form action="/icici/servlet/QwipiChargebackList?ctoken=<%=ctoken%>" method="post" name="forms" >
...
<div class="reporttable">
    <%
        ...
        String errormsg1 = (String)request.getAttribute("sErrorMessage");
        if (errormsg1 == null)
        {
            errormsg1 = "";
        }
...
<form name="chargebackform" action="/icici/servlet/QwipiChargebackTransaction?ctoken=<%=ctoken%>" method="post">
<table align=center width="45%" class="table table-striped table-bordered table-hover table-green dataTable">
    <thead>
        <tr>
            ...
            <td valign="middle" align="center" class="th0">IsRetrivalRequest</td>
    ...
    <%
        ...
        for(TransactionVO transactionVO : cbVOList)
        {
            ...
            out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getOrderDesc())+"</td>");
            out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getStatus())+"</td>");
            out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getQwipiPaymentOrderNumber())+"</td>");
            out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getAmount())+"</td>");
            out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getRetrivalRequest())+"</td>");
            out.println("<td align=center "+style+">&nbsp; <input class=\"txtboxtabel\" type=\"Text\" value=\""+ESAPI.encoder().encodeForHTMLAttribute(transactionVO.getAmount())+"\" name=\"chargebackamount_"+ESAPI.encoder().encodeForHTML(transactionVO.getTrackingId())+"\" size=\"10\"> </td>");
            ...
            out.println("<td align=center "+style+">&nbsp; <input class=\"txtboxtabel\" type=\"Text\" name=\"chargebackremark_"+ESAPI.encoder().encodeForHTML(transactionVO.getTrackingId())+"\" value=\"\" > </td>");
            ...
            out.println("<input  type=\"hidden\" name=\"accountid_"+ESAPI.encoder().encodeForHTML(transactionVO.getTrackingId())+"\" value=\""+transactionVO.getAccountId() +"\">");
            out.println("</tr>");
        }
    %>
    <thead>
        <tr>
            <td valign="middle" align="center"  class="th0" colspan="12">
                <input  type="button"  name="submitbutton" value="Chargeback Selected"  class="addnewmember" onClick="return DoChargeback();" >
                &nbsp;&nbsp;
                <input  type="submit" name="submitbutton" value="RetrivalRequest Selected"  class="addnewmember">
            </td>
        </tr>
        </thead>
</table>
    ...
    <%
        ...
        {
            out.println(Functions.NewShowConfirmation("Filter","Please provide the data to get Qwipi Chargeback List"));
        }
