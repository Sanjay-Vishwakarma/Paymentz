...
<html>
<head>
  <title>Upload Refund Chargeback</title>
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <form name = "FIRCForm" action="/icici/servlet/UploadRefundFile?ctoken=<%=ctoken%>" method="post" ENCTYPE="multipart/form-data" >
        <br>
        <%
          ...
          <tr>
            <td>
              <table  border="0" cellpadding="5" cellspacing="0" align="center">
                ...
                <tr>
                  <td class="textb" colspan="2" align="left"><b>Refund File:&nbsp;</b></td>
