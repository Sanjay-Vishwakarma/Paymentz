...
<head>
  ...
  <script type="text/javascript">
    ...
    {
      document.f1.action="/icici/riskRuleBarChart.jsp?ctoken=<%=ctoken%>";
      document.f1.submit();
    }
  </script>
  ...
  <div style="width:100%;" >
    ...
    <table border="1" style="width:100%; height:70px;" >
      <tr>
        ...
        <td width="50%">
          <canvas id="canvas-hoursly"></canvas>
        </td>
      </tr>
    </table>
    <%
    ...
    <script>
      window.onload = function()
      {
        <%
         ...
         {
         %>
        var dailyctx = document.getElementById("canvas-hoursly").getContext("2d");
                  ...
                  options:
                  {
                    ...
                    scales:
                    {
                      ...
                      yAxes: [{
                        ...
                        scaleLabel: {
                          display: true,
                          labelString: 'Values (<%=monitoringUnit%>)'
                        }
                      }]
                    }
                  }
        ...
        <%
         ...
         {
        %>
        var weeklytx = document.getElementById("canvas-daily").getContext("2d");
        window.myBar = new Chart(weeklytx,
                {
                  type: 'bar',
                  data: <%=weeklyJsonStr%>,
                  options:
        ...
        <%
         ...
         {
        %>
        var weeklyNewCtx = document.getElementById("canvas-weekly").getContext("2d");
        window.myBar = new Chart(weeklyNewCtx,
                {
                  type: 'bar',
