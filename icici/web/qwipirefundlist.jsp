...
%>
<form action="/icici/servlet/QwipiRefundList?ctoken=<%=ctoken%>" method="post" name="forms" >
        ...
        <div class="col-lg-12">
            <div class="panel panel-default"style="margin-top: 0px">
                ...
                <%
                    ...
                    {
                        ValidationErrorList validationErrorList= (ValidationErrorList) request.getAttribute("error");
                        for(ValidationException validationException : validationErrorList.errors())
                        {
                            out.println("<center><font class=\"textb\">" + validationException.getMessage() + "</font></center>");
                        }
                    }
                %>
...
<div class="reporttable">
    ...
    <%
        if(request.getAttribute("refundVOList")!=null)
        {
            ...
            {
    %>
    <form name="reversalform" action="QwipiRefundTransaction?ctoken=<%=ctoken%>" method="post">
        <table align="center" width="50%" class="table table-striped table-bordered table-hover table-green dataTable">
            ...
            <%
                ...
                for(TransactionVO transactionVO : refundVOList)
                {
                    ...
                    out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getFromid())+"</td>");
                    ...
                    out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML(transactionVO.getDtStamp())+"</td>");
                    ...
                    out.println("<td align=center "+style+">&nbsp;<input  type=\"Text\" class=\"txtboxtabel\" value=\"\" name=\"refundamount_"+ESAPI.encoder().encodeForHTML(transactionVO.getTrackingId())+"\" size=\"10\"> </td>");
            ...
            <tr>
                <td valign="middle" align="center"  class="th0" colspan="11">
                    <button type="submit" value="Reverse Selected" class="addnewmember" onClick="return DoReverse();" >
                        Reverse Selected
                    </button>
                </td>
            </tr>
    ...
    <%
        ...
        {
            out.println(Functions.NewShowConfirmation("Filter","Please provide the data to get Qwipi refund List"));
        }
