...
<%!
    Logger logger=new Logger("agentConsolidatePayoutSummary.jsp");
%>
            ...
            <td>
                <table border="0" cellpadding="5" cellspacing="0" width="97%"  align="center">
                    ...
                    <tr>
                        ...
                        <td width="3%" class="textb"></td>
                        <td width="12%" class="textb">
                            <input name="memberid" id="memberid" value="<%=memberid%>" class="txtbox" autocomplete="on">
...
<div class="reporttable">
    <%
        ...
        if(agentPayoutReportVO!=null)
        {
            ...
            HashMap<String,HashMap<String,List<ChargeDetailsVO>>> stringHashMapHashMap=agentPayoutReportVO.getStringHashMapHashMap();
    ...
    <table align=center width="80%" border="2px" style="border-color:#ffffff ">
        ...
        <tr>
            ...
            <td class="textb" colspan="2" valign="middle" align="left" bgcolor="#f5f5f5"> <%=agentPayoutReportVO.getReportingDate()%></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <%--
                        <td  colspan="4" valign="middle" align="center" class="texthead" bgcolor="#008BBA">Charges Details</td>
            --%>
        </tr>
        <tr>
    ...
    <%
            ...
            {
                logger.error("Sql Exception in agentConsolidatePayoutSummary.jsp:",e);
            }
            finally
            {
