...
<%@ page import="com.directi.pg.CommonFraudulent" %>
...
<div class="qwipitab" style="margin-top: 0px">
  <% ctoken = ((User)session.getAttribute("ESAPIUserSessionKey")).getCSRFToken();
    if (com.directi.pg.Admin.isLoggedIn(session))
    {
      ...
      String val="";
      String isRefund = fub.getFieldValue("isRefundAll");
      ...
      if(fub.getFieldValue("accountid")!=null && !fub.getFieldValue("accountid").equals(""))
      {
        ...
        if(ApplicationProperties.getProperty("MPR_FILE_STORE")+name!=null)
        {
          try
          {
            ...
            CommonFraudulent commonFraudulent = new CommonFraudulent();
            val= commonFraudulent.processFraudUpload(name, filepath, accountid,isRefund);
            if(val!=null)
            {
