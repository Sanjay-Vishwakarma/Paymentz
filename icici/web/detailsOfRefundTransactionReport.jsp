...
<% ctoken = ((User)session.getAttribute("ESAPIUserSessionKey")).getCSRFToken();
  if (com.directi.pg.Admin.isLoggedIn(session))
  {
    ...
    String RefundBankTransactionInquiry=request.getAttribute("RefundBankTransactionInquiry")==null ? "" : (String) request.getAttribute("RefundBankTransactionInquiry");
    ...
    String markedforreversal=request.getAttribute("markedforreversal")==null ? "" : (String) request.getAttribute("markedforreversal");
...
<div class="reporttable">
  <%
    ...
    if(RefundBankTransactionInquiry.equals("RefundBankTransactionInquiry")){
  ...
  <table border="0" cellpadding="3" cellspacing="3" bordercolor="#2379A5" width="50%"  align="center" class="table table-striped table-bordered table-hover table-green dataTable"  >
    <tr>
      <td  width="50%" class=" th0" colspan="6"><b>Refunded Transaction Count</b></td>
    ...
    <tr>
      <td  width="50%" class="th0" colspan="6"><b>Markedforreversal Transaction Count</b></td>
      <td style="text-align: center"><b><%= markedforreversal%></b></td>
    </tr>
  </table>
  <%
    }
