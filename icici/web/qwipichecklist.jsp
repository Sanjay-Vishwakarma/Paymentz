...
<form action="/icici/servlet/QwipiCheckList?ctoken=<%=ctoken%>" method="post" name="forms" >
...
<%
    ...
    try
    {
        ...
        fromid = ESAPI.validator().getValidInput("fromid",request.getParameter("fromid"),"Numbers",15,true);
    ...
    if (fromid != null) str = str + "&fromid=" + fromid;
            ...
            <table border="0" cellpadding="5" cellspacing="0" width="100%"  align="center">
                ...
                <tr>
                    ...
                    <td width="10%" class="textb">
                        <input type=text name="trackingid" class="txtbox">
                ...
                <tr>
                    ...
                    <td width="4%" class="textb">&nbsp;</td>
                    <td width="8%" class="textb">FromID(MID)</td>
                    <td width="3%" class="textb">&nbsp;</td>
                    <td width="12%" class="textb">
                        <input type=text maxlength="15" name="fromid"  class="txtbox" value="<%=request.getParameter("fromid")==null?"":request.getParameter("fromid")%>">
                    </td>
                ...
                <tr>
                    ...
                    <td width="8%" class="textb" >&nbsp;</td>
                    <td width="3%" class="textb">&nbsp;</td>
                    <td style="padding:5px " width="12%" class="textb">
    ...
    <table align=center width="50%" class="table table-striped table-bordered table-hover table-green dataTable">
       <thead>
            <tr>
                ...
                <td valign="middle" align="center" class="th0">ENQUIRY</td>
        ...
        <%
            ...
            for(int pos=1;pos<=records;pos++)
            {
                ...
                out.println("<tr>");
                out.println("<form action=\"/icici/servlet/QwipiInquiry\" method=\"POST\">");
                ...
                out.println("<td align=\"center\" "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String)temphash.get("toid"))+"<input type=\"hidden\" name=\"accountid\" value=\""+temphash.get("accountid")+"\"></td>");
                ...
                if (functions.isValueNull((String) temphash.get("qwipiPaymentOrderNumber")))
                {
                out.println("<td align=\"center\" "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String)temphash.get("qwipiPaymentOrderNumber"))+"</td>");
                }
                else
                {
                ...
                if (functions.isValueNull((String) temphash.get("qwipiPaymentOrderNumber")))
                {
                out.println("<td align=\"center\" "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String)temphash.get("refundamount"))+"</td>");
                }
                else
                {
                    out.println("<td align=center " + style + ">&nbsp;" + "-" + "</td>");
    ...
    <table align=center valign=top><tr>
        <td align=center>
            <jsp:include page="page.jsp" flush="true">
                ...
                <jsp:param name="page" value="QwipiCheckList"/>
