...
<%!
    Logger logger=new Logger("partnerPerAccountPayoutSummary.jsp");
%>
...
<div class="reporttable">
    <%
        ...
        {
            HashMap<String, List<ChargeDetailsVO>> stringListHashMap=partnerPayoutReportVO.getStringListHashMap();
            PartnerDetailsVO partnerDetailsVO=partnerPayoutReportVO.getPartnerDetailsVO();
            MerchantDetailsVO merchantDetailsVO=partnerPayoutReportVO.getMerchantDetailsVO();
    ...
    <%
            ...
            {
                logger.error("Sql Exception in partnerPerAccountPayoutSummary.jsp:",e);
            }
                    finally
                {
                    Database.closeConnection(conn);
