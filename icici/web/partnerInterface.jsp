...
<head>
    ...
    <title>Partners Management> Partner Master</title>
        ...
        <div class="panel panel-default" >
            <div class="panel-heading" >
                <div style="float: right;">
                    <form action="/icici/resetpasswordpartner.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" class="addnewmember" value="Add Template Colors" name="submit" style="width: 162px; font-size: 11px;">
                ...
                <div style="float: right;">
                    <form action="/icici/partnerLogo.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" class="addnewmember" value="Add New Partner Logo" name="submit" style="width: 162px; font-size: 11px;">
                            <i class="fa fa-sign-in"></i>
                            &nbsp;&nbsp;Upload Partner Logo
                        </button>
                    </form>
                ...
                <div style="float: right;">
                    <form action="/icici/partnerIcon.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" class="addnewmember" value="Add New Partner Icon" name="submit" style="width: 162px; font-size: 11px;">
                            <i class="fa fa-sign-in"></i>
                            &nbsp;&nbsp;Upload Partner Icon
                        </button>
                    </form>
                ...
                <div style="float: right;">
                    <form action="/icici/partnersignup.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" class="addnewmember" value="Add New Partner" name="submit" style="width: 162px; font-size: 11px;">
                            <i class="fa fa-sign-in"></i>
                            &nbsp;&nbsp;Add New Partner
                        </button>
                    </form>
                ...
                <div style="float: right;">
                    <form action="/icici/addTemplateColors.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" class="addnewmember" value="Add Template Colors" name="submit" style="width: 151px; font-size: 11px;">
                            <i class="fa fa-sign-in"></i>
                            &nbsp;&nbsp;Add Template Colors
                        </button>
                    </form>
                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="5" cellspacing="0" width="100%"  align="center">
                                ...
                                <tr>
                                    ...
                                    <td width="4%" class="textb">&nbsp;</td>
                                    <td width="13%" class="textb" > Super Partner Id</td>
                                    <td width="3%" class="textb"></td>
                                    <td width="12%" class="textb">
