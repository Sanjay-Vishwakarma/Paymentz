...
<link href="/merchant/NewCss/am_multipleselection/bootstrap-multiselect.css" rel="stylesheet" /><script>
    $(function () {
        ...
        <div class="page-heading">
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Bank Profile</h2>
                            ...
                            <div id="horizontal-form">
                                ...
                                <div class="form foreground bodypanelfont_color panelbody_color">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label style="font-family:Open Sans;font-size: 13px;font-weight: 600;">In which currency would you like payment to be transferred to your bank account?</label>
                                    </div>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Bank Information</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                                ...
                                <div id="horizontal-form">
                                    <div class="form-group col-md-12 has-feedback">
                                        <div class="col-md-4" style="padding-left:0;">
                                            <label style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Select Currency</label>
                            ...
                            <div class="widget-content padding">
                                <div id="horizontal-form">
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_bic" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">SWIFT/BIC (Bank Identifier Code)</label>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_bankaddress" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Bank Address</label>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_bankphonenumber" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Bank Phone Number</label>
                                    ...
                                    %>
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_aba_routingcode" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">ABA routing code (US)</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label style="font-family:Open Sans;font-size: 15px;font-weight: 600;"><u>Payment Acceptor Details:</u></label>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 has-feedback">
                                        <label for="aquirer" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Previous or current payment acceptor?</label>
                                    ...
                                    %>
                                    <div class="form-group col-md-6 has-feedback">
                                        <label for="reason_aquirer" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Reason for leaving the Previous/Current payment acceptor?</label>
            ...
            <div class="row"  style="background-color: #ffffff; margin-top: 15px;">
                <div class="col-md-12">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <%--<h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Processing History</strong></h2>--%>
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Processing History</h2>
                        ...
                        <div class="widget-content padding">
                            <div id="horizontal-form" style="overflow-y: auto; width: 100%;">
                                ...
                                <table id="myTable" class="display table table-striped table-bordered" width="100%" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                    <thead>
                                    <tr>
                                        <td align="center" class="texthead" data-label="PROCESSING HISTORY" id="processingheader" style="background-color: #7eccad !important;">PROCESSING HISTORY</td>
                                        <td align="center" class="texthead" data-label="LAST MONTH" width="" style="background-color: #7eccad !important;">LAST MONTH</td>
                                        <td align="center" class="texthead" data-label="2 MONTHS" width="" style="background-color: #7eccad !important;">2 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">3 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">4 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">5 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">6 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">12 MONTHS AGO</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">2 YEARS</td>
                                        <td align="center" class="texthead" width="" style="background-color: #7eccad !important;">3 YEARS</td>
                                    </tr>
                                    </thead>

                                    <%--<thead>
                                    <tr>
                                        <th valign="middle" align="center" style="text-align: center">PROCESSING HISTORY</th>
                                        <th valign="middle" align="center" style="text-align: center">LAST MONTH</th>
                                        <th valign="middle" align="center" style="text-align: center">2 MONTHS AGO</th>
                                        <th valign="middle" align="center" style="text-align: center">3 MONTHS AGO</th>
                                        <th valign="middle" align="center" style="text-align: center">4 MONTHS AGO</th>
                                        <th valign="middle" align="center" style="text-align: center">5 MONTHS AGO</th>
                                        <th valign="middle" align="center" style="text-align: center">6 MONTHS AGO</th>
                                    </tr>
                                    </thead>--%>


                                    <tr>
                                        <td align="center" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;"> Sales volume</td>
                                        <td align="center" data-label="LAST MONTH"><input type="tel" class="form-control" name="salesvolume_lastmonth"  maxlength="10" onkeypress="return isNumberKey(event)" onchange="calculateLastMonth()" onblur="calculateLastMonth()" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_lastmonth())==true?bankProfileVO.getSalesvolume_lastmonth():""%>"/><%if(validationErrorList.getError("salesvolume_lastmonth")!=null){%><span class="apperrormsg">Invalid salesvolume  </span><%}%></td>
                                    ...
                                    <tr>
                                        <td align="center" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Chargeback volume</td>
                                    ...
                                    <tr>
                                        <td align="center" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Number of chargebacks</td>
                                    ...
                                    <tr>
                                        <td align="center" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Refunds volume</td>
                                    ...
                                    <tr>
                                        <td align="center" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Number of refunds</td>
                                    ...
                                    <tr>
                                        <td align="center" id="chargebackratioid" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Chargeback Ratio</td>

                                        <td align="center" data-label="LAST MONTH">
                                        ...
                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="12 MONTHS AGO">
                                            <div class="input-group">
                                        ...
                                        <td align="center" data-label="2 YEARS">
                                            <div class="input-group">
                                        ...
                                        <td align="center" data-label="3 YEARS">
                                            <div class="input-group">
                                    ...
                                    <tr>
                                        <td align="center" id="refundratioid" class="texthead" style="background-color: #7eccad !important;color: white;vertical-align: middle;text-align: center;">Refund ratio</td>
                                        <td align="center" data-label="LAST MONTH">
                                            <div class="input-group">
