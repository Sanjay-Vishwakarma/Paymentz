...
<html>
<head>
  <title>Blacklist VPAAddress</title>
  <script>
    ...
    function Unblock()
    {
      ...
      {
        document.BlacklistVpaAddress.submit();
      }
    }
  </script>
</head>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default"style="margin-top: 0px">
      <div class="panel-heading" >
        Blocked VPA Address List
        <div style="float: right;">
          <form action="/icici/uploadVpaAddressDetails.jsp?ctoken=<%=ctoken%>" method="POST">
            <button type="submit" value="Upload VPA Address Details" name="submit" class="addnewmember">
      ...
      %>
      <form action="/icici/servlet/BlacklistVpaAddress?ctoken=<%=ctoken%>" name="frm1" method="post">
        <input type="hidden" value="<%=ctoken%>" name="ctoken" id="ctoken">
        <table align="center" width="35%" cellpadding="2" cellspacing="2">
          <tbody>
          <tr>
            <td>
              <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                ...
                <tr>
                  <td class="textb">&nbsp;</td>
                  <td class="textb">VPA Address</td>
                  <td class="textb">:</td>
                  <td>
                    <input name="vpaAddress" id="vpaAddress" class="txtbox" value="">
                  </td>
                </tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
                <tr>
...
<div class="reporttable">
  <%
    if(request.getAttribute("listofVpaAddres")!=null)
    {
      List<BlacklistVO> vpaAddresList = (List<BlacklistVO>)request.getAttribute("listofVpaAddres");
      PaginationVO paginationVO=(PaginationVO) request.getAttribute("paginationVO");
      paginationVO.setInputs("ctoken=" + ctoken+paginationVO.getInputs());
      if(vpaAddresList.size()>0)
      {
  %>
  <form name="BlacklistVpaAddress" action="/icici/servlet/BlacklistVpaAddress?ctoken=<%=ctoken%>" method="post">
    <table align=center width="100%" class="table table-striped table-bordered table-hover table-green dataTable">
      ...
      <tr>
        ...
        <td  align="center" class="th0">VPA Address</td>
      ...
      <%
        ...
        for(BlacklistVO blacklistVO : vpaAddresList)
        {
          ...
          out.println("<td align=center "+style+">&nbsp;" + ESAPI.encoder().encodeForHTML(blacklistVO.getVpaAddress())+"</td>");
  ...
  <table align=center valign=top><tr>
    <td align=center>
      <jsp:include page="page.jsp" flush="true">
        ...
        <jsp:param name="page" value="BlacklistVpaAddress"/>
...
<%
  ...
  {
    out.println(Functions.NewShowConfirmation("Filter", "Please provide the data to get Blocked VPA Address List"));
  }
