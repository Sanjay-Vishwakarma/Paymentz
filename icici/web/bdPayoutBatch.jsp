...
%>
<%
    ResourceBundle RB              = LoadProperties.getProperty("com.directi.pg.payoutBatch");
    String bankList  = RB.getString("BANK_LIST");
    List<String> list = Arrays.asList(bankList.split(","));
                                ...
                                <td>
                                    <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td width="4%" class="textb">&nbsp;</td>
                                            <td width="8%" class="textb">Bank Name *</td>
                                            <td width="3%" class="textb">&nbsp;</td>
                                            <td width="7%" class="textb">
                                                <select size="1" name="walletname" id="walletname" class="txtbox">
                                                    <option value="0">Select</option>
                                                    <%
                                                        String selected = "";
                                                        String walletName1 = request.getParameter("walletname") == null ? "" : request.getParameter("walletname");
                                                        for(String bankName:list)
                                                        {
                                                            if (bankName.equals(walletName1))
                                                                selected = "selected";
                                                            else
                                                                selected = "";
                                                    %>
                                                    <option value="<%=bankName%> <%=selected%>"> <%=bankName.toUpperCase()%>

                                                    <%--<option value="<%=selected%>"><%=selected.toUpperCase()%>--%>
                                                    </option>
                                                    <%
                                                        }
                                                    %>
...
//        System.out.println("bdPAyoutBatch hash--"+hash);
    ...
    <table align=center width="90%" border="1" class="table table-striped table-bordered table-hover table-green dataTable">
        <thead>
        <tr>
            <td valign="middle" align="center" class="th0">BatchID</td>
            <td valign="middle" align="center" class="th0">Bank BatchID </td>
            <td valign="middle" align="center" class="th0">Batch Date</td>
            <td valign="middle" align="center" class="th0">Bank Batch Date</td>
            <td valign="middle" align="center" class="th0">Batch Count</td>
            <td valign="middle" align="center" class="th0">Bank Batch Count</td>
            <td valign="middle" align="center" class="th0">Batch Amount</td>
