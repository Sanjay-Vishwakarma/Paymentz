...
<%!
   ...
   private Logger logger=new Logger("riskRuleManagement.jsp");
%>
...
<head>
  ...
  <title>IFE Rule Management> Risk Rule</title>
</head>
    ...
    <div class="panel panel-default">
      <div class="panel-heading" >
        ...
        <div style="float: right;">
          <form action="/icici/servlet/SingleRiskRuleDetails?ctoken=<%=ctoken%>" method="POST">
      ...
      <%
        ...
        {
          out.println("<center><font class=\"textb\">Updated Successfully</font></center>");
        }
      %>
              ...
              <table border="0" cellpadding="5" cellspacing="0" width="100%"  align="center">
                ...
                <tr>
                  ...
                  <td width="12%" class="textb">
                    <%--<select name="riskRuleName">
                      <%=riskRuleManager.getOptionTagForRiskRule(request.getParameter("riskRuleName")).toString()%>
                    </select>--%>
                      <select name="ruleid">
                        <%=profileManagementManager.getOptionTagForRiskRuleWithoutId(riskRule, request.getParameter("ruleid"))%>
                      </select>
...
<div class="reporttable">
  <%
    if(request.getAttribute("riskRuleVOList")!=null)
    {
      List<RuleVO> riskRuleVOList= (List<RuleVO>) request.getAttribute("riskRuleVOList");
      PaginationVO paginationVO = (PaginationVO) request.getAttribute("paginationVO");
      paginationVO.setInputs(paginationVO.getInputs()+"&ctoken="+ctoken);
      if(!riskRuleVOList.isEmpty())
      {
  ...
  <%
      ...
      {
        out.println(Functions.NewShowConfirmation("Filter", "Please Provide search criteria for Risk Rule Details"));
      }
...
<%
  ...
  {
    logger.error("Exception for riskRuleManagement ",e);
  }
%>