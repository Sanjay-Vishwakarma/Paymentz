...
<head>
  ...
  <title> Partner Fraud Accounts Details</title>
</head>
<body>
...
<div class="reporttable">
  ...
  <table align=center width="50%" class="table table-striped table-bordered table-hover table-green dataTable">
    ...
    <tr>
      ...
      <td valign="middle" align="center"class="th0">Fraud System</td>
      <td valign="middle" align="center"class="th0">Account Name</td>
    ...
    <%
      ...
      for(int pos=1;pos<=records;pos++)
      {
        ...
        out.println("<td align=center "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String)temphash.get("fsname"))+"<input type=\"hidden\" name=\"login\" fsname=\""+temphash.get("fsname")+"\"></td>");
  ...
  <table align=center valign=top><tr>
    <td align=center>
      <jsp:include page="page.jsp" flush="true">
        ...
        <jsp:param name="page" value="ViewPartnerFraudAccountsDetails"/>
