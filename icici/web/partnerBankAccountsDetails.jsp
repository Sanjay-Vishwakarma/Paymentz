...
<head>
  ...
  <title> Partner Bank Accounts </title>
</head>
<body>
...
<div class="reporttable">
  ...
  <table align=center width="50%" class="table table-striped table-bordered table-hover table-green dataTable">
    ...
    <tr>
      ...
      <td valign="middle" align="center"class="th0">IsActive</td>
    </tr>
    </thead>
    <%
      ...
      for(int pos=1;pos<=records;pos++)
      {
        ...
        if(temphash!=null)
        {
          GatewayAccount  account= GatewayAccountService.getGatewayAccount((String) temphash.get("accountid"));
          GatewayType  gatewayType= GatewayTypeService.getGatewayType(account.getPgTypeId());

          out.println("<tr>");
          out.println("<td align=center "+style+">&nbsp;"+srno+ "</td>");
          out.println("<td align=center "+style+">&nbsp;" +account.getAccountId()+"</td>");
          out.println("<td align=center "+style+">&nbsp;" +account.getMerchantId()+"</td>");
          out.println("<td align=center "+style+">&nbsp;"+gatewayType.getGateway()+"</td>");
          out.println("<td align=center "+style+">&nbsp;" +gatewayType.getCurrency()+"</td>");
          out.println("<td align=center "+style+">&nbsp;" +temphash.get("isActive")+"</td>");
          out.println("</tr>");
        }
  ...
  <table align=center valign=top><tr>
    <td align=center>
      <jsp:include page="page.jsp" flush="true">
        ...
        <jsp:param name="page" value="ViewPartnerBankAccountsDetails"/>
