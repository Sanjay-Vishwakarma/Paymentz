...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <br>
      <form name = "FIRCForm" action="/icici/servlet/UploadBinFile?ctoken=<%=ctoken%>" method="post" ENCTYPE="multipart/form-data">
...
<div class="reporttable">
  ...
  <%
    ...
    {
      out.println(Functions.NewShowConfirmation("Filter","please upload the Whitelist bin details File."));
    }
  %>
</div>
<%
