...
<%
    ...
    Hashtable mailEntity = mailUIUtils.getMailEntity();
...
<form action="/icici/servlet/AddMailMappingDetail?ctoken=<%=ctoken%>" method="POST">
    ...
    <table align="center" width="65%" cellpadding="2" cellspacing="2">
        ...
        <tr>
            <td>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                    <tbody>
                    <tr><td class="textb" align="center" colspan="4"><b>Add Mail Mapping</b></td>
                    </tr>
                    <tr><td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                        <td width="2%" class="textb">&nbsp;</td>
                        <td width="43%" class="textb">Mail Event</td>
                        <td width="5%" class="textb">:</td>
                        <td width="50%" class="textb">
                            <select class="txtbox" size="1" name="eventid" style="width: 340;" >
                                <%
                                    String selected5 = "";
                                    String key5 = "";
                                    String value5 = "";
                                    TreeMap treeMap5 = new TreeMap(mailEvents);
                    ...
                    <tr>
                        <td class="textb">&nbsp;</td>
                        <td class="textb">Mail From Entity</td>
                        <td class="textb">:</td>
                        <td>
                            <select class="txtbox" size="1" name="fromentityid" >
                                ...
                                <%
                                    String key7 = "";
                                    String value7 = "";
                                    TreeMap treeMap7 = new TreeMap(mailEntity);
                                    ...
                                    while (itr7.hasNext())
                                    {
                                        ...
                                        {
                                %>
                                <option value="<%=key7%>"> <%=value7%> </option>
                                <%    }
                                }
                                %>
                            </select>
                    ...
                    <tr>
                        <td class="textb">&nbsp;</td>
                        <td class="textb">Mail TO Entity </td>
                        <td class="textb">:</td>
                        <td>
                            <select class="txtbox" size="1" name="toentityid" >
                                <%
                                    String key8 = "";
                                    String value8 = "";
                                    TreeMap treeMap8 = new TreeMap(mailEntity);
                                ...
                                %>
                                <option value="<%=key8%>"> <%=value8%> </option>
                                <%
                                    }
                                %>
                            </select>
                    ...
                    <tr>
                        <td class="textb">&nbsp;</td>
                        <td class="textb">Mail Template</td>
                        <td class="textb">:</td>
                        <td>
                            <select class="txtbox" size="1" name="templateid" style="width: 220px;">
                                <option> </option>
                                <%
                                    String selected6 = "";
                                    String key6 = "";
                                    String value6 = "";
                                    TreeMap treeMap6 = new TreeMap(mailTemplate);
                                ...
                                %>
                                <option value="<%=key6%>"> <%=value6%> </option>
                                <%
                                    }
                                %>
                            </select>
                    ...
                    <tr>
                        <td class="textb">&nbsp;</td>
                        <td class="textb">Mail Subject</td>
                        <td class="textb">:</td>
                        <td>
                            <input type="text" size="40" name="subject" value="" class="txtboxsignup">
                        </td>
                    </tr>
                    <tr>
                        <td width="2%" class="textb">&nbsp;</td>
