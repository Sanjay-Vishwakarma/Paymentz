...
<html>
<head>
    <title>Block Transactions> Block VPA Address</title>
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <form name="FIRCForm" id="uploadForm" action="/icici/servlet/VpaAddressDetails?ctoken=<%=ctoken%>" method="post" ENCTYPE="multipart/form-data" >
            <input type="hidden" value="<%=ctoken%>" name="ctoken">
            <input type="hidden" name="perfromAction" value="" id="search">
        <br>
        <%
                ...
                <tr>
                    <td>
                        <table  border="0" cellpadding="5" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td class="textb" colspan="2" align="left"><b>VPA Address Details:&nbsp;&nbsp;</b></td>
