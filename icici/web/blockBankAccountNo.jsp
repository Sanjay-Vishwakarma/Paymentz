...
<html>
<head>
    <title>Block Bank Account Number</title>
  <script>
    ...
    function Unblock()
    {
      ...
      {
        document.BlacklistBankAccountNo.submit();
      }
    }
  </script>
</head>
<%
  session.setAttribute("submit","Block Bank Account");
  ...
  <div class="col-lg-12">
    <div class="panel panel-default"style="margin-top: 0px">
      <div class="panel-heading" >
        Blocked Bank Account Number List
        <div style="float:right">
          <form action="/icici/uploadbankaccount.jsp?ctoken=<%=ctoken%>" method="post">
            <button type="submit" value="Upload Bank Accountno" name="submit" class="addnewmember">
              <i class="fa fa-sign-in"></i>
              Upload Bulk Bank Account Number
            </button>
          </form>
        </div>
      </div>
      ...
      %>
      <form action="/icici/servlet/BlacklistBankAccountNo?ctoken=<%=ctoken%>" name="frm1" method="post">
        <input type="hidden" value="<%=ctoken%>" name="ctoken" id="ctoken">
        <table align="center" width="65%" cellpadding="2" cellspacing="2" style="margin-left:40% !important;">
          <tbody>
          <tr>
            <td>
              <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                ...
                <tr>
                  <td class="textb">&nbsp;</td>
                  <td class="textb">Bank Account Number </td>
                  <td class="textb">:</td>
                  <td>
                    <input name="bankAccountNo" id="bankAccountNo" class="txtbox" value="">
                  </td>
                </tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
                <tr>
...
<div class="reporttable">
    <%
    if(request.getAttribute("listofBankAccountNo")!=null)
    {
      List<BlacklistVO> bankAccountNoList = (List<BlacklistVO>)request.getAttribute("listofBankAccountNo");
      PaginationVO paginationVO=(PaginationVO) request.getAttribute("paginationVO");
      paginationVO.setInputs("ctoken=" + ctoken+paginationVO.getInputs());
      if(bankAccountNoList.size()>0)
      {
  %>
  <form name="BlacklistBankAccountNo" action="/icici/servlet/BlacklistBankAccountNo?ctoken=<%=ctoken%>" method="post">
    <table align=center width="100%" class="table table-striped table-bordered table-hover table-green dataTable">
      ...
      <tr>
        ...
        <td  align="center" class="th0">Bank Account Number</td>
      ...
      <%
        ...
        for(BlacklistVO blacklistVO : bankAccountNoList)
        {
         ...
         /* if(functions.isValueNull(blacklistVO.getRemark()))
          ...
          out.println("<td align=center "+style+">&nbsp;" + ESAPI.encoder().encodeForHTML(blacklistVO.getBlacklistBankAccountNo())+"</td>");
  ...
  <table align=center valign=top><tr>
    <td align=center>
      <jsp:include page="page.jsp" flush="true">
        ...
        <jsp:param name="page" value="BlacklistBankAccountNo"/>
...
<%
  ...
  {
    out.println(Functions.NewShowConfirmation("Filter", "Please provide the data to get Blocked Bank Account Number List"));
  }
