    ...
    <div class="panel panel-default" >
      ...
      <%
        ...
        if (request.getParameter("MES") != null)
        {
          ...
          if (mes.equals("F"))
          {
            out.println("<table align=\"center\"><tr><td align=center ><font class=\"textb\" ><b>Favicon File Upload Failed...");
          ...
          else
          {
            ...
            out.println("<table align=\"center\"><tr><td align=center><font class=\"textb\" ><b>Favicon File Uploaded Successfully...  ");
            out.println("</b></font></td></tr><tr><td algin=\"center\" >");
      ...
      <table  align="center" width="70%" cellpadding="2" cellspacing="2">
        <form action="/icici/servlet/PartnerFavicon?ctoken=<%=ctoken%>" method="post" name="form1" ENCTYPE="multipart/form-data">
          ...
          <tr>
            <td>
              ...
              <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center" >
                ...
                <tr>
                  <td class="textb">&nbsp;</td>
                  <td class="textb"><span class="textb">Favicon Name*</span><br>
                    (Ex. Favicon.jpg / Favicon.jpeg)</td>
                  <td class="textb">:</td>
                  <td class="textb"><input  type="file" maxlength="30"   value="Select Icon File" name="logonm" size="35"></td>
                </tr>
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr>
                  <td colspan="4" class="textb" align="center"><label>NOTE: Please try to upload image size of 16 x 16 or 32 x 32 for ease.</label></td>
                </tr>
                <tr><td colspan="4">&nbsp;</td></tr>
