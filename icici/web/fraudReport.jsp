...
<html>
  <head><title>Fraud Report</title><script type="text/javascript">
...
<%  ctoken = ((User)session.getAttribute("ESAPIUserSessionKey")).getCSRFToken();
    ...
    %>
    <h1 align="center">Fraud Report</h1>
    <form action="/icici/servlet/FraudReport?ctoken=<%=ctoken%>" method="post" name="forms" >
...
%>
<table align=center  >
<tr ><td valign="middle" colspan="11"  align="center"  width="60%"  bgcolor="#008BBA"><font face="arial,verdana" size="2" color="#ffffff" >Fraud report</font></td></tr>
<tr>
    ...
    <td valign="middle" align="center" bgcolor="#008BBA"><font color="#FFFFFF" >Card Holder Name</font></td>
    <td valign="middle" align="center" bgcolor="#008BBA"><font color="#FFFFFF" >Email Address</font></td>
	<td valign="middle" align="center" bgcolor="#008BBA"><font color="#FFFFFF" >MerchantID</font></td>
    <td valign="middle" align="center" bgcolor="#008BBA"><font color="#FFFFFF" >Description</font></td>
    ...
    <td valign="middle" align="center" bgcolor="#008BBA"><font color="#FFFFFF" >Transaction Date</font></td>
</tr>
<%
	...
	for(int pos=1;pos<=records;pos++)
	{
		...
		int srno=Integer.parseInt(id)+ ((pageno-1)*pagerecords);
            ...
            out.println("<td "+style+">&nbsp;" +temphash.get("name")+"</td>");
            out.println("<td "+style+">&nbsp;" +temphash.get("emailaddr")+"</td>");
           ...
           out.println("<td "+style+">&nbsp;"+(String)temphash.get("last_update_date")+"</td>");
...
<jsp:include page="page.jsp" flush="true">
    ...
    <jsp:param name="page" value="FraudReport"/>
