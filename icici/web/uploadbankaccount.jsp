...
<html>
<head>
  <title>Upload Bulk Bank Account Number</title>
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <form name = "FIRCForm" id="uploadForm" action="/icici/servlet/UploadBankAccount?ctoken=<%=ctoken%>" method="post" ENCTYPE="multipart/form-data" >
          ...
          <tr>
            <td>
              <table  border="0" cellpadding="5" cellspacing="0" align="center">
                ...
                <tr>
                  <td class="textb" colspan="2" align="left"><b>Upload Bulk Bank Account Number:&nbsp;</b></td>
