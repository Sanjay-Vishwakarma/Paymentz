...
//        System.out.println("partneridhash----hashtable"+partneridhash);
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" >
            ...
            <table  align="center" width="70%" cellpadding="2" cellspacing="2">
                <form action="/icici/servlet/NewPartnerLogo?ctoken=<%=ctoken%>" method="post" name="form1" ENCTYPE="multipart/form-data">
                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center" >
                                ...
                                <tr>
                                    ...
                                    <td class="textb">:</td>
                                    <td class="textb"><input  type="file" maxlength="30"   value="Select Logo File" name="logonm" size="35"></td>
                                </tr>
                                ...
                                <tr>
                                    <td class="textb">&nbsp;</td>
                                    <td class="textb"><span class="textb">Logo Width</span><br></td>
                                    <td class="textb">:</td>
                                    <td class="textb"><input class="txtbox" type="text" maxlength="3"  onkeypress="return isNumberKey(event)"  value="140" name="logowidth" id="logowidth"  ></td>
                                </tr>
                                <tr><td colspan="4">&nbsp;</td></tr>
                                <tr>
                                    <td class="textb">&nbsp;</td>
                                    <td class="textb"><span class="textb">Logo Height</span><br></td>
                                    <td class="textb">:</td>
                                    <td class="textb">
                                        <input class="txtbox" type="text" maxlength="3" value="38" onkeypress="return isNumberKey(event)" name="logoheight" id="logoheight" ></td>
                                </tr>
                                <tr>
                                    <td colspan="4">&nbsp;</td></tr>
