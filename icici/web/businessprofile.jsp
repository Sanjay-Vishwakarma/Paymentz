        ...
        <div class="page-heading">
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Business Profile</h2>
                        ...
                        <div class="widget-content padding">
                            <div id="horizontal-form">
                                ...
                                <div class="form-group col-md-6 has-feedback">
                                    <label style="font-family:Open Sans;font-size: 13px;font-weight: 600;">
                                ...
                                <%
                                    ...
                                    {
                                %>
                                <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color:#7eccad !important;font-family: 'Open Sans';font-size: 14px;font-weight: 400;color:white;margin-bottom: 20px;">Ticket Size of the Product</h2>
                   ...
                   <span style="<%=validationErrorList.getError("atlessthan_HT")!=null?"background-color: #f2dede;":""%>" class="errormesage" width="50%">
                            <%=validationErrorList.getError("atlessthan_HT")!=null?"Average ticket must be less than or equal to Highest Ticket":""%>
                                ...
                                <%
                                    ...
                                    {
                                %>
                                <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color:#7eccad !important;font-family: 'Open Sans';font-size: 14px;font-weight: 400;color:white;margin-bottom: 20px;">Billing Type</h2>
                                ...
                                <div class="form-group col-md-12 has-feedback">
                                    ...
                                    <div class="col-md-8" style="padding: 0;">
                                        ...
                                        <div class="form-group col-md-4 col-lg-8" style="padding: 0;">
                                            ...
                                            <div class="col-md-7 col-lg-7" style="padding-left: 0;" id="margintop10">
                                ...
                                <script>
                                    $(function(){
                                        ...
                                        $("input[name='us']").on("change", function ()
                                        {
                                ...
                                <div class="form-group col-md-4 has-feedback">
                                    <div class="col-md-6" style="padding:0;">
                                        <label class="checkbox-inline" id="align_check" style="font-family:Open Sans;font-size: 13px;font-weight: 600;display: flex;padding-left: 0;">
                                            <input type="checkbox" name="europe" value="foreigntransactions_Europe" <%=globaldisabled%> <%if(functions.isValueNull(businessProfileVO.getForeigntransactions_Europe())){%> checked <%}%> onchange="return myShareholder(this.value,'shareholderprofile1_owned','shareholderprofile3_owned',2)" />
                                            &nbsp;&nbsp;Europe</label>
                                    </div>
                                    <div class="col-md-6" id="margintop10" style="padding:0;">
                                        <div class="input-group">
            ...
            <%
                if(businessProfileInputList.contains(BankInputName.urls)|| businessProfileInputList.contains(BankInputName.descriptor) || businessProfileInputList.contains(BankInputName.ipaddress) ||
                        ...
                        businessProfileInputList.contains(BankInputName.test_link)|| businessProfileInputList.contains(BankInputName.listfraudtools)|| businessProfileInputList.contains(BankInputName.listfraudtools_yes)||
                        businessProfileInputList.contains(BankInputName.merchantcode)|| businessProfileInputList.contains(BankInputName.directmail)|| businessProfileInputList.contains(BankInputName.Yellowpages)||
                        businessProfileInputList.contains(BankInputName.radiotv)|| businessProfileInputList.contains(BankInputName.internet)|| businessProfileInputList.contains(BankInputName.networking)||
                        businessProfileInputList.contains(BankInputName.outboundtelemarketing)|| businessProfileInputList.contains(BankInputName.orderconfirmation_post) || businessProfileInputList.contains(BankInputName.orderconfirmation_email) ||
                        businessProfileInputList.contains(BankInputName.orderconfirmation_sms) || businessProfileInputList.contains(BankInputName.orderconfirmation_other) || businessProfileInputList.contains(BankInputName.orderconfirmation_other_yes) ||
                        businessProfileInputList.contains(BankInputName.goods_delivery) || businessProfileInputList.contains(BankInputName.pre_authorization) ||
                        businessProfileInputList.contains(BankInputName.pricing_policies_website) || businessProfileInputList.contains(BankInputName.pricing_policies_website_yes) ||
                        businessProfileInputList.contains(BankInputName.physicalgoods_delivered) || businessProfileInputList.contains(BankInputName.viainternetgoods_delivered) ||view)
                {
            %>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Website Information</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Website Compliance</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                            ...
                            <div id="horizontal-form">
                                ...
                                <div class="widget-content padding">
                                    <div id="horizontal-form">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label style="font-family:Open Sans;font-size: 13px;font-weight: 600;padding: 0;">After purchase do you send order confirmation to the cardholder? (pls. provide us with a copy):</label>
                                        </div>
                                ...
                                <div class="form-group col-md-12 has-feedback" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">
                                    ...
                                    <div class="col-md-2" style="padding: 0;">
                                        ...
                                        &nbsp;Yes
                                        &nbsp;&nbsp;<input type="radio" name="affiliate_programs" value="N" <%="N".equals(businessProfileVO.getAffiliate_programs()) || !functions.isValueNull(businessProfileVO.getAffiliate_programs()) ?"checked":""%> /> <%--Condition for radio button--%>
                                        &nbsp;No &nbsp;
                                    </div>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Warehouse & Product Shipment Details</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                        ...
                        <div class="widget-content padding">
                            <div id="horizontal-form">
                                ...
                                <div class="form-group col-md-12 has-feedback">
                                    <div class="col-md-6" style="padding-left: 0;">
                                        <label for="coolingoffperiod" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Is your Return of Goods policy clearly visible to the customers on your website?</label>
                                    </div>
                                    <div class="col-md-6" style="padding: 0;">
                                ...
                                <div class="form-group col-md-12" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">
                                    <div class="col-md-6" style="padding-left: 0;">
                                        <label style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Do you have return of goods policy?</label></div>
                                    <div class="col-md-6" style="padding: 0;">
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Customer Service Information</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Market Strategy</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Membership</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Other Information</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Technical Solution</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            ...
                            <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color: #9fabb7;text-align: center"> Service Provider</h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                        ...
                        <div class="widget-content padding">
                            <div id="horizontal-form">
                                ...
                                <h2 class="col-md-12 background panelheading_color headpanelfont_color" style="background-color:#7eccad !important;font-family: 'Open Sans';font-size: 14px;font-weight: 400;color:white;margin-bottom: 20px;">Payment Provider
            ...
            <%
                ...
                out.println("<div class=\"page-heading\">");*/
                    ...
                    out.println("<div class=\"widget-header transparent\">\n" +
                            "                                <h2 class=\"col-md-12 background panelheading_color headpanelfont_color\" style=\"background-color: #9fabb7;text-align: center\"> Business Details</h2>\n" +
                            "                                <div class=\"additional-btn\">\n" +
                            "                                    <a href=\"#\" class=\"hidden reload\"><i class=\"icon-ccw-1\"></i></a>\n" +
                            "                                    <a href=\"#\" class=\"widget-toggle\"><i class=\"icon-down-open-2\"></i></a>\n" +
                            "                                    <a href=\"#\" class=\"widget-close\"><i class=\"icon-cancel-3\"></i></a>\n" +
