...
<%
    ...
    {
%>
<p align="center" class="title">New Agent Signup Form</p>

<p>
<table  width="100%" >
    <tr><td>&nbsp;</td></tr>
    <%--<tr align="center" >
        <td class="subtitle" align="center" >New Login</td>
    </tr>--%>
    ...
    <form action="/icici/servlet/NewAgent?ctoken=<%=ctoken%>" method="post" name="form1">
        ...
        <tr>
            <td>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%" bgcolor="#ecf0f1" align="center">

                    <tr class="texthead">
                        <td width="2%" >&nbsp;</td>
                        <td colspan="3" >
                            Agent Information (New Login)
                        </td>
