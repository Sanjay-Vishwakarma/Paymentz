...
<head>
    ...
    <script>
        function gateway1validation()
        {

            var value = document.getElementById("gateway1").value;
            var alphanum = /^[0-9a-zA-Z]+$/;
            if (value.match(alphanum)||value==="")
            {
                return true;
            }
            else
            {
                alert("Please Enter Valid Gateway/Account");
                return false;
            }
        }
        ...
        /*
         ...
         {
         var value=document.getElementById("memid").value;
         var alphanum=value.length;
         if(alphanum>7)
         {
         return true;
         }
                        ...
                        <td>
                            <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td class="textb">:</td>
                                    <td>
                                        <input name="pgtypeid" id="gateway1" value="<%=pgtypeid%>" class="txtbox" onkeypress="return gateway1validation();"
                                               autocomplete="on">
                                ...
                                <td class="textb">:</td>
                                <td>
                                    <input name="accountid" id="accid" maxlength="10" type="number"
                                ...
                                <tr>
                                    ...
                                    <td class="textb">:</td>
                                    <td>
                                        <input type="text" name="toid" id="memid" value="<%=memberid%>" class="txtbox" maxlength="8" onkeypress="return isNumberKey(event);"
                                               autocomplete="on">
