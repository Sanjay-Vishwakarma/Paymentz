...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default" >
               ...
               Add New Admin Module
                <div style="float: right;">
                    <form action="/icici/adminModuleList.jsp?ctoken=<%=ctoken%>" method="POST">
                        <button type="submit" value="Admin Module Master" name="submit" class="addnewmember">
            ...
            <br>
            <form action="/icici/servlet/AddNewAdminModule?ctoken=<%=ctoken%>" method="post" name="forms" >
                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="5" cellspacing="0" width="100%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td width="43%" class="textb">Admin Module Name</td>
