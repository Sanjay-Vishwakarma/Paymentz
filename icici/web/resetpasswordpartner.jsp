...
<%!
  private static Logger log = new Logger("resetpasswordpartner.jsp");
%>
<%
        ...
        <div style="float: right;">
          <form action="/icici/partnerInterface.jsp?ctoken=<%=ctoken%>" method="POST">
            <button type="submit" name="submit" class="addnewmember">
              <i class="fa fa-sign-in" ></i> &nbsp;&nbsp; Partner Details
            </button>
          </form>
        </div>
      </div>
      <form action="/icici/servlet/ResetPasswordPartner?ctoken=<%=ctoken%>" method="POST" >
...
<div class="reporttable" style="overflow: auto">
  ...
  <%
      ...
      if (request.getAttribute("TemparoryPassword") != null){
        out.println("<h5 class=\"textb\" style=\"text-align: center;\">"+ "Temporary Password  for Username::::::" + forgotpassword+ "</h5>");
      }
