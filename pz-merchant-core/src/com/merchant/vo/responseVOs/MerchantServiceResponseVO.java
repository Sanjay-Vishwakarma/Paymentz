...
public class MerchantServiceResponseVO
{
  ...
  @XmlElement (name="upiSupportInvoice")
    String upiSupportInvoice;

  @XmlElement (name="upiQRSupportIinvoice")
    String upiQRSupportIinvoice;

  @XmlElement (name="paybylinkSpportInvoice")
    String paybylinkSpportInvoice;

  @XmlElement (name="AEPSSupportInvoice")
