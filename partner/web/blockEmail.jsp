...
<body>
  ...
  if (partner.isLoggedInPartner(session))
  {
    ...
    String email=nullToStr(request.getParameter("email"));
        ...
        <div class="col-sm-12 portlets ui-sortable">
          <div class="widget">
            <div class="widget-header transparent">
              <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Blocked Email ID</strong>
              </h2>
            ...
            <div class="widget-content">
              <div id="horizontal-form">
                <form action="/partner/net/BlockEmail?ctoken=<%=ctoken%>" method="post" onsubmit=""  name="forms" >
                  <div align="center">
                    ...
                    <div class="form-group col-md-12">
                      <div class="ui-widget">
                        ...
                        <div class="col-md-3">
                          <input name="email"  maxlength="100" value="<%=email%>" class="form-control" >
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                      <div class="ui-widget">
                        ...
                        <div class="col-md-3">
                          <input name="reason"  maxlength="100" value="<%=reason%>" class="form-control" >
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                      <div class="ui-widget">
                        ...
                        <div class="col-md-3">
                          <input name="remark"  maxlength="100" value="<%=remark%>"  class="form-control">
                        </div>
                      </div>
                    </div>
        ...
        <div class="col-md-12">
          <div class="widget">
            <div class="widget-header">
              <h2><i class="fa fa-table"></i>&nbsp;&nbsp;<strong>Blocked Email</strong></h2>
              <div class="additional-btn">
                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
            ...
            <div class="widget-content padding">
              <%
                ...
                {
                  List<BlacklistVO> cList = (List<BlacklistVO>)request.getAttribute("listofemail");
                  if(cList.size()>0 && records > 0)
                  {
              %>
              <br>
              <form action="/partner/net/BlacklistEmailDelete?ctoken=<%=ctoken%>" method="POST" name="BlockEmail">
                <table id="myTable" class="display table table-striped table-bordered" width="100%" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                  ...
                  <tr style="color: white; background-color:#7eccad">
                    ...
                    <th valign="middle" align="center" style="text-align: center">Blocked Emails</th>
          ...
          <jsp:include page="page.jsp" flush="true">
            ...
            <jsp:param name="page" value="BlockEmail"/>
