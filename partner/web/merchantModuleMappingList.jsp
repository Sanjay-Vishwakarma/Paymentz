...
<%
  ...
  session.setAttribute("submit","merchantModuleMappingList");
            ...
            <div class="pull-right">
              <div class="btn-group">
                <form action="/partner/memberChildSignup.jsp?ctoken=<%=ctoken%>" method="POST">
                  <button class="addnewmember btn-xs" type="submit" value="memberChildList" name="submit" style="background: white;border: 0;">
          ...
          <div class="widget">
            ...
            <div class="pull-right">
              <div class="btn-group col-md-6">
                <form action="/partner/net/AllocationUser?ctoken=<%=ctoken%>" method="POST">
                 ...
                 <input type="hidden" value="<%=request.getParameter("mappingid")%>" name="mappingid">
                  <button type="submit" class="addnewmember btn btn-default" value="AllocationUser" name="submit">
            ...
            <div class="widget-content padding" style="overflow-x: auto;">
              ...
              <table id="myTable" class="display table table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                ...
                <tr>
                  ...
                  <td align="center" style="vertical-align: middle;" <%=style%> data-label="Action" style="line-height:0.00;">&nbsp;<form action="/partner/net/ActionMerchantModule?ctoken=<%=ctoken%>" method="post"><input type="hidden" name="mappingid" value=<%=mappingId%>><input type="hidden" name="login" value="<%=ESAPI.encoder().encodeForHTML((String)request.getAttribute("login"))%>"><input type="hidden" name="userid" value="<%=ESAPI.encoder().encodeForHTML((String)request.getAttribute("userid"))%>"><input type="hidden" name="merchantid" value="<%=ESAPI.encoder().encodeForHTML(request.getParameter("merchantid"))%>"><input type="hidden" name="action" value="remove"> <input type="submit" class="btn btn-default" value="Remove"></form></td>
                </tr>
                </tbody>
