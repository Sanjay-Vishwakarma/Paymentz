...
<%
  ...
  if (partner.isLoggedInPartner(session))
  {
    ...
    String partnerMonitoringRuleLog_page_no = StringUtils.isNotEmpty(rb1.getString("partnerMonitoringRuleLog_page_no")) ? rb1.getString("partnerMonitoringRuleLog_page_no") : "Page number";
    String partnerMonitoringRuleLog_total_no_of_records = StringUtils.isNotEmpty(rb1.getString("partnerMonitoringRuleLog_total_no_of_records")) ? rb1.getString("partnerMonitoringRuleLog_total_no_of_records") : "Total number of records";
...
<head>
  ...
  <title><%=company%> Merchant Monitoring> Rule Logs</title>
...
<div class="content-page">
  ...
  <div class="col-sm-12 portlets ui-sortable">
    ...
    <div class="widget">
      ...
      %>
      <div id="showingid"><strong><%=partnerMonitoringRuleLog_page_no%> <%=pageno%>  <%=partnerMonitoringRuleLog_of%>  <%=TotalPageNo%></strong></div> &nbsp;&nbsp;
      <div id="showingid"><strong><%=partnerMonitoringRuleLog_total_no_of_records%>   <%=totalrecords%> </strong></div>
