<%@ page errorPage=""
         import="com.directi.pg.Functions,java.util.Hashtable" %>
          ...
          <div class="widget">
            ...
            <div class="widget-content padding">
              ...
              <table class="display table table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                ...
                <tr >
                  <th style="text-align: center; background-color: #7eccad !important;color: white;">Sr No</th>
                  <th style="text-align: center; background-color: #7eccad !important;color: white;">Tracking Id</th>
                  <th style="text-align: center; background-color: #7eccad !important;color: white;">Status</th>
                </tr>
                </thead>
                <%
                  String style = "";
