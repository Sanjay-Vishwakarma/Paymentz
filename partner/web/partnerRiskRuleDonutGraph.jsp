...
<div class="content-page">
    <div class="content">
        ...
        <div class="row">
                    ...
                    <div class="widget-content padding">
                        <div id="">
                            <form action="/partner/net/PartnerMerchantMonitoringGraphController?ctoken=<%=ctoken%>"
                                ...
                                <div class="form-group col-md-4 has-feedback">
                                    <label for="rn">Risk Rule ID*</label>
            ...
            <%
                if ("daily".equals(dailyFrequency) && functions.isValueNull(dailyJsonStr))
                {
            %>
            ...
            <%
                ...
                if ("weekly".equals(weeklyFrequency) && functions.isValueNull(weeklyJsonStr))
                {
            %>
            <div class="col-sm-6 portlets ui-sortable">
                <div class="widget">
