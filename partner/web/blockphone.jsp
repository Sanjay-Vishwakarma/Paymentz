        ...
        <div class="col-sm-12 portlets ui-sortable">
          <div class="widget">
            <div class="widget-header transparent">
              <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Block Phone</strong>
              </h2>
            ...
            <div class="widget-content">
              <div id="horizontal-form">
                <form action="/partner/net/BlockPhoneNumber?ctoken=<%=ctoken%>" method="post" onsubmit=""  name="forms" >
                  <div align="center">
                    ...
                    <div class="form-group col-md-12">
                      <div class="ui-widget">
                        ...
                        <div class="col-md-3">
                          <input size="8" maxlength="24" type="text"  class="form-control" name="phone"  value="<%=phone%>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group col-md-12">
        ...
        <div class="col-md-12">
          <div class="widget">
            <div class="widget-header">
              ...
              <h2><i class="fa fa-table"></i>&nbsp;&nbsp;<strong>Blocked Phone Number List</strong></h2>
              <div class="additional-btn">
                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
            ...
            <div class="widget-content padding">
              ...
              %>
              <br>
              <form action="/partner/net/BlockPhoneDelete?ctoken=<%=ctoken%>" method="POST" name="BlockEmail">
              <table id="myTable" class="display table table-striped table-bordered" width="100%" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                ...
                <tbody>
                  ...
                  reason="";
                    ...
                    out.println("<td align=center "+style+">"+blacklistVO.getPhone()+"</td>");
