...
<html>
<head>
  <title><%=company%> Rejected Transaction List</title>
  <style type="text/css">
              ...
              <div class="pull-right">
                <div class="btn-group">
                  <form name="exportform" method="post" action="/partner/net/ExportTransactions?ctoken=<%=ctoken%>" >
                    ...
                    <input type="hidden" value="<%=ESAPI.encoder().encodeForHTMLAttribute(Roles)%>" name="role">
                  ...
                  <%
                   ...
                   /* if ("JPY".equalsIgnoreCase(currency))
                    ...
                    else if ("USD".equalsIgnoreCase(currency))
                    {
                      ...
                      out.println("<td align=center>" + print_email+ "</td>");
