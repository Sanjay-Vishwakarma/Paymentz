...
function myOwnerShip(val,secondname,thirdname,option)
{
    ...
    if((val >=100 || val <=0) && option==1)
    {
        ...
        if(val>100)
        {
            this.document.forms["myformname"]['nameprincipal1_owned'].focus();
...
/*function myShareholder(val,secondname,thirdname,option)
{
    var value2 = this.document.forms["myformname"][secondname].value ;
    var value3 = this.document.forms["myformname"][thirdname].value ;
    var sum1= Number(val) + Number(value2);
...
function calculateLastMonth()
{
    ...
    if(salesVolume!="" && refundVolume!="")
    {
        ...
        else
        {
            ...
            this.document.myformname.refundratio_lastmonth.value=refundRatio;
        }
    }
    else
    {
    ...
    if(salesVolume!="" && chargeBackVolume!="")
    {
        ...
        else
        {
            ...
            this.document.myformname.chargebackratio_lastmonth.value = chargeBackRatio;
        }
    }
    else
    {
...
function myUploadBankTemplate(ctoken)
{
    ...
    document.myformname.action="/partner/net/UploadBankTemplate?ctoken="+ctoken;
}
...
function myUpload(ctoken) {
    document.getElementById("myformname").enctype = "multipart/form-data";
    document.myformname.action="/partner/net/UploadServlet?ctoken="+ctoken;
}
function myUploadNew(ctoken,alternateName) {
    document.getElementById("myformname").enctype = "multipart/form-data";
