    ...
    <div class="content" style="padding:0px 20px;margin: 0px;">
        <div class="page-heading">
                ...
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;WhiteList Email</strong>
                            </h2>
                        ...
                        <div class="widget-content">
                            <div id="horizontal-form">
                                <form action="/partner/net/WhiteListEmail?ctoken=<%=ctoken%>" method="post"
                                      name="forms">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="ui-widget">
                                            ...
                                            <div class="col-md-3">
                                                <input name="emailaddr" id="emailaddr" name="emailaddr" type="text"
                ...
                <div class="col-md-12">
                    <div class="widget">
                        <div class="widget-header">
                            <h2><i class="fa fa-table"></i>&nbsp;&nbsp;<strong>Whitelist Email List</strong></h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                        ...
                        <div class="widget-content padding">
                            ...
                            %>
                            <br>
                            <form action="/partner/net/WhitelistEmailDelete?ctoken=<%=ctoken%>" method="POST" name="BinDelete">
			...
			String actionExecutorName=role+"-"+username;
                    ...
                    out.println("</td>");
                    out.println("<td align=center "+style+">"+getValue(whitelistingDetailsVO.getIpAddress())+"</td>");
                   /* out.println("<td align=center "+style+">");
                  ...
                  %>
                    ...
                    <jsp:include page="page.jsp" flush="true">
                        ...
                        <jsp:param name="page" value="WhiteListEmail"/>
