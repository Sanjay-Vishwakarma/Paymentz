...
<head>
    ...
    %>
    <title><%=company%> Agent Management> Agent Master</title>
    ...
    <script>
        ...
        {
            var x = confirm("Do you really want to Unblock this Agent ?");
            if (x)
                return true;
            else
                return false;
                           ...
                           <form action="/partner/net/ListAgentDetails?ctoken=<%=ctoken%>" method="post" name="forms" >
                            ...
                            %>
                             ...
                             <div class="form-group col-md-4 has-feedback">
                               ...
                               <input  type="text" name="agentname" class="form-control" value="<%=ESAPI.encoder().encodeForHTMLAttribute(agentName)%>">
                             </div>
                        ...
                        <%
                                ...
                                while(stringEnumeration.hasMoreElements())
                                 {
                                   ...
                                   if("SPageno".equals(name) || "SRecords".equals(name))
                                   {
                                    ...
                                    String unblockmsg= (String) request.getAttribute("unblockmsg");
                                    if (funct.isValueNull(unblockmsg)){
                                        out.println(Functions.NewShowConfirmation1("",unblockmsg));
                                     }
                                      else if(records>0)
                                       {
                            %>
                          <table align=center width="50%" class="display table table table-striped table-bordered table-hover dataTable" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                            ...
                            <tr>
                                ...
                                <td  valign="middle" align="center" style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;" colspan="3"><b>Action</b></td>
                                <td  valign="middle" align="center" style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;"><b>Merchant Details</b></td>
                                <td  valign="middle" align="center" style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;"><b>Merchant Transaction Summary</b></td>
                              </tr>
                            </thead>
                           <%
                              Functions functions = new Functions();
                               ...
                               for(int pos=1;pos<=records;pos++)
                               {
                                  ...
                                  String disabled="";
                                   ...
                                   out.println("<td valign=\"middle\" data-label=\"Activation Date\" align=\"center\" "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String) temphash.get("agentId"))+ "</td>");
                                   out.println("<td valign=\"middle\" data-label=\"Activation Date\" align=\"center\" "+style+">&nbsp;"+ESAPI.encoder().encodeForHTML((String) temphash.get("agentName"))+ "</td>");
                                   out.println("<td valign=\"middle\" data-label=\"Action\" align=\"center\""+style+"><form action=\"/partner/net/ViewAgentDetails?ctoken="+ctoken+"\" method=\"POST\"><input type=\"hidden\" name=\"agentid\" value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("agentId"))+"\"><input type=\"submit\" name=\"submit\" value=\"View\" class=\"gotoauto btn btn-default\" ><input type=\"hidden\" name=\"action\" value=\"View\">");
                                   out.println(requestParameter.toString());
                                   out.println("</form></td>");
                                   out.println("<td valign=\"middle\" data-label=\"Action\" align=\"center\""+style+"><form action=\"/partner/net/ViewAgentDetails?ctoken="+ctoken+"\" method=\"POST\"><input type=\"hidden\" name=\"agentid\" value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("agentId"))+"\"><input type=\"submit\" name=\"submit\" value=\"Edit\" class=\"gotoauto btn btn-default\"><input type=\"hidden\" name=\"action\" value=\"modify\">");
                                   out.println(requestParameter.toString());
                                   out.println("</form></td>");

                                   out.println("<td align=\"center\" data-label=\"Action\" "+style+"><form action=\"/partner/net/UnblockAgent?ctoken="+ctoken+"\" method=\"POST\"><" +
                                           "input type=\"hidden\" name=\"agentid\" value=\""+ESAPI.encoder().encodeForHTML((String)temphash.get("agentId"))+"\">" +
                                           "<input type=\"hidden\" name=\"login\" value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("login"))+"\">" +
                                           "<input type=\"hidden\" name=\"unblocked\"  value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("login"))+"\">" +
                                           "<input type=\"submit\" name=\"Unblock\" value=\"Unblock\" id=\"unblock\" Onclick=\"return ConfirmUnblock();\" class=\"btn btn-default gotoauto\"" +
                                           " width=\"100\"" +disabled+" >");
                                   out.println(requestParameter.toString());
                                   out.println("</form></td>");

                                   out.println("<td valign=\"middle\" data-label=\"Action\" align=\"center\""+style+"><form action=\"/partner/net/AgentMerchantDetails?ctoken="+ctoken+"\" method=\"POST\"><input type=\"hidden\" name=\"agentid\" value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("agentId"))+"\"><input type=\"submit\" name=\"submit\" value=\"View Merchant\" class=\"gotoauto btn btn-default\">");
                                   out.println(requestParameter.toString());
                                   out.println("</form></td>");
                                   out.println("<td valign=\"middle\" data-label=\"Action\" align=\"center\""+style+"><form action=\"/partner/net/AgentMerchantTransactionSummary?ctoken="+ctoken+"\" method=\"POST\"><input type=\"hidden\" name=\"agentid\" value=\""+ESAPI.encoder().encodeForHTML((String) temphash.get("agentId"))+"\"><input type=\"submit\" name=\"submit\" value=\"View Transactions\" class=\"gotoauto btn btn-default\">");
                                   out.println(requestParameter.toString());
                                   out.println("</form></td>");
                                   out.println("</tr>");
                               }
