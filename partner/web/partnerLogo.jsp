...
<head>
  <%
    ...
    String partnerLogo_Partner_Upload = StringUtils.isNotEmpty(rb1.getString("partnerLogo_Partner_Upload")) ? rb1.getString("partnerLogo_Partner_Upload") : "Partner Upload Logo";
    String partnerLogo_Logo_Upload = StringUtils.isNotEmpty(rb1.getString("partnerLogo_Logo_Upload")) ? rb1.getString("partnerLogo_Logo_Upload") : "Logo Upload";
    String partnerLogo_PartnerID = StringUtils.isNotEmpty(rb1.getString("partnerLogo_PartnerID")) ? rb1.getString("partnerLogo_PartnerID") : "Partner ID";
    String partnerLogo_select = StringUtils.isNotEmpty(rb1.getString("partnerLogo_select")) ? rb1.getString("partnerLogo_select") : "---select---";
    String partnerLogo_File_size = StringUtils.isNotEmpty(rb1.getString("partnerLogo_File_size")) ? rb1.getString("partnerLogo_File_size") : "File size should not exceed 500KB";
    String partnerLogo_Upload = StringUtils.isNotEmpty(rb1.getString("partnerLogo_Upload")) ? rb1.getString("partnerLogo_Upload") : "Upload";

  %>
  <title><%=company%> | Partner Upload Logo</title>
...
<div class="content-page">
  <div class="content">
    ...
    <div class="page-heading">
      ...
      <form action="/partner/net/UploadPartnerLogo?ctoken=<%=ctoken%>" enctype="multipart/form-data" method="post">
        <div class="row reporttable">
          <div class="col-md-12">
            <div class="widget">
              <div class="widget-header">
                <h2><i class="fa fa-table"></i>&nbsp;&nbsp;<strong><%=partnerLogo_Partner_Upload%></strong></h2>
                ...
                <div class="widget-content padding" style="overflow-x: auto;">
                  ...
                  <%
                    if (request.getParameter("MES") != null)
                    {
                      ...
                      {
                        out.println("<h5 class=\"bg-alert\" style=\"text-align: center;\"><i class=\"fa fa-info-circle\"></i></i>&nbsp;&nbsp; Logo File Uploaded Successfully.</h5>");
                      }
                    }
                  ...
                  <table align=center  id="smalltable" class="display table table table-striped table-bordered table-hover dataTable" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">
                    ...
                    <thead>
                    <tr>
                      <td colspan="2" valign="middle" align="center" style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;"><b><%=partnerLogo_Logo_Upload%></b></td>
                    </tr>
                    </thead>
                    ...
                    <tr>
                      ...
                      <td valign="middle" data-label="Logo Upload" align="center">
                        ...
                        <input class="form-control" style="text-align: center;"  value="( Ex. logo.jpg / logo.jpeg / logo.png )" disabled/>
                      </td>
                      ...
                      <td valign="middle" data-label="Action" align="center">
                        ...
                        <label><%=partnerLogo_File_size%></label>
                      </td>
