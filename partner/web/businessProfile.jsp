...
<html>
<head>
  <title><%=company%> Rule Management> Business Profile</title>
  <style type="text/css">
...
<%
  ...
  String businessProfile_page_no = StringUtils.isNotEmpty(rb1.getString("businessProfile_page_no")) ? rb1.getString("businessProfile_page_no") : "Page number";
  String businessProfile_please_total_no_of_records = StringUtils.isNotEmpty(rb1.getString("businessProfile_please_total_no_of_records")) ? rb1.getString("businessProfile_please_total_no_of_records") : "Total number of records";
        ...
        <div class="col-md-12">
          <div class="widget">
            ...
            <div class="widget-content padding" style="overflow-x: auto;">
              ...
              %>
              <div id="showingid"><strong><%=businessProfile_page_no%> <%=paginationVO.getPageNo()%>  of  <%=TotalPageNo%></strong></div> &nbsp;&nbsp;
              <div id="showingid"><strong><%=businessProfile_please_total_no_of_records%>     <%=paginationVO.getTotalRecords()%> </strong></div>
