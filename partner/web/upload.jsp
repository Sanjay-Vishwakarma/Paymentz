...
<%
    ...
    String upload_Sr_No = StringUtils.isNotEmpty(rb1.getString("upload_Sr_No")) ? rb1.getString("upload_Sr_No") : "Sr No.";
    String upload_Document_Name = StringUtils.isNotEmpty(rb1.getString("upload_Document_Name")) ? rb1.getString("upload_Document_Name") : "Document Name";
    ...
    String upload_go = StringUtils.isNotEmpty(rb1.getString("upload_go")) ? rb1.getString("upload_go") : "- Go one step back.";
    String upload_Next = StringUtils.isNotEmpty(rb1.getString("upload_Next")) ? rb1.getString("upload_Next") : "Next";
    String upload_go1 = StringUtils.isNotEmpty(rb1.getString("upload_go1")) ? rb1.getString("upload_go1") : "- Go one step forward.";
...
<script>
    ...
    function myUploadNew1(ctoken,alternateName) {
        if(check()) {
            ...
            document.getElementById("myformname").enctype = "multipart/form-data";
            document.myformname.action="/partner/net/UploadServlet?ctoken="+ctoken+"&alternate_name="+alternateName;
            document.myformname.submit();
        }
        else
        {
                        ...
                        <div class="widget-content padding">
                            ...
                            <div id="horizontal-form">
                                ...
                                <div class="bg-info "style="text-align: center;font-size:16px;/*color: #31708f;*/">
                                    ...
                                    <center><h4 class="txtboxinfo bg-info" style="font-family: Open Sans; font-size: 13px; font-weight: 600;background-color:#f3f3f3!important;">Supported Formats: Excel, PDF, JPG & PNG. <br> The file size cannot exceed 2 MB.</h4></center>
                            ...
                            <div>                        <%-- End Radio Button--%>
                                <div class="form-group col-md-12 has-feedback">
                                    ...
                                    <table id="myTable" class="display table table-striped table-bordered" width="100%" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;border: 1px solid #ddd;">
                                        ...
                                        <tr style="background-color: #7eccad;">
                                            <th><%=upload_Sr_No%></th>
                                            <th style="width: 25%;"><%=upload_Document_Name%></th>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" id="newbtn" class="btn btn-default" style="margin-left: 15px;margin-top: 8px;" name="upload" onclick="myUploadNew1('<%=ctoken%>','<%=uploadLabelVO.getValue().getAlternateName()%>')">
