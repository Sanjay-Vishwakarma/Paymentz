        ...
        <div class="col-sm-12 portlets ui-sortable">
          <div class="widget">
            ...
            <div class="widget-header transparent">
              <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Merchant's Merchant Master</strong>
            ...
            <div class="pull-right">
              <div class="btn-group">
                ...
                <form action="/partner/memberChildSignup.jsp?ctoken=<%=ctoken%>" method="POST">
                  <button class="btn-xs" type="submit" value="User Management" name="submit" name="B1" style="background: white;border: 0;">
