...
<body>
<form name="form" method="post" action="PayoutTransactionList?ctoken=<%=ctoken%>">
    ...
    <div class="content">
      ...
      <div class="page-heading">
        <div class="pull-right">
          <div class="btn-group">
            <form action="partner/net/PayoutTransactionList?ctoken=<%=ctoken%>" method="post" name="form">
              <%
        ...
        <div class="page-heading">
                ...
                <div class="widget-content padding" style="overflow-x: auto;">
                  ...
                  <table align=center width="50%"
                    ...
                    <tr>
                      ...
                      <td class="tr" align="center" data-label="Pin Code"
                          valign="middle"><%=ESAPI.encoder().encodeForHTML(customerId)%>
                      </td>
                    </tr>
                  </table>
                </div>
          ...
          <%
            ...
            if (functions.isValueNull(cardNum) || functions.isValueNull(name) || functions.isValueNull(bin_card_type) || functions.isValueNull(bin_card_category))
            {
          %>
          <div class="row reporttable">
            <div class="col-md-12">
