...
$(document).ready(function(){
   ...
   /* $('#sidebar-menu').slimScroll({
    ...
    /*$('#myTable').dataTable();//for table responsive
    ...
    $("#sidebar-menu button").on('click',function(e){
        if(!$("#wrapper").hasClass("enlarged")){
            ...
            if(!$(this).hasClass("subdrop")) {
                ...
                $("button",$(this).parents("ul:first")).removeClass("subdrop");
                //$("#sidebar-menu .pull-right i").removeClass("fa-angle-up").addClass("fa-angle-down");
                $("#sidebar-menu .pull-right i").removeClass("fa-caret-up").addClass("fa-caret-down");
                ...
                $(".pull-right i",$(this).parents(".has_sub:last")).removeClass("fa-caret-down").addClass("fa-caret-up");
                $(".pull-right i",$(this).siblings("ul")).removeClass("fa-caret-up").addClass("fa-caret-down");

            }else if($(this).hasClass("subdrop")) {
                $(this).removeClass("subdrop");
                $(this).next("ul").slideUp(350);
                //$(".pull-right i",$(this).parent()).removeClass("fa-angle-up").addClass("fa-angle-down");
                $(".pull-right i",$(this).parent()).removeClass("fa-caret-up").addClass("fa-caret-down");
...
// NAVIGATION HIGHLIGHT & OPEN PARENT
    $("#sidebar-menu ul li.has_sub button.active").parents("li:last").children("button:first").addClass("active").trigger("click");
