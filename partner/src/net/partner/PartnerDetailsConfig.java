 ...
 */
public class PartnerDetailsConfig extends HttpServlet
{
    private static Logger logger = new Logger(PartnerDetailsConfig.class.getName());
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException,ServletException
    {
       ...
       // RequestDispatcher rdError=request.getRequestDispatcher("/viewpartnerdetails.jsp?MES=ERR&ctoken="+user.getCSRFToken());
        RequestDispatcher rdSuccess= request.getRequestDispatcher("/viewpartnerdetails.jsp?Success=YES&ctoken="+user.getCSRFToken());
