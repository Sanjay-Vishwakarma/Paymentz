 ...
 */
public class PartnerSetMemberConfig extends HttpServlet
{
    static Logger logger = new Logger(PartnerSetMemberConfig.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        logger.debug("Enter in Transection ");
...
//                    int result = Database.executeUpdate(query, Database.getConnection());
            ...
            catch (Exception e)
            {
                ...
                sErrorMessage.append("Internal Error while Fatching records");
