 ...
 */
public class UploadPartnerLogo extends HttpServlet
{
    private Logger logger = new Logger(UploadPartnerLogo.class.getName());
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            {
                boolean b=updatePartnerLogo(partnerid,uploadedFileName);
                if(b)
                {
                    Merchants.refresh();
                }
        ...
        {
           /* System.out.println("error massage"+msg);*/
    ...
    public boolean updatePartnerLogo(String partnerid, String logoname) throws SystemError
    {
        ...
        try
        {
            ...
            String selquery = "update partners set logoName =? where partnerId = ? ";
