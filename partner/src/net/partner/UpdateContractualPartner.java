...
/**
 * Created by Admin on 19/5/2017.
 */
public class UpdateContractualPartner extends HttpServlet
{
    Logger logger = new Logger(UpdateContractualPartner.class.getName());
    ...
    {
        logger.debug("Inside UpdateContractualPartner--");
        ...
        try
        {
            ...
            if(action.equals("update"))
            {
                ...
                //System.out.println("Update in Partner1 partnerId---"+partnerId+"---bankname----"+bankName+"---contractualPartnerId---"+contractualPartnerId+"---contractualPartnerName---"+contractualPartnerName);
    ...
    {
        //System.out.println("Inside updateContractualPartner method");
        Connection con = null;
