...
/**
 * Created by Swamy on 22/07/2015.
 */
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException,ServletException
    {
        ...
        try
        {
          ...
          //  consolidatedApplicationVOMap=applicationManager.getconsolidated_applicationForMemberIdOrPgTypeId(MemberID, Name, consolidatedId);
            consolidatedApplicationVOMap=applicationManager.getconsolidated_applicationForMappedMembers(MemberID, Name, consolidatedId,partnerId);
