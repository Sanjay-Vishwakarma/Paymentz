 ...
 */
public class MerchantPayoutTransactionDetails extends HttpServlet
{
...
//            request.setAttribute("cardtypeid", cardtypeId);
            ...
            hash=null;
            RequestDispatcher view = request.getRequestDispatcher("/merchantPayoutTranactionDetails.jsp?ctoken="+user.getCSRFToken());
