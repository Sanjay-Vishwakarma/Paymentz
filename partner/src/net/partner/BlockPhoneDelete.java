...
public class BlockPhoneDelete extends HttpServlet
{
    private static Logger logger = new Logger(BlockPhoneDelete.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        for (String id : ids)
        {
            try
            {
                boolean flag = blacklistDAO.deleteBlacklistPhone(id);
        ...
        redirectPage = "/blockphone.jsp?ctoken=";
