        ...
        if (functions.isValueNull(partnerId))
        {
          ...
          /*if (!ESAPI.validator().isValidInput("checkoutTimerTime ", req.getParameter("checkoutTimerTime"), "checkoutTimer", 5, false)||req.getParameter("checkoutTimerTime").equals("0:00")||req.getParameter("checkoutTimerTime").equals("00:00")||req.getParameter("checkoutTimerTime").equals("00:0"))
            ...
            try
            {
                ...
                pstmt.setString(160, vpaAddressMonthlyCount);
                pstmt.setString(161, vpaAddressMonthlyAmountLimit);
                pstmt.setString(162, customerEmailMonthlyCount);
                pstmt.setString(163, customerEmailMonthlyAmountLimit);
                pstmt.setString(164, customerPhoneMonthlyCount);
                pstmt.setString(165, customerPhoneMonthlyAmountLimit);
                pstmt.setString(166, bankAccountNoMonthlyCount);
                pstmt.setString(167, bankAccountNoMonthlyAmountLimit);
                pstmt.setString(168, customerIpMonthlyCount);
                pstmt.setString(169, customerIpMonthlyAmountLimit);
                pstmt.setString(170, customerNameMonthlyCount);
                pstmt.setString(171, customerNameMonthlyAmountLimit);
                pstmt.setString(172, merchant_verify_otp);
                pstmt.setString(173, generateview);
                pstmt.setString(174, partnerId);
