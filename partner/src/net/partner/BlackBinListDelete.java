...
/**
 * Created by Suneeta on 11/1/2018.
 */
public class BlackBinListDelete extends HttpServlet
{
    private static Logger logger = new Logger(BlackBinListDelete.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        for (String id : ids)
        {
            ...
            try
            {
                boolean flag = blacklistDAO.deleteBlacklistBin(id);
                if (flag)
                {
            ...
            redirectPage = "/blockBin.jsp?ctoken=";
