 ...
 */
public class MerchantModuleMappingList extends HttpServlet
{
    static Logger logger = new Logger(MerchantModuleMappingList.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("/merchantModuleMappingList.jsp?ctoken="+user.getCSRFToken());

        if (!ESAPI.validator().isValidInput("userid", userId, "SafeString", 100, false))
        {
            req.setAttribute("errormessage", "Please select merchant user");
            rd.forward(req, res);
        }
