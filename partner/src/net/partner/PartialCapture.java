...
import net.partner.PartnerFunctions;
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                notificationUrl     = (String)transactionDetails.get("notificationUrl");
                ...
                if(isValidCaptureRequest && isValidCaptureAmount)
                {
                    ...
                    responseStatus      = captureResponse.getStatus();
            ...
            captureTrans.put("Capture Amount",currency+" "+captureamount.toString());
            ...
            captureMailDetails.put(MailPlaceHolder.MULTIPALTRANSACTION, asynchronousMailService.getDetailTable(captureMailDetails).toString());
        ...
        catch (SystemError se)
        {
            ...
            out.println("<form name=\"frm\" method=\"get\" action=\"PartnerCapture?ctoken=\""+req.getParameter("ctoken")+"\"> <input type=\"button\" value=\"BACK\" onClick=\"document.frm.submit()\"></form>");
        }
        catch (Exception e)
        {
            exceptionocccured = true;
