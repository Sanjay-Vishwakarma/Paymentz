...
public class PartnerMerchantRefundList extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        try
        {
            int totalrecords= partnerManager.getRefundListCountNew(description,accountid,trakingid,memberId,partner_id,records,pageno);
            hash1 = partnerManager.getPartnerMerchantRefundList(description,accountid,trakingid,memberId, partner_id,records,pageno,totalrecords);
        }
        catch (Exception e)
        {
