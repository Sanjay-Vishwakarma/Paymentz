...
/**
 * Created by Kalyani on 28/01/2022.
 */
public class UploadBulkBankAccountNumber extends HttpServlet
{
    private static Logger log= new Logger(UploadBulkBankAccountNumber.class.getName());
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
    {
        ...
        RequestDispatcher rd= request.getRequestDispatcher("/uploadbulbankaccountno.jsp?ctoken="+user.getCSRFToken());
        ...
        try
        {
            ...
            if (action.equalsIgnoreCase("download"))
            {
                ...
                String fileName = "UploadBankAccount.xls";
            ...
            auditTrailVO.setActionExecutorId("183");
            auditTrailVO.setActionExecutorName("Partner" + "-" + session.getAttribute("username").toString());
            ...
            try
            {
               UploadBulkBankAccountNumber bankAccounts= new UploadBulkBankAccountNumber();
    ...
    public StringBuffer processBlockedUploadBankAccount(String completefilepath,String actionExecutorId, String actionExecutorName)throws SystemError
    {
        ...
        for(BlacklistVO vpa: readBlockedBankAccount)
        {
            ...
            try
            {
                System.out.println("try in validator");
                if ( (!ESAPI.validator().isValidInput(vpa.getBlacklistBankAccountNo(), vpa.getBlacklistBankAccountNo(), "Number", 30, false)))
                {
                ...
                else
                {
                    ...
                    if (count!= 1 && (ESAPI.validator().isValidInput(vpa.getBlacklistBankAccountNo(), vpa.getBlacklistBankAccountNo(), "Number", 30, false)) && (ESAPI.validator().isValidInput(vpa.getBlacklistReason(), vpa.getBlacklistReason(), "Description", 100, false)))
                    {
                        smessage= vpa.getBlacklistBankAccountNo() + " is already blocked";
