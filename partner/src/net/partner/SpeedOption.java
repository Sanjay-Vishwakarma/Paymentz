...
public class SpeedOption extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            applicationManagerVO.setSpeed_user(Module.PARTNER.name());
            ...
            if("Save".equals(request.getParameter("action")))
            {
                ...
                applicationManagerVO.setNotificationMessage(isUpdate,"Privet Form"," Saved Successfully");
            ...
            else
            {
                if(validationErrorList.isEmpty())
                {
                    ...
                    applicationManagerVO.setNotificationMessage(isUpdate,"Privet Form"," Submitted Successfully");
                    applicationManagerVO.setMessageColorClass("bg-info");
                }
            }
        ...
        request.setAttribute("selectedID",applicationManagerVO.getMemberId());
        if(!validationErrorList.isEmpty())
        {
