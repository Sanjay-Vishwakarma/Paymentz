...
public class listGatewayAccountDetails extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        if (!ESAPI.validator().isValidInput("name", req.getParameter("name"),"Description", 40, true))
        {
            req.setAttribute("message", "Invalid Bank Name");
            RequestDispatcher rd= req.getRequestDispatcher("/gatewayAccountInterface.jsp?ctoken="+user.getCSRFToken());
            rd.forward(req,res);
            return;
        }
        ...
        try
        {
            ...
            {
                query.append(" and gt.name='" + bankname+ "'");
                countquery.append(" and gt.name='" + bankname+ "'");
