 ...
 */
public class UnblockPartnerAccount extends HttpServlet
{
    Logger logger=new Logger(UnblockPartnerAccount.class.getName());
    ...
    public  void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException
    {
        ...
        try
        {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("PartnerUnblockedAccount?ctoken="+user.getCSRFToken());
