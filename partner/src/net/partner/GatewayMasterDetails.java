 ...
 */
public class GatewayMasterDetails extends HttpServlet
{
    static Logger log = new Logger(GatewayMasterDetails.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        catch (ValidationException e)
        {
            ...
            RequestDispatcher rd = req.getRequestDispatcher("/gatewayMaster.jsp?ctoken="+user.getCSRFToken());
            rd.forward(req, res);
        }
