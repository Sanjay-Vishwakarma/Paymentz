...
public class PopulateApplication extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
    {
        ...
        try
        {
            ...
            request.setAttribute("selectedID",request.getParameter("action").split("_")[0]);
            ...
            else
            {
                ...
                {
                    rdSuccessM = request.getRequestDispatcher("/net/AppManagerStatus?status=" + ApplicationStatus.MODIFIED.name() + "&SPageno=" + Functions.convertStringtoInt(request.getParameter("SPageno"), 1) + "&SRecords=" + Functions.convertStringtoInt(request.getParameter("SRecords"), 15) + "&ctoken=" + user.getCSRFToken()+"&selectedID="+request.getParameter("action").split("_")[0]+"&apptoid="+request.getParameter("action").split("_")[0]);
