 ...
 */
public class ATRequestVO extends FSGenericRequestVO
{
    ...
    String user_number;
    String user_name;
    String player_status;//customer_status
    String reg_date;
   ...
   //For Update Transaction Request
    ...
    public String getInternal_tran_id()
    {
        return internal_trans_id;
    }

    public void setInternal_tran_id(String internal_trans_id)
    {
