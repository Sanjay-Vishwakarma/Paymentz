 ...
 */
@XmlRootElement(name="fraudServiceRequestVO")
@XmlAccessorType(XmlAccessType.FIELD)
public class FraudRequestVO
{
    ...
    @XmlElement(name="customerRegDate")
  ...
  /*  @XmlElement(name="partnerId")
    ...
    @XmlElement(name="customer_registration_id")
    ...
    @XmlElement(name="cust_request_id")
    String cust_request_id;

    @XmlElement(name="customerRegId")
    ...
    @XmlElement(name="payment_method_last_digits")
    String payment_method_last_digits;

    @XmlElement(name="deposit_limits_pay_method_type")
    String deposit_limits_pay_method_type;

    @XmlElement(name="deposit_limits_dl_min")
    String deposit_limits_dl_min;

    @XmlElement(name="deposit_limits_dl_daily")
    String deposit_limits_dl_daily;

    @XmlElement(name="deposit_limits_dl_weekly")
    String deposit_limits_dl_weekly;

    @XmlElement(name="deposit_limits_dl_monthly")
    ...
    @XmlElement(name="payment_method_bin")
    ...
    @XmlElement(name="billingprovince")
    ...
    @XmlElement(name="billingphone1")
    String billingphone1;

    @XmlElement(name="billingphone2")
    ...
    public String getCustomerRegDate() {return customerRegDate;}

    public void setCustomerRegDate(String customerRegDate) {this.customerRegDate = customerRegDate;}
    ...
    public String getId_value() {return id_value;}

    public void setId_value(String id_value) {this.id_value = id_value;}
    ...
    public String getCustomer_registration_id() {return customer_registration_id;}

    public void setCustomer_registration_id(String customer_registration_id) {this.customer_registration_id = customer_registration_id;}
