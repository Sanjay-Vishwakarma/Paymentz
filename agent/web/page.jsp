...
<%--<div class="reporttable" style="width:50%">--%>
    <table id="paginateid" align=right valign=top style="width:auto">
        <tr>
                ...
                <form action="<%=linkpage%>" method=post>
                    <%       //this is for first button
...

                        {
                            ...
                            /*out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/agent/images/first.png\" ></button>");*/
                            out.println("<button type=\"submit\" id=\"firstid\" class=\"gotopage\" name=\"SPageno\" value=\"1\">First</button>");
                        }
                        else
                        {
                            /*out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/agent/images/first1.gif\" ></button>");*/
                            out.println("<button type=\"button\" id=\"firstid\" class=\"gotopage_disabled\" name=\"SPageno\" value=\"1\">First</button>");
                        }
                ...
                <form action="<%=linkpage%>" method=post>
                    <%
...

                        {
                            ...
                            /*out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+prevblockpageno+"><img src=\"/agent/images/previous.png\" ></button>");*/
                            out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+prevblockpageno+">Previous</button>");
                        ...
                        {
                            /*out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value=\"1\"><img src=\"/agent/images/previous1.gif\" ></button>");*/
                            out.println("<button type=\"button\" class=\"gotopage_disabled\" name=\"SPageno\" value=\"1\">Previous</button>");
                        }
                    %>
                </form>
            </td>
                        ...
                        for (int i = 1; i <= noofpagesperblock; i++)
                        {
...

                            {
...

                                {
                                    ...
                                    out.println("<input type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+temppageno+" disabled>");
                ...
                <form action="<%=linkpage%>" method=post>
                    <%
...

                        {
                            ...
                            /*out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/agent/images/next.png\" ></button>");*/
                            out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+">Next</button>");

                        }
                        else
                        {
                            /*out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/agent/images/next1.gif\" ></button>");*/
                            out.println("<button type=\"button\" class=\"gotopage_disabled\" name=\"SPageno\" value="+nextblockpageno+">Next</button>");
                        }
                    %>
                </form>
            </td>
                ...
                <form action="<%=linkpage%>" method=post>
                    <%
...

                        {
                            ...
                            /*out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+totalnofopages+"><img src=\"/agent/images/last.png\" ></button>");*/
                            out.println("<button type=\"submit\" class=\"gotopage\" name=\"SPageno\" value="+totalnofopages+">Last</button>");

                        }
                        else
                        {
                            /*out.println("<button type=\"button\" class=\"gotopage\" name=\"SPageno\" value="+nextblockpageno+"><img src=\"/agent/images/last1.gif\" ></button>");*/
                            out.println("<button type=\"button\" class=\"gotopage_disabled\" name=\"SPageno\" value="+nextblockpageno+">Last</button>");
                        }
                    %>
                </form>
            </td>
        ...
        <tr>
            <td colspan="5" align="center">
                <form action="<%=linkpage%>" method=post>
                    <span class="textb" style="font-family:Open Sans,Helvetica Neue,Helvetica,Arial,sans-serif; font-size: 12px; color: #001962; font-weight: normal;">Page No:</span>&nbsp;
                    <%
                        out.println(input.toString());
                        if(functions.isValueNull(pageorderby))
                        {
