 ...
 */
@XmlRootElement(name="restPaymentRequestVO")
@XmlAccessorType(XmlAccessType.FIELD)
public class RestPaymentRequestVO
{
    ...
    @XmlElement(name="orderDescriptor")
    ...
    VirtualAccountVO virtualAccountVO;
    ...
    @XmlElement(name="partner.userName")
    ...
    @XmlElement(name="redirectMethod")
    String redirectMethod;

    @XmlElement(name="memberId")
    String memberId;

    @XmlElement(name="memberGuid")
    String memberGuid;
    ...
    @XmlElement(name="merchantAccountType")
    ...
    @XmlElement(name="vpa_address")
    String vpa_address;

    @XmlElement(name="purchase_identifier")
    String purchase_identifier;

    @XmlElement(name="cardHolderAccountInfo")
    CardHolderAccountInfoVO CardHolderAccountInfoVO;
    ...
    @XmlElement(name="personalAccountNumber")
    ...
    public VirtualAccountVO getVirtualAccountVO()
    {
        return virtualAccountVO;
    }

    public void setVirtualAccountVO(VirtualAccountVO virtualAccountVO)
    {
        this.virtualAccountVO = virtualAccountVO;
    }
    ...
    public CardHolderAccountInfoVO getCardHolderAccountInfoVO()
    {
        return CardHolderAccountInfoVO;
    }

    public void setCardHolderAccountInfoVO(CardHolderAccountInfoVO cardHolderAccountInfoVO)
    {
        CardHolderAccountInfoVO = cardHolderAccountInfoVO;
    }
    ...
    public void setDeviceDetailsVO(DeviceDetailsVO deviceDetailsVO)
    {
    ...
    public CardVO[] getCard1()
    {
        return card1;
    }

    public void setCard1(CardVO[] card1)
    {
        this.card1 = card1;
    }
