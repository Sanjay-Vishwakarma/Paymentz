...
public class AppFileDetailsVO
{
    ...
    AppFileActionType fileActionType ;
    boolean success;
    ...
    public AppFileActionType getFileActionType()
    {
        return fileActionType;
    }

    public void setFileActionType(AppFileActionType fileActionType)
    {
