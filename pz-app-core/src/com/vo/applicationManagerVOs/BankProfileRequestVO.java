...
public class BankProfileRequestVO
{
    @FormParam("MerchantApplicationForm.BankProfileVO.applicationid")
    String application_id;

    @FormParam("MerchantApplicationForm.BankProfileVO.currencyrequested_productssold")
    String currencyrequested_productssold;

    @FormParam("MerchantApplicationForm.BankProfileVO.currencyrequested_bankaccount")
    String currencyrequested_bankaccount;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_bic")
    String bankinfo_bic  ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_bank_name")
    String bankinfo_bank_name ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_bankaddress")
    String bankinfo_bankaddress;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_bankTelCC")
    String  bankinfo_bankTelCC;
    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_bankphonenumber")
    String  bankinfo_bankphonenumber        ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_aba_routingcode")
    String  bankinfo_aba_routingcode          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_accountholder")
    String  bankinfo_accountholder             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_IBAN")
    String  bankinfo_IBAN;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_accountnumber")
    String  bankinfo_accountnumber               ;

    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_currency")
    String  bankinfo_currency               ;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_INR")
    String currency_products_INR;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_USD")
    String currency_products_USD;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_EUR")
    String currency_products_EUR;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_GBP")
    String currency_products_GBP;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_JPY")
    String currency_products_JPY;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_PEN")
    String currency_products_PEN;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_INR")
    String currency_payments_INR;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_USD")
    String currency_payments_USD;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_EUR")
    String currency_payments_EUR;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_GBP")
    String currency_payments_GBP;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_JPY")
    String currency_payments_JPY;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_PEN")
    String currency_payments_PEN;

    @FormParam("MerchantApplicationForm.BankProfileVO.bank_account_currencies")
    String bank_account_currencies;

    @FormParam("MerchantApplicationForm.BankProfileVO.product_sold_currencies")
    String product_sold_currencies;

    //ADD new
    @FormParam("MerchantApplicationForm.BankProfileVO.aquirer")
    String aquirer;
    @FormParam("MerchantApplicationForm.BankProfileVO.reasonaquirer")
    String reasonaquirer;

    @FormParam("MerchantApplicationForm.BankProfileVO.customer_trans_data")
    String customer_trans_data;


    //Add new
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_HKD")
    String currency_products_HKD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_AUD")
    String currency_products_AUD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_CAD")
    String currency_products_CAD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_DKK")
    String currency_products_DKK;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_SEK")
    String currency_products_SEK;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_products_NOK")
    String currency_products_NOK;

    //Add new
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_HKD")
    String currency_payments_HKD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_AUD")
    String currency_payments_AUD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_CAD")
    String currency_payments_CAD;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_DKK")
    String currency_payments_DKK;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_SEK")
    String currency_payments_SEK;
    @FormParam("MerchantApplicationForm.BankProfileVO.currency_payments_NOK")
    String currency_payments_NOK;
    @FormParam("MerchantApplicationForm.BankProfileVO.bankinfo_contactperson")
    String bankinfo_contactperson;


    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_lastmonth")
    String  salesvolume_lastmonth               ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_2monthsago")
    String  salesvolume_2monthsago               ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_3monthsago")
    String  salesvolume_3monthsago                ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_4monthsago")
    String  salesvolume_4monthsago                 ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_5monthsago")
    String  salesvolume_5monthsago                  ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_6monthsago")
    String  salesvolume_6monthsago                   ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_12monthsago")
    String  salesvolume_12monthsago                   ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_year2")
    String  salesvolume_year2                   ;

    @FormParam("MerchantApplicationForm.BankProfileVO.salesvolume_year3")
    String  salesvolume_year3                   ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_lastmonth")
    String  numberoftransactions_lastmonth            ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_2monthsago")
    String  numberoftransactions_2monthsago            ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_3monthsago")
    String  numberoftransactions_3monthsago             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_4monthsago")
    String  numberoftransactions_4monthsago              ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_5monthsago")
    String  numberoftransactions_5monthsago               ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_6monthsago")
    String  numberoftransactions_6monthsago                ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_12monthsago")
    String  numberoftransactions_12monthsago                ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_year2")
    String  numberoftransactions_year2                ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberoftransactions_year3")
    String  numberoftransactions_year3                ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_lastmonth")
    String  chargebackvolume_lastmonth                      ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_2monthsago")
    String  chargebackvolume_2monthsago                      ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_3monthsago")
    String  chargebackvolume_3monthsago                       ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_4monthsago")
    String  chargebackvolume_4monthsago                        ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_5monthsago")
    String  chargebackvolume_5monthsago                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_6monthsago")
    String  chargebackvolume_6monthsago                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_12monthsago")
    String  chargebackvolume_12monthsago                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_year2")
    String  chargebackvolume_year2                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackvolume_year3")
    String  chargebackvolume_year3                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_lastmonth")
    String  numberofchargebacks_lastmonth                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_2monthsago")
    String  numberofchargebacks_2monthsago                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_3monthsago")
    String  numberofchargebacks_3monthsago                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_4monthsago")
    String  numberofchargebacks_4monthsago                           ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_5monthsago")
    String  numberofchargebacks_5monthsago                            ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_6monthsago")
    String  numberofchargebacks_6monthsago                             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_12monthsago")
    String  numberofchargebacks_12monthsago                             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_year2")
    String  numberofchargebacks_year2                             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofchargebacks_year3")
    String  numberofchargebacks_year3                             ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_lastmonth")
    String  refundsvolume_lastmonth                                     ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_2monthsago")
    String  refundsvolume_2monthsago                                     ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_3monthsago")
    String  refundsvolume_3monthsago                                      ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_4monthsago")
    String  refundsvolume_4monthsago                                       ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_5monthsago")
    String  refundsvolume_5monthsago                                        ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_6monthsago")
    String  refundsvolume_6monthsago                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_12monthsago")
    String  refundsvolume_12monthsago                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_year2")
    String  refundsvolume_year2                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundsvolume_year3")
    String  refundsvolume_year3                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_lastmonth")
    String  numberofrefunds_lastmonth                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_2monthsago")
    String  numberofrefunds_2monthsago                                         ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_3monthsago")
    String  numberofrefunds_3monthsago                                          ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_4monthsago")
    String  numberofrefunds_4monthsago                                           ;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_5monthsago")
    String  numberofrefunds_5monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_6monthsago")
    String  numberofrefunds_6monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_12monthsago")
    String  numberofrefunds_12monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_year2")
    String  numberofrefunds_year2;

    @FormParam("MerchantApplicationForm.BankProfileVO.numberofrefunds_year3")
    String  numberofrefunds_year3;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_lastmonth")
    String  chargebackratio_lastmonth;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_2monthsago")
    String  chargebackratio_2monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_3monthsago")
    String  chargebackratio_3monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_4monthsago")
    String  chargebackratio_4monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_5monthsago")
    String  chargebackratio_5monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_6monthsago")
    String  chargebackratio_6monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_12monthsago")
    String  chargebackratio_12monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_year2")
    String  chargebackratio_year2;

    @FormParam("MerchantApplicationForm.BankProfileVO.chargebackratio_year3")
    String  chargebackratio_year3;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_lastmonth")
    String  refundratio_lastmonth;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_2monthsago")
    String  refundratio_2monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_3monthsago")
    String  refundratio_3monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_4monthsago")
    String  refundratio_4monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_5monthsago")
    String  refundratio_5monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_6monthsago")
    String  refundratio_6monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_12monthsago")
    String  refundratio_12monthsago;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_year2")
    String  refundratio_year2;

    @FormParam("MerchantApplicationForm.BankProfileVO.refundratio_year3")
    String  refundratio_year3;

    @FormParam("MerchantApplicationForm.BankProfileVO.iscurrencywisebankinfo")
    String  iscurrencywisebankinfo;


    @FormParam("MerchantApplicationForm.BankProfileVO.bankProfileSaved")
    String bankProfileSaved;
    @FormParam("MerchantApplicationForm.BankProfileVO.isProcessingHistory")
    String isProcessingHistory;

    @FormParam("MerchantApplicationForm.BankProfileVO.currency")
    String currency;

    @FormParam("MerchantApplicationForm.BankProfileVO.currencywisebankinfo_id")
    String currencywisebankinfo_id;

    @FormParam("MerchantApplicationForm.BankProfileVO.processinghistory_id")
    String processinghistory_id;

    @FormParam("MerchantApplicationForm.BankProfileVO.processinghistory_creation_time")
    String processinghistory_creation_time;

    @FormParam("MerchantApplicationForm.BankProfileVO.processinghistory_updation_time")
