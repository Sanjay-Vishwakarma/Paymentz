...
var EmptyEmail, InvalidEmail, EmptyAddress, EmptyCity, EmptyCountry, EmptyState, EmptyZip, EmptyBirhtdate;
var InvalidAddress, InvalidCity, InvalidCountry, InvalidState, InvalidZip;
var InvalidVisa, InvalidMaster, InvalidDiner, InvalidAMEX, InvalidDISC, InvalidJCB, InvalidMAESTRO, InvalidINSTAPAYMENT, InvalidCard;
var VisaNotPermitted, MasterNotPermitted, DinerNotPermitted, AmexNotPermitted, DiscNotPermitted, JcbNotPermitted, MaestroNotPermitted, InstapaymentNotPermitted;
...
{
    let currentTab;
    if (document.getElementById("payMethod").innerText.includes(" > "))
    {
...
function showTab(n) {
    ...
    if (n == (x.length - 1)) {
        document.getElementById("nextBtn").innerHTML = "Save Card";
    } else {
...
function validateForm() {
    ...
    for (i = 0; i < y.length; i++) {
        ...
        if (y[i].id.indexOf("city") > -1 && y[i].value !="")
        {
            if (validateCity(document.getElementById(y[i].id).value, document.getElementById(y[i].id).parentElement.id))
            {
                console.log("in if city")
                valid = true;
            }
            else
            {
        ...
        if (y[i].id.indexOf("zip") > -1 && y[i].value !="")
        {
            if (validateZip(document.getElementById(y[i].id).value, document.getElementById(y[i].id).parentElement.id))
            {
                console.log("in if zip")
                valid = true;
            }
            else
            {
                console.log("in else zip");
                y[i].className += " invalid";
                return valid = false;
            }
        }
        if (y[i].id.indexOf("country_input") > -1 && y[i].value !="")
        {
            if (validateCountry(document.getElementById(y[i].id).value, document.getElementById(y[i].id).parentElement.id))
            {
                console.log("in if country_input")
                valid = true;
            }
            else
            {
                console.log("in else country_input");
                y[i].className += " invalid";
                return valid = false;
            }
        }
        if (y[i].id.indexOf("state") > -1 && y[i].value !="")
        {
            if (validateState(document.getElementById(y[i].id).value, document.getElementById(y[i].id).closest('.form-group').id))
            {
        ...
        if (y[i].id.includes("phonecc-id") && y[i].value !="")
        {
...
function addSlash(event, id)
{
    ...
    if (val.length >= 2 && val.length < 4)
    {
        if (val.slice(0, 2) > 12)
        {
            console.log("0" + val.slice(0, 1) + "/" + val.slice(1, 4));
...
function clearSettleBirthDate(id, divID)
{
    ...
    console.log("full year = ", year, "year = ", y, " month = ", m, " day = ", d);
    if (val.length == 8)
    {
        if (y <= 1900 || y > year)
        {
        ...
        {
            console.log("in else if month");
            valid = false;
            error = InvalidMonth;
        }
        else if (d < 1 || d > 31)
        {
            console.log("in else if day");
            valid = false;
            error = InvalidDay;
        }
        else
    ...
    {
        console.log("in else invalid date");
        valid = false;
        error = InvalidDate;
    }
...
function expiryCheck(exp, divID)
{
    ...
    if (length >= 4)
    {
        ...
        {
            valid = true;
            // if(!(val.includes("/"))){ console.log("value - " , val , val.slice(0, 2) + "/" + val.slice(2,4))
...
function validateZip(inputText, divID)
{
    ...
    else if (regex.test(inputText) || inputText.length < 4)
    {
        error = InvalidZip;
        valid = false;
    }
...
{
    var ccNum = document.getElementById(cardno).value.replace(/\s/g, "");
    ...
    if (ccNum.startsWith("4"))
    {
        ...
        else
        {
            valid = true;
            type = "VISA";
           /* if (availableCardType.includes("VISA") || availableDebitCardType.includes("VISA"))
            {
    ...
    else if ((ccNum.startsWith("51") || ccNum.startsWith("52") || ccNum.startsWith("53") || ccNum.startsWith("54") || ccNum.startsWith("55") || ccNum.startsWith("22") ||
            ccNum.startsWith("23") || ccNum.startsWith("24") || ccNum.startsWith("25") || ccNum.startsWith("26") || ccNum.startsWith("27")))
    {
        if (length != 16)
        {
            error = InvalidMaster;
        ...
        else
        {
            valid = true;
            type = "MC";
           /* if (availableCardType.includes("MC") || availableDebitCardType.includes("MC"))
            {
            ...
            || ccNum.startsWith("305") || ccNum.startsWith("36") || ccNum.startsWith("54") || ccNum.startsWith("55")))
    {
        ...
        else
        {
            valid = true;
            type = "DINER";
           /* if (availableCardType.includes("DINER") || availableDebitCardType.includes("DINER"))
            {
    ...
    else if ((ccNum.startsWith("34") || ccNum.startsWith("37")))
    {
        ...
        else
        {
            valid = true;
            type = "AMEX";
           /* if (availableCardType.includes("AMEX") || availableDebitCardType.includes("AMEX"))
            {
    ...
    else if ((ccNum.startsWith("6011") || ccNum.startsWith("622") || ccNum.startsWith("644") || ccNum.startsWith(" 645") || ccNum.startsWith("646") || ccNum.startsWith("647") || ccNum.startsWith("648") || ccNum.startsWith("649") || ccNum.startsWith("65")))
    {
        ...
        else
        {
            valid = true;
            type = "DISC";
           /* if (availableCardType.includes("DISC") || availableDebitCardType.includes("DISC"))
            {
    ...
    else if ((ccNum.startsWith("35")))
    {
        ...
        else
        {
            valid = true;
            type = "JCB";
            /*if (availableCardType.includes("JCB") || availableDebitCardType.includes("JCB"))
            {
    ...
    else if ((ccNum.startsWith("5018") || ccNum.startsWith("5020") || ccNum.startsWith("5038") || ccNum.startsWith("5893") || ccNum.startsWith("6304") || ccNum.startsWith("6759") || ccNum.startsWith("6761") || ccNum.startsWith("6762") || ccNum.startsWith("6763") || ccNum.startsWith("6709") || ccNum.startsWith("6799")))
    {
        if (length != 16 && length != 19)
        {
        ...
        else
        {
            valid = true;
            type = "MAESTRO";
            /*if (availableCardType.includes("MAESTRO") || availableDebitCardType.includes("MAESTRO"))
            {
    ...
    else if ((ccNum.startsWith("637") || ccNum.startsWith("638") || ccNum.startsWith("639")))
    {
        if (length != 16)
        {
        ...
        else
        {
            valid = true;
            type = "INSTAPAYMENT";
            /*if (availableCardType.includes("INSTAPAYMENT") || availableDebitCardType.includes("INSTAPAYMENT"))
            {
    ...
    if (valid == true)
    {
        ...
        if (pay_methods == 'CreditCards')
        {
            ...
            {
                let val = $("#CreditCards").find("#" + type)[0].value;
                document.getElementById('paymentBrand').value = type;
        ...
        {
            payMode = "DC";
            if ($("#DebitCards").find("#" + type)[0])
            {
                let val = $("#DebitCards").find("#" + type)[0].value;
...
function setCountry(val, countryID)
{
    ...
    if (country_code == "AF" || country_code == "AFG") {document.getElementById(countryID).value = "Afghanistan"};
    if (country_code == "AX" || country_code == "ALA") {document.getElementById(countryID).value = "Åland Islands"};
    if (country_code == "AL" || country_code == "ALB") {document.getElementById(countryID).value = "Albania"};
    if (country_code == "DZ" || country_code == "DZA") {document.getElementById(countryID).value = "Algeria"};
    if (country_code == "AS" || country_code == "ASM") {document.getElementById(countryID).value = "American Samoa"};
    if (country_code == "AD" || country_code == "AND") {document.getElementById(countryID).value = "Andorra"};
    if (country_code == "AO" || country_code == "AGO") {document.getElementById(countryID).value = "Angola"};
    if (country_code == "AI" || country_code == "AIA") {document.getElementById(countryID).value = "Anguilla"};
    if (country_code == "AQ" || country_code == "ATA") {document.getElementById(countryID).value = "Antarctica"};
    if (country_code == "AG" || country_code == "ATG") {document.getElementById(countryID).value = "Antigua and Barbuda"};
    if (country_code == "AR" || country_code == "ARG") {document.getElementById(countryID).value = "Argentina"};
    if (country_code == "AM" || country_code == "ARM") {document.getElementById(countryID).value = "Armenia"};
    if (country_code == "AW" || country_code == "ABW") {document.getElementById(countryID).value = "Aruba"};
    if (country_code == "AU" || country_code == "AUS") {document.getElementById(countryID).value = "Australia"};
    if (country_code == "AT" || country_code == "AUT") {document.getElementById(countryID).value = "Austria"};
    if (country_code == "AZ" || country_code == "AZE") {document.getElementById(countryID).value = "Azerbaijan"};
    if (country_code == "BS" || country_code == "BHS") {document.getElementById(countryID).value = "Bahamas"};
    if (country_code == "BH" || country_code == "BHR") {document.getElementById(countryID).value = "Bahrain"};
    if (country_code == "BD" || country_code == "BGD") {document.getElementById(countryID).value = "Bangladesh"};
    if (country_code == "BB" || country_code == "BRB") {document.getElementById(countryID).value = "Barbados"};
    if (country_code == "BY" || country_code == "BLR") {document.getElementById(countryID).value = "Belarus"};
    if (country_code == "BE" || country_code == "BEL") {document.getElementById(countryID).value = "Belgium"};
    if (country_code == "BZ" || country_code == "BLZ") {document.getElementById(countryID).value = "Belize"};
    if (country_code == "BJ" || country_code == "BEN") {document.getElementById(countryID).value = "Benin"};
    if (country_code == "BM" || country_code == "BMU") {document.getElementById(countryID).value = "Bermuda"};
    if (country_code == "BT" || country_code == "BTN") {document.getElementById(countryID).value = "Bhutan"};
    if (country_code == "BO" || country_code == "BOL") {document.getElementById(countryID).value = "Bolivia"};
    if (country_code == "BQ" || country_code == "BES") {document.getElementById(countryID).value = "Bonaire"};
    if (country_code == "BA" || country_code == "BIH") {document.getElementById(countryID).value = "Bosnia and Herzegovina"};
    if (country_code == "BW" || country_code == "BWA") {document.getElementById(countryID).value = "Botswana"};
    if (country_code == "BR" || country_code == "BRA") {document.getElementById(countryID).value = "Brazil"};
    if (country_code == "IO" || country_code == "IOT") {document.getElementById(countryID).value = "British Indian Ocean Territory"};
    if (country_code == "BN" || country_code == "BRN") {document.getElementById(countryID).value = "Brunei Darussalam"};
    if (country_code == "BG" || country_code == "BGR") {document.getElementById(countryID).value = "Bulgaria"};
    if (country_code == "BF" || country_code == "BFA") {document.getElementById(countryID).value = "Burkina Faso"};
    if (country_code == "BI" || country_code == "BDI") {document.getElementById(countryID).value = "Burundi"};
    if (country_code == "KH" || country_code == "KHM") {document.getElementById(countryID).value = "Cambodia"};
    if (country_code == "CM" || country_code == "CMR") {document.getElementById(countryID).value = "Cameroon"};
    if (country_code == "CA" || country_code == "CAN") {document.getElementById(countryID).value = "Canada"};
    if (country_code == "CV" || country_code == "CPV") {document.getElementById(countryID).value = "Cape Verde"};
    if (country_code == "KY" || country_code == "CYM") {document.getElementById(countryID).value = "Cayman Islands"};
    if (country_code == "CF" || country_code == "CAF") {document.getElementById(countryID).value = "Central African Republic"};
    if (country_code == "TD" || country_code == "TCD") {document.getElementById(countryID).value = "Chad"};
    if (country_code == "CL" || country_code == "CHL") {document.getElementById(countryID).value = "Chile"};
    if (country_code == "CN" || country_code == "CHN") {document.getElementById(countryID).value = "China"};
    if (country_code == "CX" || country_code == "CXR") {document.getElementById(countryID).value = "Christmas Island"};
    if (country_code == "CC" || country_code == "CCK") {document.getElementById(countryID).value = "Cocos (Keeling) Islands"};
    if (country_code == "CO" || country_code == "COL") {document.getElementById(countryID).value = "Colombia"};
    if (country_code == "KM" || country_code == "COM") {document.getElementById(countryID).value = "Comoros"};
    if (country_code == "CG" || country_code == "COD") {document.getElementById(countryID).value = "Congo"};
    if (country_code == "CD" || country_code == "COD") {document.getElementById(countryID).value = "Congo"};
    if (country_code == "CK" || country_code == "COK") {document.getElementById(countryID).value = "Cook Islands"};
    if (country_code == "CR" || country_code == "CRI") {document.getElementById(countryID).value = "Costa Rica"};
    if (country_code == "CI" || country_code == "CIV") {document.getElementById(countryID).value = "Côte d'Ivoire"};
    if (country_code == "HR" || country_code == "HRV") {document.getElementById(countryID).value = "Croatia"};
    if (country_code == "CU" || country_code == "CUB") {document.getElementById(countryID).value = "Cuba"};
    if (country_code == "CW" || country_code == "CUW") {document.getElementById(countryID).value = "Curaçao"};
    if (country_code == "CY" || country_code == "CYP") {document.getElementById(countryID).value = "Cyprus"};
    if (country_code == "CZ" || country_code == "CZE") {document.getElementById(countryID).value = "Czech Republic"};
    if (country_code == "DK" || country_code == "DNK") {document.getElementById(countryID).value = "Denmark"};
    if (country_code == "DJ" || country_code == "DJI") {document.getElementById(countryID).value = "Djibouti"};
    if (country_code == "DM" || country_code == "DMA") {document.getElementById(countryID).value = "Dominica"};
    if (country_code == "DO" || country_code == "DOM") {document.getElementById(countryID).value = "Dominican Republic"};
    if (country_code == "EC" || country_code == "ECU") {document.getElementById(countryID).value = "Ecuador"};
    if (country_code == "EG" || country_code == "EGY") {document.getElementById(countryID).value = "Egypt"};
    if (country_code == "SV" || country_code == "SLV") {document.getElementById(countryID).value = "El Salvador"};
    if (country_code == "GQ" || country_code == "GNQ") {document.getElementById(countryID).value = "Equatorial Guinea"};
    if (country_code == "ER" || country_code == "ERI") {document.getElementById(countryID).value = "Eritrea"};
    if (country_code == "EE" || country_code == "EST") {document.getElementById(countryID).value = "Estonia"};
    if (country_code == "ET" || country_code == "ETH") {document.getElementById(countryID).value = "Ethiopia"};
    if (country_code == "FK" || country_code == "FLK") {document.getElementById(countryID).value = "Falkland Islands"};
    if (country_code == "FO" || country_code == "FRO") {document.getElementById(countryID).value = "Faroe Islands"};
    if (country_code == "FJ" || country_code == "FJI") {document.getElementById(countryID).value = "Fiji"};
    if (country_code == "FI" || country_code == "FIN") {document.getElementById(countryID).value = "Finland"};
    if (country_code == "FR" || country_code == "FRA") {document.getElementById(countryID).value = "France"};
    if (country_code == "GF" || country_code == "GUF") {document.getElementById(countryID).value = "French Guiana"};
    if (country_code == "PF" || country_code == "PYF") {document.getElementById(countryID).value = "French Polynesia"};
    if (country_code == "TF" || country_code == "ATF") {document.getElementById(countryID).value = "French Southern Territories"};
    if (country_code == "GA" || country_code == "GAB") {document.getElementById(countryID).value = "Gabon"};
    if (country_code == "GM" || country_code == "GMB") {document.getElementById(countryID).value = "Gambia"};
    if (country_code == "GE" || country_code == "GEO") {document.getElementById(countryID).value = "Georgia"};
    if (country_code == "DE" || country_code == "DEU") {document.getElementById(countryID).value = "Germany"};
    if (country_code == "GH" || country_code == "GHA") {document.getElementById(countryID).value = "Ghana"};
    if (country_code == "GI" || country_code == "GIB") {document.getElementById(countryID).value = "Gibraltar"};
    if (country_code == "GR" || country_code == "GRC") {document.getElementById(countryID).value = "Greece"};
    if (country_code == "GL" || country_code == "GRL") {document.getElementById(countryID).value = "Greenland"};
    if (country_code == "GD" || country_code == "GRD") {document.getElementById(countryID).value = "Grenada"};
    if (country_code == "GP" || country_code == "GLP") {document.getElementById(countryID).value = "Guadeloupe"};
    if (country_code == "GU" || country_code == "GUM") {document.getElementById(countryID).value = "Guam"};
    if (country_code == "GT" || country_code == "GTM") {document.getElementById(countryID).value = "Guatemala"};
    if (country_code == "GG" || country_code == "GGY") {document.getElementById(countryID).value = "Guernsey"};
    if (country_code == "GN" || country_code == "GIN") {document.getElementById(countryID).value = "Guinea"};
    if (country_code == "GW" || country_code == "GNB") {document.getElementById(countryID).value = "Guinea-Bissau"};
    if (country_code == "GY" || country_code == "GUY") {document.getElementById(countryID).value = "Guyana"};
    if (country_code == "HT" || country_code == "HTI") {document.getElementById(countryID).value = "Haiti"};
    if (country_code == "HM" || country_code == "HMD") {document.getElementById(countryID).value = "Heard Island & McDonald Islands"};
    if (country_code == "VA" || country_code == "VAT") {document.getElementById(countryID).value = "Vatican City"};
    if (country_code == "HN" || country_code == "HND") {document.getElementById(countryID).value = "Honduras"};
    if (country_code == "HK" || country_code == "HKG") {document.getElementById(countryID).value = "Hong Kong"};
    if (country_code == "HU" || country_code == "HUN") {document.getElementById(countryID).value = "Hungary"};
    if (country_code == "IS" || country_code == "ISL") {document.getElementById(countryID).value = "Iceland"};
    if (country_code == "IN" || country_code == "IND") {document.getElementById(countryID).value = "India"};
    if (country_code == "ID" || country_code == "IDN") {document.getElementById(countryID).value = "Indonesia"};
    if (country_code == "XZ") {document.getElementById(countryID).value = "Installations in International Waters"};
    if (country_code == "IR" || country_code == "IRN") {document.getElementById(countryID).value = "Iran"};
    if (country_code == "IQ" || country_code == "IRQ") {document.getElementById(countryID).value = "Iraq"};
    if (country_code == "IE" || country_code == "IRL") {document.getElementById(countryID).value = "Ireland"};
    if (country_code == "IM" || country_code == "IMN") {document.getElementById(countryID).value = "Isle of Man"};
    if (country_code == "IL" || country_code == "ISR") {document.getElementById(countryID).value = "Israel"};
    if (country_code == "IT" || country_code == "ITA") {document.getElementById(countryID).value = "Italy"};
    if (country_code == "JM" || country_code == "JAM") {document.getElementById(countryID).value = "Jamaica"};
    if (country_code == "JP" || country_code == "JPN") {document.getElementById(countryID).value = "Japan"};
    if (country_code == "JE" || country_code == "JEY") {document.getElementById(countryID).value = "Jersey"};
    if (country_code == "JO" || country_code == "JOR") {document.getElementById(countryID).value = "Jordan"};
    if (country_code == "KZ" || country_code == "KAZ") {document.getElementById(countryID).value = "Kazakhstan"};
    if (country_code == "KE" || country_code == "KEN") {document.getElementById(countryID).value = "Kenya"};
    if (country_code == "KI" || country_code == "KIR") {document.getElementById(countryID).value = "Kiribati"};
    if (country_code == "KP" || country_code == "PRK") {document.getElementById(countryID).value = "Korea"};
    if (country_code == "KR" || country_code == "KOR") {document.getElementById(countryID).value = "Korea"};
    if (country_code == "KW" || country_code == "KWT") {document.getElementById(countryID).value = "Kuwait"};
    if (country_code == "KG" || country_code == "KGZ") {document.getElementById(countryID).value = "Kyrgyzstan"};
    if (country_code == "LA" || country_code == "LAO") {document.getElementById(countryID).value = "Lao People's Democratic Republic"};
    if (country_code == "LV" || country_code == "LVA") {document.getElementById(countryID).value = "Latvia"};
    if (country_code == "LB" || country_code == "LBN") {document.getElementById(countryID).value = "Lebanon"};
    if (country_code == "LS" || country_code == "LSO") {document.getElementById(countryID).value = "Lesotho"};
    if (country_code == "LR" || country_code == "LBR") {document.getElementById(countryID).value = "Liberia"};
    if (country_code == "LY" || country_code == "LBY") {document.getElementById(countryID).value = "Libya"};
    if (country_code == "LI" || country_code == "LIE") {document.getElementById(countryID).value = "Liechtenstein"};
    if (country_code == "LT" || country_code == "LTU") {document.getElementById(countryID).value = "Lithuania"};
    if (country_code == "LU" || country_code == "LUX") {document.getElementById(countryID).value = "Luxembourg"};
    if (country_code == "MO" || country_code == "MAC") {document.getElementById(countryID).value = "Macao"};
    if (country_code == "MK" || country_code == "MKD") {document.getElementById(countryID).value = "Macedonia"};
    if (country_code == "MG" || country_code == "MDG") {document.getElementById(countryID).value = "Madagascar"};
    if (country_code == "MW" || country_code == "MWI") {document.getElementById(countryID).value = "Malawi"};
    if (country_code == "MY" || country_code == "MYS") {document.getElementById(countryID).value = "Malaysia"};
    if (country_code == "MV" || country_code == "MDV") {document.getElementById(countryID).value = "Maldives"};
    if (country_code == "ML" || country_code == "MLI") {document.getElementById(countryID).value = "Mali"};
    if (country_code == "MT" || country_code == "MLT") {document.getElementById(countryID).value = "Malta"};
    if (country_code == "MH" || country_code == "MHL") {document.getElementById(countryID).value = "Marshall Islands"};
    if (country_code == "MQ" || country_code == "MTQ") {document.getElementById(countryID).value = "Martinique"};
    if (country_code == "MR" || country_code == "MRT") {document.getElementById(countryID).value = "Mauritania"};
    if (country_code == "MU" || country_code == "MUS") {document.getElementById(countryID).value = "Mauritius"};
    if (country_code == "YT" || country_code == "MYT") {document.getElementById(countryID).value = "Mayotte"};
    if (country_code == "MX" || country_code == "MEX") {document.getElementById(countryID).value = "Mexico"};
    if (country_code == "FM" || country_code == "FSM") {document.getElementById(countryID).value = "Micronesia"};
    if (country_code == "MD" || country_code == "MDA") {document.getElementById(countryID).value = "Moldova"};
    if (country_code == "MC" || country_code == "MCO") {document.getElementById(countryID).value = "Monaco"};
    if (country_code == "MN" || country_code == "MNG") {document.getElementById(countryID).value = "Mongolia"};
    if (country_code == "ME" || country_code == "MNE") {document.getElementById(countryID).value = "Montenegro"};
    if (country_code == "MS" || country_code == "MSR") {document.getElementById(countryID).value = "Montserrat"};
    if (country_code == "MA" || country_code == "MAR") {document.getElementById(countryID).value = "Morocco"};
    if (country_code == "MZ" || country_code == "MOZ") {document.getElementById(countryID).value = "Mozambique"};
    if (country_code == "MM" || country_code == "MMR") {document.getElementById(countryID).value = "Myanmar"};
    if (country_code == "NA" || country_code == "NAM") {document.getElementById(countryID).value = "Namibia"};
    if (country_code == "NR" || country_code == "NRU") {document.getElementById(countryID).value = "Nauru"};
    if (country_code == "NP" || country_code == "NPL") {document.getElementById(countryID).value = "Nepal"};
    if (country_code == "NL" || country_code == "NLD") {document.getElementById(countryID).value = "Netherlands"};
    if (country_code == "NC" || country_code == "NCL") {document.getElementById(countryID).value = "New Caledonia"};
    if (country_code == "NZ" || country_code == "NZL") {document.getElementById(countryID).value = "New Zealand"};
    if (country_code == "NI" || country_code == "NIC") {document.getElementById(countryID).value = "Nicaragua"};
    if (country_code == "NE" || country_code == "NER") {document.getElementById(countryID).value = "Niger"};
    if (country_code == "NG" || country_code == "NGA") {document.getElementById(countryID).value = "Nigeria"};
    if (country_code == "NU" || country_code == "NIU") {document.getElementById(countryID).value = "Niue"};
    if (country_code == "NF" || country_code == "NFK") {document.getElementById(countryID).value = "Norfolk Island"};
    if (country_code == "MP" || country_code == "MNP") {document.getElementById(countryID).value = "Northern Mariana Islands"};
    if (country_code == "NO" || country_code == "NOR") {document.getElementById(countryID).value = "Norway"};
    if (country_code == "OM" || country_code == "OMN") {document.getElementById(countryID).value = "Oman"};
    if (country_code == "PK" || country_code == "PAK") {document.getElementById(countryID).value = "Pakistan"};
    if (country_code == "PW" || country_code == "PLW") {document.getElementById(countryID).value = "Palau"};
    if (country_code == "PS" || country_code == "PSE") {document.getElementById(countryID).value = "Palestine"};
    if (country_code == "PA" || country_code == "PAN") {document.getElementById(countryID).value = "Panama"};
    if (country_code == "PG" || country_code == "PNG") {document.getElementById(countryID).value = "Papua New Guinea"};
    if (country_code == "PY" || country_code == "PRY") {document.getElementById(countryID).value = "Paraguay"};
    if (country_code == "PE" || country_code == "PER") {document.getElementById(countryID).value = "Peru"};
    if (country_code == "PH" || country_code == "PHL") {document.getElementById(countryID).value = "Philippines"};
    if (country_code == "PN" || country_code == "PCN") {document.getElementById(countryID).value = "Pitcairn"};
    if (country_code == "PL" || country_code == "POL") {document.getElementById(countryID).value = "Poland"};
    if (country_code == "PT" || country_code == "PRT") {document.getElementById(countryID).value = "Portugal"};
    if (country_code == "PR" || country_code == "PRI") {document.getElementById(countryID).value = "Puerto Rico"};
    if (country_code == "QA" || country_code == "QAT") {document.getElementById(countryID).value = "Qatar"};
    if (country_code == "RE" || country_code == "REU") {document.getElementById(countryID).value = "Reunion"};
    if (country_code == "RO" || country_code == "ROU") {document.getElementById(countryID).value = "Romania"};
    if (country_code == "RU" || country_code == "RUS") {document.getElementById(countryID).value = "Russia"};
    if (country_code == "RW" || country_code == "RWA") {document.getElementById(countryID).value = "Rwanda"};
    if (country_code == "BL" || country_code == "BLM") {document.getElementById(countryID).value = "Saint Barthélemy"};
    if (country_code == "SH" || country_code == "SHN") {document.getElementById(countryID).value = "Saint Helena"};
    if (country_code == "KN" || country_code == "KNA") {document.getElementById(countryID).value = "Saint Kitts and Nevis"};
    if (country_code == "LC" || country_code == "LCA") {document.getElementById(countryID).value = "Saint Lucia"};
    if (country_code == "MF" || country_code == "MAF") {document.getElementById(countryID).value = "Saint Martin"};
    if (country_code == "PM" || country_code == "SPM") {document.getElementById(countryID).value = "Saint Pierre and Miquelon"};
    if (country_code == "VC" || country_code == "VCT") {document.getElementById(countryID).value = "Saint Vincent and the Grenadines"};
    if (country_code == "WS" || country_code == "WSM") {document.getElementById(countryID).value = "Samoa"};
    if (country_code == "SM" || country_code == "SMR") {document.getElementById(countryID).value = "San Marino"};
    if (country_code == "ST" || country_code == "STP") {document.getElementById(countryID).value = "Sao Tome and Principe"};
    if (country_code == "SA" || country_code == "SAU") {document.getElementById(countryID).value = "Saudi Arabia"};
    if (country_code == "SN" || country_code == "SEN") {document.getElementById(countryID).value = "Senegal"};
    if (country_code == "RS" || country_code == "SRB") {document.getElementById(countryID).value = "Serbia"};
    if (country_code == "SC" || country_code == "SYC") {document.getElementById(countryID).value = "Seychelles"};
    if (country_code == "SL" || country_code == "SLE") {document.getElementById(countryID).value = "Sierra Leone"};
    if (country_code == "SG" || country_code == "SGP") {document.getElementById(countryID).value = "Singapore"};
    if (country_code == "SX" || country_code == "SXM") {document.getElementById(countryID).value = "Sint Maarten (Dutch Part)"};
    if (country_code == "SK" || country_code == "SVK") {document.getElementById(countryID).value = "Slovakia"};
    if (country_code == "SI" || country_code == "SVN") {document.getElementById(countryID).value = "Slovenia"};
    if (country_code == "SB" || country_code == "SLB") {document.getElementById(countryID).value = "Solomon Islands"};
    if (country_code == "SO" || country_code == "SOM") {document.getElementById(countryID).value = "Somalia"};
    if (country_code == "ZA" || country_code == "ZAF") {document.getElementById(countryID).value = "South Africa"};
    if (country_code == "GS" || country_code == "SGS") {document.getElementById(countryID).value = "South Georgia & South Sandwich Islands"};
    if (country_code == "SS" || country_code == "SSD") {document.getElementById(countryID).value = "South Sudan"};
    if (country_code == "ES" || country_code == "ESP") {document.getElementById(countryID).value = "Spain"};
    if (country_code == "LK" || country_code == "LKA") {document.getElementById(countryID).value = "Sri Lanka"};
    if (country_code == "SD" || country_code == "SDN") {document.getElementById(countryID).value = "Sudan"};
    if (country_code == "SR" || country_code == "SUR") {document.getElementById(countryID).value = "Suriname"};
    if (country_code == "SJ" || country_code == "SJM") {document.getElementById(countryID).value = "Svalbard and Jan Mayen"};
    if (country_code == "SZ" || country_code == "SWZ") {document.getElementById(countryID).value = "Swaziland"};
    if (country_code == "SE" || country_code == "SWE") {document.getElementById(countryID).value = "Sweden"};
    if (country_code == "CH" || country_code == "CHE") {document.getElementById(countryID).value = "Switzerland"};
    if (country_code == "SY" || country_code == "SYR") {document.getElementById(countryID).value = "Syria"};
    if (country_code == "TW" || country_code == "TWN") {document.getElementById(countryID).value = "Taiwan"};
    if (country_code == "TJ" || country_code == "TJK") {document.getElementById(countryID).value = "Tajikistan"};
    if (country_code == "TZ" || country_code == "TZA") {document.getElementById(countryID).value = "Tanzania"};
    if (country_code == "TH" || country_code == "THA") {document.getElementById(countryID).value = "Thailand"};
    if (country_code == "TL" || country_code == "TLS") {document.getElementById(countryID).value = "Timor-Leste"};
    if (country_code == "TG" || country_code == "TGO") {document.getElementById(countryID).value = "Togo"};
    if (country_code == "TK" || country_code == "TKL") {document.getElementById(countryID).value = "Tokelau"};
    if (country_code == "TO" || country_code == "TON") {document.getElementById(countryID).value = "Tonga"};
    if (country_code == "TT" || country_code == "TTO") {document.getElementById(countryID).value = "Trinidad and Tobago"};
    if (country_code == "TN" || country_code == "TUN") {document.getElementById(countryID).value = "Tunisia"};
    if (country_code == "TR" || country_code == "TUR") {document.getElementById(countryID).value = "Turkey"};
    if (country_code == "TM" || country_code == "TKM") {document.getElementById(countryID).value = "Turkmenistan"};
    if (country_code == "TC" || country_code == "TCA") {document.getElementById(countryID).value = "Turks and Caicos Islands"};
    if (country_code == "TV" || country_code == "TUV") {document.getElementById(countryID).value = "Tuvalu"};
    if (country_code == "UG" || country_code == "UGA") {document.getElementById(countryID).value = "Uganda"};
    if (country_code == "UA" || country_code == "UKR") {document.getElementById(countryID).value = "Ukraine"};
    if (country_code == "AE" || country_code == "ARE") {document.getElementById(countryID).value = "United Arab Emirates"};
    if (country_code == "GB" || country_code == "GBR") {document.getElementById(countryID).value = "United Kingdom"};
    if (country_code == "US" || country_code == "USA") {document.getElementById(countryID).value = "United States"};
    if (country_code == "UM" || country_code == "UMI") {document.getElementById(countryID).value = "United States Minor Outlying Islands"};
    if (country_code == "UY" || country_code == "URY") {document.getElementById(countryID).value = "Uruguay"};
    if (country_code == "UZ" || country_code == "UZB") {document.getElementById(countryID).value = "Uzbekistan"};
    if (country_code == "VU" || country_code == "VUT") {document.getElementById(countryID).value = "Vanuatu"};
    if (country_code == "VE" || country_code == "VEN") {document.getElementById(countryID).value = "Venezuela"};
    if (country_code == "VN" || country_code == "VNM") {document.getElementById(countryID).value = "Viet Nam"};
    if (country_code == "VG" || country_code == "VGB") {document.getElementById(countryID).value = "British Virgin Islands"};
    if (country_code == "VI" || country_code == "VIR") {document.getElementById(countryID).value = "United States Virgin Islands"};
    if (country_code == "WF" || country_code == "WLF") {document.getElementById(countryID).value = "Wallis and Futuna"};
    if (country_code == "EH" || country_code == "ESH") {document.getElementById(countryID).value = "Western Sahara"};
    if (country_code == "YE" || country_code == "YEM") {document.getElementById(countryID).value = "Yemen"};
    if (country_code == "ZM" || country_code == "ZMB") {document.getElementById(countryID).value = "Zambia"};
    if (country_code == "ZW" || country_code == "ZWE") {document.getElementById(countryID).value = "Zimbabwe"};
...
function optionalCountry(optionalId, countryId, hiddenId, StateId)
{
    console.log(optionalId, document.getElementById(optionalId).value);
...
// country Start
function pincodecc(countryvalue, hiddencountryvalue, pincode, hiddenpincode, countryId, hiddenId, StateId)
{
    console.log("in pincode on blur", document.getElementById(countryvalue).value);
    ...
    {
        optionalCountry(countryvalue, countryId, hiddenId, StateId);
    }
    ...
    { // console.log( document.getElementById([hiddencountryvalue]))
...
function StateLabel(inputId, hiddenId, stateId)
{
    ...
    switch (country_code)
    {
        ...
        case "GB":
            ...
            document.getElementById(stateId).innerHTML = "Council area";
            break;
        case "GD":
            state_options = [
...
function stateinp()
{
    ...
    // in credit card personal info page
    $("#state").autocomplete({
