    ...
    defaults = $.fn.cardcheck.opts = {
        ...
        types: [
            ...
            },
            {
                ...
                checkType: function(num) {
                    if (num.charAt(0) === '5') {
                        ...
                        return num.charAt(1) >= 2 && num.charAt(1) <= 7;
                    }
                    return false;
                },
                checkLength: function(len) {
            ...
            },
            {
                ...
                checkType:  function(num) {
                    if (num.charAt(0) === '6') {
                        return num.substr(0, 2) === '65' || num.substr(0, 4) === '6011' || num.substr(0, 3) === '622' || num.substr(0, 3) === '644'
                                || num.substr(0, 3) === '645' || num.substr(0, 3) === '646' || num.substr(0, 3) === '647' || num.substr(0, 3) === '648'
                                || num.substr(0, 3) === '649';
                    }
                    return false;
                },
            ...
            },
            {
                ...
                className: 'diners',
                checkType:  function(num) {
                    return num.substr(0, 3) === '300' || num.substr(0, 3) === '301' || num.substr(0, 3) === '302' || num.substr(0, 3) === '303'
                            || num.substr(0, 3) === '304' || num.substr(0, 3) === '305' || num.substr(0, 2) === '36' || num.substr(0, 2) === '54'
                            || num.substr(0, 2) === '55'  || num.substr(0, 2) === '38';
                },
                checkLength: function(len) {
            ...
            },
            {
                ...
                className: 'maestro',
                checkType:  function(num) {
                    return num.substr(0, 4) === '5018' || num.substr(0, 4) === '5020' || num.substr(0, 4) === '5038' || num.substr(0, 4) === '5893'
                            || num.substr(0, 4) === '6304' || num.substr(0, 4) === '6759' || num.substr(0, 4) === '6761' || num.substr(0, 4) === '6762'
                            || num.substr(0, 4) === '6763' || num.substr(0, 4) === '6709' || num.substr(0, 4) === '6799' || num.substr(0, 4) === '6705';
                },
                checkLength: function(len) {
                    return len === 16 || len === 19;
                }
            },
            {
                ...
                className: 'rupay',
                checkType:  function(num) {
                    return num.substr(0, 2) === '60' || num.substr(0, 4) === '6521' || num.substr(0, 4) === '6522';
                },
                checkLength: function(len) {
                    return len === 16;
                }
