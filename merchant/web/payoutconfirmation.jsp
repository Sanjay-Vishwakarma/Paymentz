...
%>
<%
  Map dataHash = (Map) request.getAttribute("hiddenResponse");

  String message = (String) dataHash.get("statusDesc");
  int trackingid = (int) dataHash.get("trackingid");
  ...
  String description = (String) dataHash.get("description");
  String newVoucherSerialNumber=(String)dataHash.get("vouchernumber");
%>
        ...
        <div class="col-sm-12 portlets ui-sortable">
          <div class="widget">
            ...
            <div class="widget-header transparent">
              <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Payout Transaction Status</strong>
              ...
              <div id="horizontal-form">
                <div class="table table-responsive">
                  <table class="table table-striped table-bordered" id="textheadid" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                    ...
                    <tr >
                      <td class="tr0" align="center" style="color: white;border-bottom: 1px solid #ddd;">Order Id </td>
                      <td class="tr1" align="center"><%=orderid%></td>
                    </tr>
                    <tr >
                      <td class="tr0" align="center" style="color: white;border-bottom: 1px solid #ddd;">Order Description </td>
                    ...
                    <tr >
                      <%
                        if(message!=null){
                      %>
                      <td class="tr0" align="center" style="color: white;border-bottom: 1px solid #ddd;">Remark </td>
                    ...
                    %>
                    <%
                      if(newVoucherSerialNumber!=null)
                      {
                    %>
                    <tr >
                      <td class="tr0" align="center" style="color: white;border-bottom: 1px solid #ddd;">New VoucherNumber </td>
                      <td class="tr1" align="center"><%=newVoucherSerialNumber%></td>
                    </tr>
                    <%
                      }
                    %>
