...
<%
        ...
        Hashtable hash2 = (Hashtable)request.getAttribute("cardtypelist");
        Hashtable hash3 = (Hashtable)request.getAttribute("terminallist");


        String key = (String)hash.get("key");
        String checksumAlgorithm = (String)hash.get("checksumAlgorithm");
...
<html>
<head>
    <title>Merchant Order Payments</title>
    <link rel="stylesheet" type="text/css" href="/merchant/style.css"/>
...
this.document.myformname.phone1.value = hatto.split("|")[1];
...
<%
        ...
        {
            //out.println("<center><li class=\"alert alert-danger alert-dismissable\"><b>"+error+"</b></li></center><br/><br/>");
            out.println("<h5 class=\"bg-infoorange\" style=\"text-align: center;\"><i class=\"fa fa-exclamation-triangle\"></i>&nbsp;&nbsp;" + error + "</h5><br><br>");
  ...
  <form action="/merchant/servlet/VirtualConfirm?ctoken=<%=ctoken%>" name="myformname" method="post">

  <table width="740" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#E4D6C9">
    <tr>
      <td>
        <table width="740" border="0" cellspacing="0" cellpadding="0" align="center" bordercolor="#E4D6C9" bgcolor="#CCE0FF">
          <tr>
            <td width="38%" height="20">&nbsp;</td>
            <td colspan="6" width="62%">&nbsp;</td>
          </tr>
          <tr>
            <td width="38%"><div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Merchant
                ID : </font></b></div></td>
            <td colspan="6" width="62%"><input type="text" name="mid" size="10" disabled="true" value=<%=memberid%> ></td>
          </tr>
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Order
                ID :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="oid" size="10">
              <font size="2"><font size="2"><font  face="Arial, Helvetica, sans-serif" size="1"><b>Enter
              a unique order number else the transaction will get locked</b></font></font></font></td>
          </tr>
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Amount
                :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="total" size="10">
              <font size="2"><font  face="Arial, Helvetica, sans-serif" size="1"><b>In
              <%=currency%></b></font></font></td>
          </tr>
          <%--<tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Customer
                Name :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="name" size="20">
              <font size="2"><font  face="Arial, Helvetica, sans-serif" size="1"><b>Enter
              Full Name e.g John Doe</b></font></font></td>
          </tr>--%>
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Address
                :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="b_address" size="40">
            </td>
          </tr>
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">City
                :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="b_city" size="20">
            </td>
          </tr>
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Zip
                Code :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="b_zipcode" size="10">
              <font size="2"><font color="#CC0000" face="Arial, Helvetica, sans-serif" size="1"></font></font></td>
          </tr>

          <tr>
            <td><div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">State
                :</font></b></div></td>
            <td colspan="6"><input name="b_state" type="text" id="b_state" size="10">

			<select name="us_states" onchange="usstate();">
          ...
          <tr>
            <td><div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">ISO
                Country Code :</font></b></div>
            </td>
            <td colspan="6"><input type="test" name="countrycode" size="10" readonly>

                <select name="country" onchange="myjunk();">
          ...
          <tr>
            <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Phone
                :</font></b></div></td>
            <td colspan="6" width="62%"> <input type="text" name="phone1" size="5" readonly>
              -
              <input type="text" name="phone2" size="20"> <font size="2"><font size="2"><font  face="Arial, Helvetica, sans-serif" size="1"><b>Example
              (Country Code - Phone Number)</b></font></font></font></td>
          </tr>
          <%
          ...
          %>
          <tr>
          <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Select Pay Mode
                :</font></b></div></td>
           <td colspan="6">
        ...
        <tr>
        <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Select Card Type
                :</font></b></div></td>
           <td colspan="6">
        <select name=cardtype>
         ...
         <%
                Enumeration cardenum = hash2.keys();
                String cardtypekey = "";
                ...
                {
                    cardtypekey = (String) cardenum.nextElement();
                    cardtypevalue = (String)hash2.get(cardtypekey);
                    
                if(cardtypekey.equals("1"))
                {
                    isSelected="selected";
                }
                else
          ...
          %>
            <option value="<%=ESAPI.encoder().encodeForHTMLAttribute(cardtypekey)%>" <%=isSelected%> >
                    <%=ESAPI.encoder().encodeForHTML(cardtypevalue)%>
            </option>
            <%
                }
            %>
        ...
        <font size="2"><font size="2"><font  face="Arial, Helvetica, sans-serif" size="1"><b>(Mandatory if paymode is credit cards)</b></font></font></font>
        </td>
        </tr>
          <%
              }
          ...
          %>
          <tr>
              <td width="38%"> <div align="right"><b><font face="Arial, Helvetica, sans-serif" size="2">Select Terminal Type
                  :</font></b></div></td>
              <td colspan="6">
                  <select name=terminalid>
                      <%
                          Enumeration terminalenum = hash3.keys();
                          String terminaltypekey = "";
                          String terminaltypevalue = "";
                          String isCreditCard ="";

                          while (terminalenum.hasMoreElements())
                          {
                              terminaltypekey = (String) terminalenum.nextElement();
                              terminaltypevalue = (String)hash3.get(terminaltypekey);


                      %>
                      <option value="<%=ESAPI.encoder().encodeForHTMLAttribute(terminaltypekey)%>" >
                          <%=ESAPI.encoder().encodeForHTML(terminaltypevalue)%>
                      </option>
                      <%
                          }
                      %>
          ...
          <tr>
            <td width="38%">&nbsp;</td>
            <td colspan="6" width="62%">
              <input type="hidden" name="mid" value=<%=memberid%>>
              <input type="hidden" name="bitkey" value=<%=key%>>
              <input type="hidden" name="currency" value=<%=currency%>>
              <input type="hidden" name="ctoken" value=<%=ctoken%>>
              <input type="hidden" name="checksumAlgorithm" value=<%=checksumAlgorithm%>>
