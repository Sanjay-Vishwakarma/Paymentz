            ...
            <div class="pull-right">
                <div class="btn-group">
                    <%
                        ...
                        {
                            form = "/merchant/servlet/Transactions?ctoken=";
                        }
                ...
                <div class="widget-content padding" style="overflow-x: auto;">
                    ...
                    <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                        ...
                        <tr style="color: white;">
                            ...
                            <td valign="middle" align="center"
                                style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;">
                                <b>isRollingReserveKept</b></td>
                            <td valign="middle" align="center"
                                style="background-color: #7eccad !important;color: white;padding-top: 13px;padding-bottom: 13px;">
                                <b>isRollingReserveReleased</b></td>--%>
                    ...
                    <div class="widget">
                        <div class="widget-header">
                                        ...
                                        <div class="widget-content padding"  style="overflow-y: auto;">
                                            <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                                ...
                                                <tr style="color: white;">
                                                    ...
                                                    <th style="text-align: center">RRN</th>
                                                    ...
                                                    <%
                                                        if("22".equals(cardtypeid)){      //needed for neteller
                                                    %>
                                                ...
                                                <%
                                                    ...
                                                    for (int pos = 1; pos <= records; pos++)
                                                    {
                                                        ...
                                                        out.println("<td data-label=\"Rrn\" style=\"text-align: center\">" + ESAPI.encoder().encodeForHTML(rrn) + "</td>");
                                ...
                                <div class="col-sm-12 portlets ui-sortable">
                                    <div class="widget">
                                        <%
                                            ...
                                            if(innerHash!= null )
                                            {
                                                transStatus1 = (String) innerHash.get("status");
                                        ...
                                        <div class="widget-content padding" style="overflow-y: auto;">
                                            <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                                ...
                                                <%
                                                    ...
                                                    out.println("<td data-label=\"customerId\" style=\"text-align: center\">&nbsp;" + functions.maskVpaAddress(customerId) +  "</td>");
                            ...
                            <%
                                ...
                                String First_Six = (String) innerHash.get("first_six");
                                String Last_Four = (String) innerHash.get("last_four");
                                //String cardExpired= (String)innerHash.get("cardExpired");
                                String cardExpired= "";

                                if (functions.isValueNull(name) || functions.isValueNull(First_Six) || functions.isValueNull(lastName) || functions.isValueNull(cardExpired))
                                {
                            ...
                            <div class="row">
                                <div class="col-sm-12 portlets ui-sortable">
                                    <div class="widget">
                                        ...
                                        <div class="widget-header transparent">
                                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;<%=transactionDetails_Card_Details%></strong></h2>
                                            <div class="additional-btn">
                                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                                        ...
                                        <div class="widget-content padding" style="overflow-y: auto;">
                                            <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                                <thead >
                                                <tr style="color: white;">
                                                    <th style="text-align: center"><%=transactionDetails_Cardholder%> </th>
                                                    <th style="text-align: center"><%=transactionDetails_FirstSix%></th>
                                                    <th style="text-align: center"><%=transactionDetails_LastFour%></th>
                                                    <th style="text-align: center">Card Expired</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <%
                                                    ...
                                                    if (name == null) name = "-";
                                                    First_Six = (String) innerHash.get("first_six");
                                                    if (First_Six == null) First_Six = "-";
                                                    Last_Four = (String) innerHash.get("last_four");
                                                    if (Last_Four == null) Last_Four = "-";
                                                    String bin_sub_brand = (String) innerHash.get("bin_trans_type");
                                                    //cardExpired= (String)innerHash.get("cardExpired");
                                                    cardExpired= "";
                                                    if (cardExpired== null) cardExpired = "-";
                                    /*if (bin_card_category == null) bin_card_category = "-";
                                    String bin_usage_type = (String) innerHash.get("bin_usage_type");*/
                                                    //if (bin_usage_type == null || bin_usage_type!="") bin_usage_type = "-";

                                                    //out.println("<tr " + style + ">");
                                                    out.println("<td data-label=\"Cardholder's Name\" style=\"text-align: center\">&nbsp;" + name + "</td>");
                                                    out.println("<td data-label=\"First Six\" style=\"text-align: center\">&nbsp;" + First_Six + "" +"</td>");
                                                    out.println("<td data-label=\"Last Four\" style=\"text-align: center\">&nbsp;" + Last_Four + "</td>");
                                                    out.println("<td data-label=\"Card Expired\" style=\"text-align: center\">&nbsp;" + cardExpired + "</td>");
                                       /* out.println("<td data-label=\"Bin Brand\" style=\"text-align: center\">&nbsp;" + bin_brand + "</td>");*/
                                    /*out.println("<td data-label=\"Bin Sub Brand\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(bin_sub_brand) +  "</td>");*/

                                    /*out.println("<td data-label=\"Bin Usage Type\" style=\"text-align: center\">&nbsp;" + bin_usage_type +  "</td>");*/
                                                    out.println("</tr>");
                                                %>
                                                </tbody>
                                            </table>
                            ...
                            <%
                                ...
                                if (functions.isValueNull(bin_brand) || functions.isValueNull(card_country) || functions.isValueNull(cardIssuingBank)
                                        || functions.isValueNull(bin_card_type) || functions.isValueNull(bin_card_category))
                                {
                            %>
                            <div class="row">
                                <div class="col-sm-12 portlets ui-sortable">
                                    <div class="widget">
                                        ...
                                        <div class="widget-header transparent">
                                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;<%=transactionDetails_BinDetails%></strong></h2>
                                            <div class="additional-btn">
                                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                                        ...
                                        <div class="widget-content padding" style="overflow-y: auto;">
                                            <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                                <thead >
                                                <tr style="color: white;">
                                                    <th style="text-align: center"><%=transactionDetails_BinBrand%></th>
                                                    <th style="text-align: center"><%=transactionDetails_Country1%></th>
                                                    <th style="text-align: center"><%=transactionDetails_IssuingBank%></th>
                                                    <th style="text-align: center"><%=transactionDetails_Bin_Card_Type%></th>
                                                    <th style="text-align: center"><%=transactionDetails_Bin_Card%></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <%
                                                    ...
                                                    if (bin_card_type == null) bin_card_type = "-";
                                                    bin_card_category = (String) innerHash.get("bin_card_category");
                                                    if (bin_card_category == null) bin_card_category = "-";

                                                    out.println("<td data-label=\"Bin Brand\" style=\"text-align: center\">&nbsp;" + bin_brand + "</td>");
                                                    out.println("<td data-label=\"Card Country\" style=\"text-align: center\">&nbsp;" + card_country +  "</td>");
                                                    out.println("<td data-label=\"Card Issue  Bank\" style=\"text-align: center\">&nbsp;" + cardIssuingBank +  "</td>");
                                                    out.println("<td data-label=\"Bin Card Type\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(bin_card_type) +  "</td>");
                                                    out.println("<td data-label=\"Bin Card Category\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(bin_card_category) +  "</td>");
                                                    out.println("</tr>");
                                                %>
                                                </tbody>
                                            </table>
                            ...
                            <div class="row">
                                <div class="col-sm-12 portlets ui-sortable">
                                    <div class="widget">
                                        ...
                                        <div class="widget-header transparent">
                                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;<%=transactionDetails_Fraud_Rules%></strong></h2>
                                            <div class="additional-btn">
                                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                                        ...
                                        <div class="widget-content padding" style="overflow-y: auto;">
                                            <table id="myTable" class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                                <thead >
                                                <tr style="color: white;">
                                                    <th style="text-align: center"><%=transactionDetails_Fraud_Rule%></th>
                                                    <th style="text-align: center"><%=transactionDetails_Status%></th>
                                                    <th style="text-align: center"><%=transactionDetails_Fraud_Rule_Score%></th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <%
                                                    for(RuleMasterVO ruleMasterVO:ruleMasterVOList)
                                                    {
                                                        ...
                                                        out.println("<td data-label=\"Fraud Rule Name\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(ruleMasterVO.getRuleName()) + "</td>");
                                                        out.println("<td data-label=\"Fraud Rule Pass\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(defaultStatus) + "</td>");
                                                        out.println("<td data-label=\"Fraud Rule Score\" style=\"text-align: center\">&nbsp;" + ESAPI.encoder().encodeForHTML(ruleMasterVO.getDefaultScore()) + "</td>");
                                                        out.println("</tr>");
                                                %>
                                                <%
                                                    }
                            ...
                            <div class="row">
                                <div class="col-sm-12 portlets ui-sortable">
                                    <div class="widget">
                                        ...
                                        <div class="widget-header transparent">
                                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;<%=transactionDetails_Transaction_Receipt%></strong></h2>
                                            <div class="additional-btn">
                                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
