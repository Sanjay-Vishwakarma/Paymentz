...
<%
  ...
  String manageMerchantFraudRule_page_no=!functions.isEmptyOrNull(rb1.getString("manageMerchantFraudRule_page_no"))?rb1.getString("manageMerchantFraudRule_page_no"): "Page number";
  String manageMerchantFraudRule_total_no_of_records=!functions.isEmptyOrNull(rb1.getString("manageMerchantFraudRule_total_no_of_records"))?rb1.getString("manageMerchantFraudRule_total_no_of_records"):"Total number of records";
%>
...
<head>
  ...
  <title><%=company%>  Merchant Settings > Fraud Rule Configuration</title>
          ...
          <div class="widget">
            ...
            <div class="widget-content padding">
              ...
              <form name="updateSubAccountLevelFraudConfform" action="/merchant/servlet/ManageMerchantFraudRule?ctoken=<%=ctoken%>" method="post">
                ...
                %>
                <div id="showingid"><strong><%=manageMerchantFraudRule_page_no%> <%=paginationVO.getPageNo()%> <%=manageMerchantFraudRule_of%> <%=TotalPageNo%></strong></div> &nbsp;&nbsp;
                <div id="showingid"><strong><%=manageMerchantFraudRule_total_no_of_records%>   <%=paginationVO.getTotalRecords()%></strong></div>
