...
<%
    ...
    String bankapplication_please = StringUtils.isNotEmpty(rb1.getString("bankapplication_please"))?rb1.getString("bankapplication_please"): "Please save Bank Profile after entering the data provided";
    String bankapplication_information = StringUtils.isNotEmpty(rb1.getString("bankapplication_information"))?rb1.getString("bankapplication_information"): "Bank Information";
    ...
    String bankapplication_BankName = StringUtils.isNotEmpty(rb1.getString("bankapplication_BankName"))?rb1.getString("bankapplication_BankName"): "Bank Name*";
    ...
    String bankapplication_Phone = StringUtils.isNotEmpty(rb1.getString("bankapplication_Phone"))?rb1.getString("bankapplication_Phone"): "Bank Phone Number";
    String bankapplication_account = StringUtils.isNotEmpty(rb1.getString("bankapplication_account"))?rb1.getString("bankapplication_account"): "Bank Account Number*";
    String bankapplication_routing = StringUtils.isNotEmpty(rb1.getString("bankapplication_routing"))?rb1.getString("bankapplication_routing"): "ABA routing code (US)";
    String bankapplication_holder = StringUtils.isNotEmpty(rb1.getString("bankapplication_holder"))?rb1.getString("bankapplication_holder"): "Account Holder*";
    String bankapplication_payment = StringUtils.isNotEmpty(rb1.getString("bankapplication_payment"))?rb1.getString("bankapplication_payment"): "Payment Acceptor Details:";
    String bankapplication_acceptor = StringUtils.isNotEmpty(rb1.getString("bankapplication_acceptor"))?rb1.getString("bankapplication_acceptor"): "Previous or current payment acceptor?";
    ...
    String bankapplication_Processing_History1 = StringUtils.isNotEmpty(rb1.getString("bankapplication_Processing_History1"))?rb1.getString("bankapplication_Processing_History1"): "PROCESSING HISTORY";
    String bankapplication_6months = StringUtils.isNotEmpty(rb1.getString("bankapplication_6months"))?rb1.getString("bankapplication_6months"): "6 Months Ago";
    String bankapplication_5months = StringUtils.isNotEmpty(rb1.getString("bankapplication_5months"))?rb1.getString("bankapplication_5months"): "5 Months Ago";
    String bankapplication_4months = StringUtils.isNotEmpty(rb1.getString("bankapplication_4months"))?rb1.getString("bankapplication_4months"): "4 Months Ago";
    String bankapplication_3months = StringUtils.isNotEmpty(rb1.getString("bankapplication_3months"))?rb1.getString("bankapplication_3months"): "3 Months Ago";
    String bankapplication_2months = StringUtils.isNotEmpty(rb1.getString("bankapplication_2months"))?rb1.getString("bankapplication_2months"): "2 Months Ago";
    String bankapplication_1months = StringUtils.isNotEmpty(rb1.getString("bankapplication_1months"))?rb1.getString("bankapplication_1months"): "1 Months Ago";
    ...
    String bankapplication_2year = StringUtils.isNotEmpty(rb1.getString("bankapplication_2year"))?rb1.getString("bankapplication_2year"): "2 Year Ago";
    String bankapplication_3year = StringUtils.isNotEmpty(rb1.getString("bankapplication_3year"))?rb1.getString("bankapplication_3year"): "3 Year Ago";
    String bankapplication_sales = StringUtils.isNotEmpty(rb1.getString("bankapplication_sales"))?rb1.getString("bankapplication_sales"): "Sales volume";
    String bankapplication_transactions = StringUtils.isNotEmpty(rb1.getString("bankapplication_transactions"))?rb1.getString("bankapplication_transactions"): "Number of transactions";
    String bankapplication_chargeback = StringUtils.isNotEmpty(rb1.getString("bankapplication_chargeback"))?rb1.getString("bankapplication_chargeback"): "Chargeback volume";
    String bankapplication_number = StringUtils.isNotEmpty(rb1.getString("bankapplication_number"))?rb1.getString("bankapplication_number"): "Number of chargebacks";
    String bankapplication_refunds = StringUtils.isNotEmpty(rb1.getString("bankapplication_refunds"))?rb1.getString("bankapplication_refunds"): "Refunds volume";
    String bankapplication_no = StringUtils.isNotEmpty(rb1.getString("bankapplication_no"))?rb1.getString("bankapplication_no"): "Number of refunds";
    String bankapplication_ratio = StringUtils.isNotEmpty(rb1.getString("bankapplication_ratio"))?rb1.getString("bankapplication_ratio"): "Chargeback Ratio";
    String bankapplication_ratio1 = StringUtils.isNotEmpty(rb1.getString("bankapplication_ratio1"))?rb1.getString("bankapplication_ratio1"): "Refund ratio";
        ...
        <div class="page-heading">
                            ...
                            <div id="horizontal-form">
                                ...
                                <div class="form foreground bodypanelfont_color panelbody_color">
                                    ...
                                    <div class="form-group col-md-6">
                                            ...
                                            <label>In which currency would you like payment to be transferred to your bank account?</label>
                                    </div>
            ...
            <div class="row">
                <div class="col-sm-12 portlets ui-sortable">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;<%=bankapplication_information%></strong></h2>
                            <div class="additional-btn">
                                <a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
                                <a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
                                <a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
                        ...
                        <div class="form foreground bodypanelfont_color panelbody_color">
                            ...
                            <div class="widget-content padding" style="overflow-y: auto;">
                                <div id="horizontal-form">
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_bank_name" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_BankName%></label>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        ...
                                        <input type="text"  class="form-control"  id="bankinfo_bankaddress" name="bankinfo_bankaddress" style="border: 1px solid #b2b2b2;font-weight:bold"  <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getBankinfo_bankaddress())==true?bankProfileVO.getBankinfo_bankaddress():""%>"/>
                                        <%if(validationErrorList.getError("bankinfo_bankaddress")!=null){%><i class="form-control-feedback glyphicon glyphicon-remove erroricon " style="display: block;color:#a94442;background-color: #ebccd1;width: 40px;margin-right: 16px;height: 32px; margin-top: -1px;"></i><%}%>
                                    </div>
                                    <%
                                        }
                                    %>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_bankphonenumber" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_Phone%></label>
                                    ...
                                    %>
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankcontactperson" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">Bank Contact Person</label>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_accountnumber" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_account%></label>
                                    ...
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_IBAN" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">IBAN Number</label>
                                    ...
                                    %>
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_aba_routingcode" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_routing%></label>
                                    ...
                                    %>
                                    <div class="form-group col-md-4 has-feedback">
                                        <label for="bankinfo_accountholder" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_holder%></label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label style="font-family:Open Sans;font-size: 15px;font-weight: 600;"><u><%=bankapplication_payment%></u></label>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 has-feedback">
                                        <label for="aquirer" style="font-family:Open Sans;font-size: 13px;font-weight: 600;"><%=bankapplication_acceptor%></label>
                                    ...
                                    %>
                                    <div class="form-group col-md-6 has-feedback">
                                        <label for="customer_trans_data" style="font-family:Open Sans;font-size: 13px;font-weight: 600;">What kind of customer and transaction data is stored?*</label>
                        ...
                        <div class="widget-content padding" style="overflow-y: auto;">
                            <div id="horizontal-form">
                                ...
                                <table id="myTable" class="display table table-striped table-bordered" width="100%" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                    <thead>
                                    <tr id="nocolorid">
                                        <td align="center" class="texthead" data-label="PROCESSING HISTORY" id="processingheader"><%=bankapplication_Processing_History1%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_6months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_5months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_4months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_3months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_2months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_1months%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_1year%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_2year%></td>
                                        <td align="center" class="texthead" width=""><%=bankapplication_3year%></td>
                                    </tr>
                                    </thead>

                                    <tr>

                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_sales%></td>
                                        <td align="center" data-label="6 MONTHS AGO">

                                        <input type="text"  class="form-control" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate6monthsago()" onblur="calculate6monthsago()" name="salesvolume_6monthsago" style="border: 1px solid #b2b2b2;font-weight:bold"  <%=globaldisabled%>
                                               value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_6monthsago())==true?bankProfileVO.getSalesvolume_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_6monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>


                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control"  maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate5monthsago()" onblur="calculate5monthsago()" name="salesvolume_5monthsago" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_5monthsago())==true?bankProfileVO.getSalesvolume_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_5monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>


                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control"  maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate4monthsago()" onblur="calculate4monthsago()" name="salesvolume_4monthsago" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_4monthsago())==true?bankProfileVO.getSalesvolume_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_4monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>


                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control"  maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate3monthsago()"onblur="calculate3monthsago()"  name="salesvolume_3monthsago" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_3monthsago())==true?bankProfileVO.getSalesvolume_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_3monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume</span><%}%>
                                        </td>


                                        <td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control"  maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate2monthsago()" onblur="calculate2monthsago()" name="salesvolume_2monthsago" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_2monthsago())==true?bankProfileVO.getSalesvolume_2monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_2monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>


                                        <td align="center" data-label="1 MONTHS AGO">
                                            <input type="text" class="form-control"   maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateLastMonth()" onblur="calculateLastMonth()" name="salesvolume_lastmonth" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_lastmonth())==true?bankProfileVO.getSalesvolume_lastmonth():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_lastmonth")!=null){%><span class="apperrormsg">Invalid salesvolume  </span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate12monthsago()" onblur="calculate12monthsago()" name="salesvolume_12monthsago"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_12monthsago())==true?bankProfileVO.getSalesvolume_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_12monthsago")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="salesvolume_year2" maxlength=50" onkeypress="return isNumberKey(event)" onchange="calculateyear2()" onblur="calculateyear2()"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_year2())==true?bankProfileVO.getSalesvolume_year2():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_year2")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="salesvolume_year3" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear3()" onblur="calculateyear3()"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getSalesvolume_year3())==true?bankProfileVO.getSalesvolume_year3():""%>"/>
                                            <%if(validationErrorList.getError("salesvolume_year3")!=null){%><span class="apperrormsg">Invalid salesvolume </span><%}%>
                                        </td>

                                    </tr>
                                    <tr>

                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_transactions%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_6monthsago" maxlength="50"   onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_6monthsago())==true?bankProfileVO.getNumberoftransactions_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_6monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_6monthsago</span><%}%>
                                        </td>

                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_5monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_5monthsago())==true?bankProfileVO.getNumberoftransactions_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_5monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_5monthsago </span><%}%>
                                        </td>

                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_4monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_4monthsago())==true?bankProfileVO.getNumberoftransactions_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_4monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_4monthsago </span><%}%>
                                        </td>

                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_3monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_3monthsago())==true?bankProfileVO.getNumberoftransactions_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_3monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_3monthsago </span><%}%>
                                        </td>


                                        <td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_2monthsago" maxlength="50" onkeypress="return isNumberKey(event)"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_2monthsago())==true?bankProfileVO.getNumberoftransactions_2monthsago():""%>" />
                                            <%if(validationErrorList.getError("numberoftransactions_2monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_2monthsago </span><%}%>
                                        </td>

                                        <td align="center" data-label="1 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_lastmonth" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_lastmonth())==true?bankProfileVO.getNumberoftransactions_lastmonth():""%>" />
                                            <%if(validationErrorList.getError("numberoftransactions_lastmonth")!=null){%><span class="apperrormsg">Invalid numberoftransactions_lastmonth  </span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_12monthsago" maxlength="50" onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_12monthsago())==true?bankProfileVO.getNumberoftransactions_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_12monthsago")!=null){%><span class="apperrormsg">Invalid numberoftransactions_12monthsago </span><%}%>
                                        </td>
                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_year2" maxlength="50" onkeypress="return isNumberKey(event)"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_year2())==true?bankProfileVO.getNumberoftransactions_year2():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_year2")!=null){%><span class="apperrormsg">Invalid numberoftransactions_2years </span><%}%>
                                        </td>
                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="numberoftransactions_year3" maxlength="50" onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>
                                                   value="<%=functions.isValueNull(bankProfileVO.getNumberoftransactions_year3())==true?bankProfileVO.getNumberoftransactions_year3():""%>"/>
                                            <%if(validationErrorList.getError("numberoftransactions_year3")!=null){%><span class="apperrormsg">Invalid numberoftransactions_3years </span><%}%>
                                        </td>
                                    </tr>
                                    <tr>

                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_chargeback%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_6monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate6monthsago()"onblur="calculate6monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_6monthsago())==true?bankProfileVO.getChargebackvolume_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_6monthsago")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_5monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate5monthsago()" onblur="calculate5monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_5monthsago())==true?bankProfileVO.getChargebackvolume_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_5monthsago")!=null){%><span class="apperrormsg">Invalid chargebackvolume</span><%}%>
                                        </td>

                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_4monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate4monthsago()"onblur="calculate4monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_4monthsago())==true?bankProfileVO.getChargebackvolume_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_4monthsago")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_3monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate3monthsago()" onblur="calculate3monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_3monthsago())==true?bankProfileVO.getChargebackvolume_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_3monthsago")!= null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_2monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate2monthsago()" onblur="calculate2monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_2monthsago())==true?bankProfileVO.getChargebackvolume_2monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_2monthsago")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>

                                        <td align="center" data-label="1 MONTHS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_lastmonth" maxlength="50"  onkeypress="return isNumberKey(event)" onchange="calculateLastMonth()" onblur="calculateLastMonth()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_lastmonth())==true?bankProfileVO.getChargebackvolume_lastmonth():""%>"  />
                                            <%if(validationErrorList.getError("chargebackvolume_lastmonth")!=null){%><span class="apperrormsg">Invalid chargebackvolume</span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_12monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate12monthsago()" onblur="calculate12monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_12monthsago())==true?bankProfileVO.getChargebackvolume_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_12monthsago")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>
                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_year2" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear2()" onblur="calculateyear2()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_year2())==true?bankProfileVO.getChargebackvolume_year2():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_year2")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>
                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="chargebackvolume_year3" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear3()" onblur="calculateyear3()" style="border: 1px solid #b2b2b2;font-weight:bold"  <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getChargebackvolume_year3())==true?bankProfileVO.getChargebackvolume_year3():""%>"/>
                                            <%if(validationErrorList.getError("chargebackvolume_year3")!=null){%><span class="apperrormsg">Invalid chargebackvolume </span><%}%>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_number%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_6monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_6monthsago())==true?bankProfileVO.getNumberofchargebacks_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_6monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_6monthsago</span><%}%>
                                        </td>

                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_5monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_5monthsago())==true?bankProfileVO.getNumberofchargebacks_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_5monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_5monthsago</span><%}%>
                                        </td>

                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_4monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_4monthsago())==true?bankProfileVO.getNumberofchargebacks_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_4monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_4monthsago </span><%}%>
                                        </td>

                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_3monthsago" maxlength="50" onkeypress="return isNumberKey(event)"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_3monthsago())==true?bankProfileVO.getNumberofchargebacks_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_3monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_3monthsago </span><%}%>
                                        </td>

                                        <td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_2monthsago" maxlength="50" onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold"  <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_2monthsago())==true?bankProfileVO.getNumberofchargebacks_2monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_2monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_2monthsago</span><%}%>
                                        </td>

                                        <td align="center" data-label="1 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_lastmonth" maxlength="50"  onkeypress="return isNumberKey(event)"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_lastmonth())==true?bankProfileVO.getNumberofchargebacks_lastmonth():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_lastmonth")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_lastmonth </span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_12monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate12monthsago()" onblur="calculate12monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_12monthsago())==true?bankProfileVO.getNumberofchargebacks_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_12monthsago")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_12monthsago </span><%}%>
                                        </td>
                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_year2" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear2()" onblur="calculateyear2()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_year2())==true?bankProfileVO.getNumberofchargebacks_year2():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_year2")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_2years </span><%}%>
                                        </td>
                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="numberofchargebacks_year3" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear3()" onblur="calculateyear3()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofchargebacks_year3())==true?bankProfileVO.getNumberofchargebacks_year3():""%>"/>
                                            <%if(validationErrorList.getError("numberofchargebacks_year3")!=null){%><span class="apperrormsg">Invalid numberofchargebacks_3years </span><%}%>
                                        </td>
                                    </tr>
                                    <tr>

                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_refunds%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_6monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate6monthsago()" onblur="calculate6monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_6monthsago())==true?bankProfileVO.getRefundsvolume_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_6monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume</span><%}%>
                                        </td>
                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_5monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate5monthsago()" onblur="calculate5monthsago()"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_5monthsago())==true?bankProfileVO.getRefundsvolume_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_5monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume</span><%}%>
                                        </td>
                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_4monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate4monthsago()" onblur="calculate4monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_4monthsago())==true?bankProfileVO.getRefundsvolume_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_4monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume</span><%}%>
                                        </td>
                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_3monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate3monthsago()" onblur="calculate3monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_3monthsago())==true?bankProfileVO.getRefundsvolume_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_3monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume</span><%}%>
                                        </td><td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_2monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate2monthsago()" onblur="calculate2monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_2monthsago())==true?bankProfileVO.getRefundsvolume_2monthsago():""%>" />
                                            <%if(validationErrorList.getError("refundsvolume_2monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume </span><%}%>
                                        </td>
                                        <td align="center" data-label="1 MONTHS AGO">
                                            ...
                                            <%if(validationErrorList.getError("refundsvolume_lastmonth")!=null){%><span class="apperrormsg">Invalid refundsvolume </span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->
                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" name="refundsvolume_12monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate12monthsago()" onblur="calculate12monthsago()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_12monthsago())==true?bankProfileVO.getRefundsvolume_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_12monthsago")!=null){%><span class="apperrormsg">Invalid refundsvolume_12monthsago </span><%}%>
                                        </td>
                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_year2" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear2()" onblur="calculateyear2()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_year2())==true?bankProfileVO.getRefundsvolume_year2():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_year2")!=null){%><span class="apperrormsg">Invalid refundsvolume_2years </span><%}%>
                                        </td>
                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="refundsvolume_year3" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear3()" onblur="calculateyear3()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getRefundsvolume_year3())==true?bankProfileVO.getRefundsvolume_year3():""%>"/>
                                            <%if(validationErrorList.getError("refundsvolume_year3")!=null){%><span class="apperrormsg">Invalid refundsvolume_3years </span><%}%>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td align="center" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_no%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_6monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_6monthsago())==true?bankProfileVO.getNumberofrefunds_6monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_6monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_6monthsago</span><%}%>
                                        </td>
                                        <td align="center" data-label="5 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_5monthsago" maxlength="50" onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold"  <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_5monthsago())==true?bankProfileVO.getNumberofrefunds_5monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_5monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_5monthsago</span><%}%>
                                        </td>
                                        <td align="center" data-label="4 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_4monthsago" maxlength="50"   onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_4monthsago())==true?bankProfileVO.getNumberofrefunds_4monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_4monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_4monthsago</span><%}%>
                                        </td>
                                        <td align="center" data-label="3 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_3monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_3monthsago())==true?bankProfileVO.getNumberofrefunds_3monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_3monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_3monthsago</span><%}%>
                                        </td>
                                        <td align="center" data-label="2 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_2monthsago" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_2monthsago())==true?bankProfileVO.getNumberofrefunds_2monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_2monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_2monthsago</span><%}%>
                                        </td>
                                        <td align="center" data-label="1 MONTHS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_lastmonth" maxlength="50"  onkeypress="return isNumberKey(event)" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%> value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_lastmonth())==true?bankProfileVO.getNumberofrefunds_lastmonth():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_lastmonth")!=null){%><span class="apperrormsg">Invalid numberofrefunds_lastmonth</span><%}%>
                                        </td>

                                        <!--NEW COLUMN ADDED-->

                                        <td align="center" data-label="1 YEAR AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_12monthsago" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculate12monthsago()" onblur="calculate12monthsago()"  style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_12monthsago())==true?bankProfileVO.getNumberofrefunds_12monthsago():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_12monthsago")!=null){%><span class="apperrormsg">Invalid numberofrefunds_12monthsago </span><%}%>
                                        </td>
                                        <td align="center" data-label="2 YEARS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_year2" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear2()" onblur="calculateyear2()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_year2())==true?bankProfileVO.getNumberofrefunds_year2():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_year2")!=null){%><span class="apperrormsg">Invalid numberofrefunds_2years </span><%}%>
                                        </td>
                                        <td align="center" data-label="3 YEARS AGO">
                                            <input type="text" class="form-control" name="numberofrefunds_year3" maxlength="50" onkeypress="return isNumberKey(event)" onchange="calculateyear3()" onblur="calculateyear3()" style="border: 1px solid #b2b2b2;font-weight:bold" <%=globaldisabled%>  value="<%=functions.isValueNull(bankProfileVO.getNumberofrefunds_year3())==true?bankProfileVO.getNumberofrefunds_year3():""%>"/>
                                            <%if(validationErrorList.getError("numberofrefunds_year3")!=null){%><span class="apperrormsg">Invalid numberofrefunds_3years </span><%}%>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" id="chargebackratioid" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_ratio%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                    ...
                                    <tr>
                                        <td align="center" id="refundratioid" class="texthead" style="color: white;vertical-align: middle;text-align: center;"><%=bankapplication_ratio1%></td>
                                        <td align="center" data-label="6 MONTHS AGO">
                                            <div class="input-group">
        ...
        <%
                ...
                if(bankProfileInputList.size()==0 && !view)
                {
                    ...
                    out.println("<div class=\"widget-header transparent\">\n" +
                            "                                <h2><strong><i class=\"fa fa-th-large\"></i>&nbsp;&nbsp;Bank Profile</strong></h2>\n" +
                            "                                <div class=\"additional-btn\">\n" +
                            "                                    <a href=\"#\" class=\"hidden reload\"><i class=\"icon-ccw-1\"></i></a>\n" +
                            "                                    <a href=\"#\" class=\"widget-toggle\"><i class=\"icon-down-open-2\"></i></a>\n" +
                            "                                    <a href=\"#\" class=\"widget-close\"><i class=\"icon-cancel-3\"></i></a>\n" +
