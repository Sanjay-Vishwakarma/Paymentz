...
<%
  ...
  Logger log = new Logger("dashBoardPerCurrency.jsp");
%>
...
<script type="application/javascript">
    function myAllCurrency(ctoken)
    {
        ...
        if(data.length === 0){
            ...
            document.myformname.action="/merchant/servlet/DashboardPerCurrency?ctoken="+ctoken;
        }
...
<script>
  ...
  <%
      ...
      List<BigDecimal> authsuccessfulHashtable = (List<BigDecimal>) request.getAttribute("authSuccessful");
      List<BigDecimal> declinedHashtable = (List<BigDecimal>) request.getAttribute("declined");
        List<BigDecimal> setteleddHashtable = (List<BigDecimal>) request.getAttribute("setteled");


        BigDecimal totalauthsuccessfulHashtable = authsuccessfulHashtable.get(0);
        BigDecimal totaldeclinedHashtable = declinedHashtable.get(0);
        BigDecimal totalsetteledHashtable = setteleddHashtable.get(0);
           ...
           if("authfailed".equals(compare.getKey()))
            {
             ...
             if("setteled".equals(compare.getKey()))
            {
                setteled = (int) statusHash.get("setteled");
            }
      }
...
<script>
  ...
  function allChange(ctoken)
  {
      ...
      document.myform1.action="/merchant/servlet/DashBoard?ctoken="+ctoken;
  }
        ...
        <div class="widget green-1 animated fadeInDown">
          <div class="widget-content padding">
            ...
            <%--<div class="text-box">
              ...
              <h2><img src="/merchant/images/<%=currency.substring(0,3).toUpperCase()%>.png">
                <span class="animate-number" data-value=<%=totalSales%> data-duration="3000"></span></h2>
              <div class="clearfix"></div>
            </div>--%>
              <div class="text-box">
                  <p class="maindata">TOTAL <b>APPROVED</b></p>
                  <h2><img src="/merchant/images/<%=currency.substring(0,3).toUpperCase()%>.png">
                      <span class="animate-number" data-value=<%=totalSales%> data-duration="3000"></span></h2>
                  <div class="clearfix"></div>
              </div>
        ...
        <div class="widget lightblue-1 animated fadeInDown">
          <div class="widget-content padding">
            ...
            <%--<div class="text-box">
              ...
              <div class="text-box">
                  <p class="maindata">TOTAL <b>SETTLED</b></p>
                  <h2><img src="/merchant/images/<%=currency.substring(0,3).toUpperCase()%>.png">
                      <span class="animate-number" data-value=<%=totalsetteledHashtable%> data-duration="3000">0</span></h2>
                  <div class="clearfix"></div>
              </div>
          </div>
          <div class="widget-footer">
            ...
            <div class="widget orange-4 animated fadeInDown" style="background-color:#1e8b92 !important ">
                <div class="widget-content padding">
                    ...
                    <%--<div class="text-box">
                        ...
                        <h2>&lt;%&ndash;$&nbsp;&ndash;%&gt;&lt;%&ndash;<img src="/merchant/images/<%=currencyKey.substring(0,3).toUpperCase()%>.png" style="margin-top: -5px;">&ndash;%&gt;
                            <span class="animate-number" data-value=<%=totalauthsuccessfulHashtable%> data-duration="3000">0</span></h2>
                        <div class="clearfix"></div>
                    </div>--%>

                    <div class="text-box">
                        <p class="maindata">TOTAL <b>DECLINED</b></p>
                        <h2><img src="/merchant/images/<%=currency.substring(0,3).toUpperCase()%>.png">
                            <span class="animate-number" data-value=<%=totaldeclinedHashtable%> data-duration="3000">0</span></h2>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <div class="widget-footer">
                ...
                <div class="col-xs-8 col-sm-4 col-md-4" id="currencyid">
                    <form name="myformname" id="myformname" action="" method="POST">
                        ...
                        <div class="btn-group">
                            ...
                            <select name="currency" onchange="myAllCurrency('<%=ctoken%>')" class="btn btn-default2 btn-xs dropdown-toggle form-control">
                                <option  value="">All Currency</option>

                                    <option value="" onchange="this.form.allChange('<%=ctoken%>')" )>All</option>
