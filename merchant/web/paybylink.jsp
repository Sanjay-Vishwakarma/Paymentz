...
<%
  ...
  session.setAttribute("submit","PayByLink"+request.getParameter("terminalid"));
%>
<html lang="en">
<head>
  ...
  <title><%=totype%> Pay By Link </title>
...
<%
  ...
  String autoSelectTerminal = (String) memberData.get("autoSelectTerminal");
   ...
   paymode = Functions.checkStringNull(request.getParameter("paymode"));
  if (paymode == null)
    paymode = "";
  cardtype = Functions.checkStringNull(request.getParameter("cardtype"));
  if (cardtype == null)
    cardtype = "";
  currency1 = Functions.checkStringNull(request.getParameter("currency"));
  if (currency1 == null)
    currency1 = "";
...
<div class="content-page">
  <div class="content">
          ...
          <div class="col-sm-12 portlets ui-sortable">
            <div class="widget">
              ...
              <div class="widget-header transparent">
                <h2><strong><i class="fa fa-th-large"></i>&nbsp;&nbsp;Transaction Details</strong></h2>
    ...
    /*String errormsg = null;*/
                ...
                <div id="horizontal-form">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="toid" size="10" class="form-control" value=<%=ESAPI.encoder().encodeForHTML(memberid)%> disabled style="border: 1px solid #b2b2b2;font-weight:bold">
                      <input type="hidden" name="memberid" value="<%=ESAPI.encoder().encodeForHTML(memberid)%>" class="textb">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input  type="Text"  name="orderdescription" size="15" maxlength="80" value="Order from Pay by Link" class="form-control">
                  </div>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="telno" size="10"  class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                    <label>Email ID</label>
                    <input type="text" name="emailaddr" size="10"  class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                     <label>Redirect URL</label>
                     <input type="text" name="redirecturl" size="255"  class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                     <label>Customer Name</label>
                     <input type="text" name="firstname" size="255"  class="form-control">
                  </div>
                </div>
              </div>
            </div>
        ...
        <input type="hidden" name="cardtype" value="<%=ESAPI.encoder().encodeForHTML(cardtype)%>" class="textb">
        ...
        <div class="bg-info" style="text-align:center;background-color: #ffffff;color: #000000;border-left: 4px solid #34495e;border: #ffffff">
          ...
          <input type="checkbox" id="terms" value="tc" name="TC" >&nbsp<b>I have read the Terms and condition and I accept the same.</b>
        </div>

        <div class="bg-info" style="text-align:center;">
          <i class="fa fa-info-circle"></i>&nbsp;&nbsp;
            PLEASE NOTE THAT SHOULD YOUR ORDER DOES NOT COMPLY WITH THE SHIPPING JURISDICTION, WE WILL REFUND YOUR ORDER
        </div>
        <%--</div>
    </div>--%>
        ...
        <div class="form-group col-md-5">
          <button type="submit" name="Submit" class="btn btn-default" onclick="return submitForm('/merchant/servlet/PayByLink?ctoken=<%=ctoken%>');">
            <%--<i class="fa fa-"></i>--%>
                Generate
          </button>
        </div>
