...
<%
    ...
    ResourceBundle rb12 = null;
    rb12 = LoadProperties.getProperty("com.directi.pg.CheckoutLanguage_en-us");
    String consent1     = rb12.getString("VAR_CONSENT_STMT1");
    String consent2     = rb12.getString("VAR_CONSENT_STMT2");
    String consent3     = rb12.getString("VAR_CONSENT_STMT3");
    String varAND       = rb12.getString("VAR_AND");
    String privacyLink  = "";
    String target       = "";
    String termsLink    = "";
    String disabledbutton ="";
    if(merchantDetailsVO.getPrivacyPolicyUrl() != null ){
        privacyLink = merchantDetailsVO.getPrivacyPolicyUrl();
    }
    if(merchantDetailsVO.getTcUrl() != null){
        termsLink = merchantDetailsVO.getTcUrl();
                            ...
                            <div id="horizontal-form">
                                <form action="/merchant/servlet/DoReverseTransaction" method="post" name="form1">
                                    <%  //String currency = (String) session.getAttribute("currency");
                                        ...
                                        TransactionDetailsVO transactionDetailsVO = (TransactionDetailsVO) request.getAttribute("transactionDetailsVO");
                                        TreeMap<String, String> bankDetailsMap = (TreeMap<String, String>) request.getAttribute("bankDetailsMap");
                                        MerchantDetailsVO merchantDetailsVO1=(MerchantDetailsVO)request.getAttribute("merchantDetailsVO");
                                        if(merchantDetailsVO1!=null)
                                            marketPlaceFlag=merchantDetailsVO1.getMarketPlace();
                                        if(temphash!=null)
                                        {
                                            double amount = 0.00;
                                    ...
                                    <table class="table table-striped table-bordered" style="font-family:Open Sans;font-size: 13px;font-weight: 600;width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            {
                                            %>
                                            <td data-label="Bank Name" style="text-align: center">
                                                <select id="esbanklist" name="bankname" class="form-control" style="width: 200px;">
                                                    <option value="0">Select Bank</option>
                                                    <%
                                                        for (Map.Entry<String, String> entry : bankDetailsMap.entrySet())
                                                        {
                                                    %>
                                    ...
                                    %>
                                        <div class="form-group col-md-15 row" style="padding-top: 20px; text-align: center">
                                            <div class="<%--form-group--%>" id="terms1">
                                                <input type="checkbox" class="" <%--style="width: 5%"--%> id="TC_DC_IN" onclick="BankES1()">
                                                <label for="TC_DC_IN" style="font-size: 85%;margin: 0px;">
                                                    <%=consent1%> <b> <a href="<%=privacyLink%>" <%=target%>> <%=consent2%></a> </b> <%=varAND%> <b> <a href="<%=termsLink%>" <%=target%>> <%=consent3%> </a></b>.
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-15 row" style="text-align: center">
                                            <div class="<%--form-group--%>" >
                                                <label for="TC_DC_IN" style="font-size: 85%;margin: 0px; color:Gray; ">
                                        ...
                                        <div class="form-group col-md-15 row" style="text-align: center">
                                            <div class="<%--form-group--%>">
                                                <button <%=disabledbutton%> id="confirmCode"  type="submit" class="btn btn-default" name="B1" &lt;%&ndash;style="margin-left:147%;"&ndash;%&gt; value="Capture" onclick="return formSubmit()">
                                    ...
                                    <%}else{%>
                                        ...
                                        <div class="form-group col-md-3">
                                            <br><br>
                                            <button <%=disabledbutton%> id="confirmCode" type="submit" class="btn btn-default  name="B1" <%--style="margin-left:147%;"--%> value="Capture" onclick="return formSubmit()">
                                            <span><i class="fa fa-save"></i></span>
                                            &nbsp;&nbsp;<%=reversereason_Reverse%>
                                            </button>
                                        </div>
